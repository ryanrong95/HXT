...
/****** Object:  View [dbo].[AdminsTopView]    Script Date: 2018/8/14 15:06:02 ******/
SET ANSI_NULLS ON
GO
...
AS
SELECT     ID, UserName, RealName, Password, CreateDate, UpdateDate, LoginDate, Status, Summary
FROM         BvnErp.dbo.Admins
