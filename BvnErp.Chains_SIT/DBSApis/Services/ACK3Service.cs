...
{
    public class ACK3Service
    {
        //public string EncryptedMsg { get; set; }
        public ACK3Response Response { get; set; }

        public ACK3Service(ACK3Response response)
        {
        ...
        //        ACK3Response response = JsonConvert.DeserializeObject<ACK3Response>(decryptedMsg);
        //        this.Response = response;
        //        Handle();
        //    }
        //    catch (Exception ex)
        ...
        public void Handle()
        {
            try
            {
                ...
                if (TransactionName != "")
                {
                    ...
                    ACK3ResponseTxnResponses txnResponse = this.Response.txnResponses.FirstOrDefault();
                    ...
                    durTSTResponse.bankReference = txnResponse.bankReference;
                    ...
                    durTSTResponse.txnCcy = txnResponse.txnCcy;
                    durTSTResponse.txnAmount = txnResponse.txnAmount;
                    durTSTResponse.debitAccountCcy = txnResponse.debitAccountCcy;
                    durTSTResponse.tranSettlementAmt = txnResponse.tranSettlementAmt;
                    durTSTResponse.tranSettlementDt = txnResponse.tranSettlementDt;
                    durTSTResponse.fxContractRef1 = txnResponse.fxContractRef1;
                    durTSTResponse.fxAmountUtilized1 = txnResponse.fxAmountUtilized1;
                    durTSTResponse.fxContractRef2 = txnResponse.fxContractRef2;
                    durTSTResponse.fxAmountUtilized2 = txnResponse.fxAmountUtilized2;
                    durTSTResponse.transactionReference = txnResponse.transactionReference;
                    durTSTResponse.senderName = txnResponse.senderParty.name;
                    durTSTResponse.senderSwiftBic = txnResponse.senderParty.swiftBic;
                    durTSTResponse.receivingName = txnResponse.receivingParty.name;
                    durTSTResponse.receivingAccountNo = txnResponse.receivingParty.accountNo;
            ...
            {
                string receivers = System.Configuration.ConfigurationManager.AppSettings["Receivers"].ToString();
                SmtpContext.Current.Send(receivers, "星展银行返回失败：" + this.Response.header.msgId, ex.Message);
            }
        }
    }
}