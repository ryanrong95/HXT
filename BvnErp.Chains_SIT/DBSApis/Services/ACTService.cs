...
namespace DBSApis.Services
{
    ...
    {
        public ACTRequest Request { get; set; }

        public ACTService(ACTRequest request)
        {
        ...
        public ReturnType PostMsg()
        {
            ...
            durApiLogs.TransactionName = DBSConstConfig.DBSConstTransName.ACT;

            ReturnType returnType = new ReturnType();
            try
            {
                DurTSTRequest durTSTRequest = new DurTSTRequest();
                durTSTRequest.TransactionName = DBSConstConfig.DBSConstTransName.ACT;
                ...
                ACTRequestTxnInfo singleTxnInfo = this.Request.txnInfoDetails.txnInfo.FirstOrDefault();
                ...
                string requestURL = urlConfig.ApiServerUrl + urlConfig.ACTUrl;
                ...
                durTSTResponse.TransactionName = DBSConstConfig.DBSConstTransName.ACT;
