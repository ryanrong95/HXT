...
namespace DBSApis.Services
{
    ...
    {
        public TTRequest Request { get; set; }

        public TTService(TTRequest request)
        {
        ...
        public ReturnType PostMsg()
        {
            ...
            durApiLogs.TransactionName = DBSConstConfig.DBSConstTransName.TT;

            ReturnType returnType = new ReturnType();
            try
            {
                DurTSTRequest durTSTRequest = new DurTSTRequest();
                durTSTRequest.TransactionName = DBSConstConfig.DBSConstTransName.TT;
                ...
                TTRequestTxnInfo singleTxnInfo = this.Request.txnInfoDetails.txnInfo.FirstOrDefault();
                ...
                durTSTRequest.fxContractRef1 = singleTxnInfo.fxContractRef1;
                durTSTRequest.fxAmountUtilized1 = singleTxnInfo.fxAmountUtilized1;
                durTSTRequest.chargeBearer = singleTxnInfo.chargeBearer;
                ...
                durTSTRequest.receivingSwiftBic = singleTxnInfo.receivingParty.swiftBic;
                durTSTRequest.addresses = singleTxnInfo.receivingParty.beneficiaryAddresses.FirstOrDefault()?.address;
                durTSTRequest.specificPaymentPurpose = singleTxnInfo.bopInfo.specificPaymentPurpose;
                durTSTRequest.taxFreeGoodsRelated = singleTxnInfo.bopInfo.taxFreeGoodsRelated;
                durTSTRequest.paymentNature = singleTxnInfo.bopInfo.paymentNature;
                durTSTRequest.bOPCode1PaymentCategory = singleTxnInfo.bopInfo.bOPCode1PaymentCategory;
                durTSTRequest.bOPCode1SeriesCode = singleTxnInfo.bopInfo.bOPCode1SeriesCode;
                ...
                string requestURL = urlConfig.ApiServerUrl + urlConfig.TTUrl;
                ...
                durTSTResponse.TransactionName = DBSConstConfig.DBSConstTransName.TT;
