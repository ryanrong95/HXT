...
namespace Needs.Wl.CustomsTool.WinForm.Models.ExceptionHandler
{
    ...
    public class Statement
    {
        ...
        public ExceptionHandlerEnum Analyse(string text)
        {
            ...
            if (Analyse(this.RestartCustomsConfig, text))
            {
                result = ExceptionHandlerEnum.RestartCustomsConfig;
            }
            else if (Analyse(this.ResendMsgConfig, text))
            {
                result = ExceptionHandlerEnum.ResendMsgConfig;
            }
            else if (Analyse(this.RemindHimConfig, text))
            {
                result = ExceptionHandlerEnum.RemindHimConfig;
            }
            else if (Analyse(this.OtherExceptionConfig, text))
            {
        ...
        /// </summary>
        /// <returns></returns>
        private bool Analyse(List<string> listConfig, string text)
        {
