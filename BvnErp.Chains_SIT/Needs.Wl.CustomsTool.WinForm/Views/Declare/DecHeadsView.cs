...
{
    public class DecHeadsView : UniqueView<DecHead, ScCustomsReponsitory>
    {
        public DecHeadsView()
        {
        }
        ...
        protected override IQueryable<DecHead> GetIQueryable()
        {
            return from head in this.Reponsitory.ReadTable<Layer.Data.Sqls.ScCustoms.DecHeads>()
                   join admin in this.Reponsitory.ReadTable<Layer.Data.Sqls.ScCustoms.AdminsTopView>() on head.InputerID equals admin.ID into g
                   ...
                   select new DecHead
                   {
                       ...
                       Inputer = new Ccs.Services.Models.Admin { ID = temp.ID,RealName = temp.RealName },
