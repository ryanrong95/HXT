...
namespace WebMvc.Models
{
    ...
    /// 待付汇
    /// </summary>
    public class UnPayExchangesViewModel
    {
        //货币数据源
        public string CurrencyOptions { get; set; }

        //订单列表
        public PreConfirmViewModel[] OrderList { get; set; }
    ...
    public class ApplyViewModel
    {
        ...
        /// 供应商银行
        /// </summary>
        public string SupplierBankOptions { get; set; }
        ...
        /// 汇率类型
        /// </summary>
        public ExchangeRateType RateTypeCode { get; set; }
        ...
        /// 总金额(外币)
        /// </summary>
        public decimal TotalDeclareMoney { get; set; }
    ...
    /// 我的付汇申请
    /// </summary>
    public class MyAppliesViewModel
    {
        //申请状态数据源
        public string ApplyStatusOptions { get; set; }
    }
    ...
    /// <summary>
    /// 获取供应商银行+地址、订单本次申请金额 action 请求参数
    /// </summary>
    public class SupplierBankAndAddressRequestModel
    {
    ...
    /// 检查供应商银行敏感性 请求参数
    /// </summary>
    public class SupplierBankSensitive
    {
        public string SupplierBankAddress { get; set; }
    }
}