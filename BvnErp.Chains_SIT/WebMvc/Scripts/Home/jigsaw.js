    ...
    class jigsaw {
        ...
        bindEvents() {
            ...
            this.slider.addEventListener('mousedown', function (e) {
                ...
                getEle("#sliderImg").style.display = "block";
                getEle("#sliderSmImg").style.display = "block";
                isMouseDown = true
            })
            ...
            document.addEventListener('mouseup', (e) => {
                ...
                if (spliced) {
                    if (TuringTest) {
                        ...
                        getEle("#sliderImg").style.display = "none";
                        getEle("#sliderSmImg").style.display = "none";
