...
namespace Needs.Ccs.Services.ApiSettings
{
    ...
    public class PurPriceApiSetting
    {

        public static string ApiName = "InvoiceApiUrl";

        public static string PuePriceHandle = "services/core.ashx";

        public static string request_service = "InvoiceFlowHandle";

        public static string request_item = "财务入库";

        public static string token = "92A0E2EC-F9F4-41DB-B623-E135A1336254";
    }

    public class OutStockApiSetting
    {

        public static string ApiName = "InvoiceApiUrl";

        public static string OutStockHandle = "services/core.ashx";

        public static string request_service = "InvoiceFlowHandle";

        public static string request_item = "一键出库";
