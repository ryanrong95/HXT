    ...
    public class ContractWLT
    {
        ...
        static DataTable GetData(List<DecProduct> items, string currency, string 大写金额, decimal totalPrice, decimal orderTotalPrice)
        {
            ...
            foreach (var entity in items)
            {
                ...
                dr1["UnitPrice"] = entity.OrderUnitPrice.ToRound(4).ToString("0.####");//entity.UnitPrice.ToRound(4).ToString("0.####");
                dr1["TotalPrice"] = entity.OrderTotalPrice.ToRound(2);//entity.TotalPrice.ToRound(2);
                dt.Rows.Add(dr1);
        ...
        public ContractWLT(Vendor vendor, string fileName, Contract contract)
        {
            this.Vendor = vendor;
        ...
        public void Execute()
        {
            ...
            parameters.Add("Part标题及Logo", new { Vendor = this.Vendor, Contract = this.Contract, });
            parameters.Add("Part卖方买方", new { Vendor = this.Vendor, });
            ...
            pdfBuilder.DottedFunNames.Add("Part卖方买方");
        ...
        private static object Part标题及Logo(object sender, EventArgs<PdfBuilder> e)
        {
            ...
            var titlePara1 = new Paragraph(new Chunk("SALES CONTRACT", new Font(baseFont1, 22f, Font.BOLD | Font.UNDERLINE)))
            {
                Alignment = Rectangle.ALIGN_CENTER,
            };
            var titlePara2 = new Paragraph(new Chunk("                                 DATE: " + contract.DDate, new Font(baseFont, 8f, Font.NORMAL)))
            {
                Alignment = Rectangle.ALIGN_LEFT,
            };
            var titlePara3 = new Paragraph(new Chunk("                          CONTRACT NO: " + contract.ContractNo, new Font(baseFont, 8f, Font.NORMAL)))
            {
                Alignment = Rectangle.ALIGN_LEFT,
            };
        ...
        private static object Part卖方买方(object sender, EventArgs<PdfBuilder> e)
        {
            ...
            var cell1 = new PdfPCell(new Phrase("SELLER (卖方):", new Font(baseFont, 8f, Font.NORMAL)))
            {
            ...
            var cell2 = new PdfPCell(new Phrase(vendor.CompanyName, new Font(baseFont, 8f, Font.NORMAL)))
            {
            ...
            var cell3 = new PdfPCell(new Phrase("PURCHASER (买方):", new Font(baseFont, 8f, Font.NORMAL)))
            {
                HorizontalAlignment = Rectangle.ALIGN_RIGHT,
                PaddingTop = 2f,
                PaddingBottom = 6f,
            ...
            var cell4 = new PdfPCell(new Phrase(PurchaserContext.Current.DomesticConsigneeEname.ToUpper(), new Font(baseFont, 8f, Font.NORMAL)))
            {
                HorizontalAlignment = Rectangle.ALIGN_LEFT,
                PaddingTop = 2f,
                PaddingBottom = 6f,
        ...
        private static object Part数据(object sender, EventArgs<PdfBuilder> e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                for (int j = 0; j < dt.Columns.Count; j++)
                {
                    ...
                    if (cell.Phrase.Content.Contains("合同金额(大写)")|| cell.Phrase.Content.Contains("运保杂费"))
                    {
