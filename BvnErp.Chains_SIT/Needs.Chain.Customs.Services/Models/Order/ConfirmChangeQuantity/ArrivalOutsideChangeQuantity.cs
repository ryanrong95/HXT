...
namespace Needs.Ccs.Services.Models
{
    ...
    /// 外单修改数量 Do
    /// </summary>
    public class ArrivalOutsideChangeQuantity : IChangeQuantityDo
    {
        ...
        public ArrivalOutsideChangeQuantity(Layer.Data.Sqls.ScCustomsReponsitory reponsitory, string orderItemID, decimal newQuantity, decimal unitPrice, string orderID,
