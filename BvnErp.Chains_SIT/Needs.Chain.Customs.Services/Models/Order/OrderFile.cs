...
namespace Needs.Ccs.Services.Models
{
    ...
    /// </summary>
    [Serializable]
    public class OrderFile : IUnique, IPersist, IFulError, IFulSuccess
    {
        #region 属性
        ...
        public void Abandon()
        {
            using (Layer.Data.Sqls.ScCustomsReponsitory reponsitory = new Layer.Data.Sqls.ScCustomsReponsitory())
            {
                reponsitory.Update<Layer.Data.Sqls.ScCustoms.OrderFiles>(new { Status = Enums.Status.Delete }, item => item.ID == this.ID);
            }
        ...
        public void Delete()
        {
            using (Layer.Data.Sqls.ScCustomsReponsitory reponsitory = new Layer.Data.Sqls.ScCustomsReponsitory())
            {
                reponsitory.Delete<Layer.Data.Sqls.ScCustoms.OrderFiles>(item => item.ID == this.ID);
            }
