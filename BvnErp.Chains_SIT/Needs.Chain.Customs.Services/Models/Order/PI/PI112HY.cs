...
{
    public class PI112HY : PIBuilder
    {
        public PI112HY(string fileName, List<Views.OrderItemSupplierViewModel> items, string piNo, string clientName) : base(fileName, items, piNo, clientName)
        {
        ...
        public override void Execute()
        {
            ...
            pdfBuilder.AddStep(PartSecend);
            pdfBuilder.AddStep(PartSoldTo);
            ...
            pdfBuilder.AddStep(PartBlank);
            pdfBuilder.AddStep(PartSingnature);
        ...
        private static object PartTitle(object sender, EventArgs<PdfBuilder> e)
        {
            ...
            Image image11 = Image.GetInstance(System.Configuration.ConfigurationManager.AppSettings["ContentPath"] + @"\Content\Images\Logos\环宇.png");
            ...
            cell2.AddElement(new Phrase("HK Huanyu Electronics Technology   co., ltd", new Font(baseFont, 16f, Font.NORMAL)));
            cell2.AddElement(new Phrase(" ", new Font(baseFont, 8f, Font.NORMAL)));
            cell2.AddElement(new Phrase("香港環宇電子科技有限公司   COMMERCIAL INVOICE", new Font(baseFont, 16f, Font.NORMAL)));
        ...
        private static object PartSecend(object sender, EventArgs<PdfBuilder> e)
        {
            ...
            var cell1 = new PdfPCell();
            cell1.AddElement(new Phrase("  Room 503, 5/F, Wayson Commercial Building, 28", new Font(baseFont, 10f, Font.NORMAL)));
            cell1.AddElement(new Phrase("    Connaught Road West, Sheung Wan Hong Kong", new Font(baseFont, 10f, Font.NORMAL)));
            cell1.AddElement(new Phrase("                            TEL: +852-34210530", new Font(baseFont, 10f, Font.NORMAL)));
            cell1.DisableBorderSide(15);
            table.AddCell(cell1);

            var cell2 = new PdfPCell();
            cell2.AddElement(new Phrase("INV. NO :  " + piNo, new Font(baseFont, 10f, Font.NORMAL)));
            cell2.AddElement(new Phrase("DATE:      " + DateTime.Now.AddDays(-1).ToString("yyyyMMdd"), new Font(baseFont, 10f, Font.NORMAL)));
            cell2.AddElement(new Phrase("SHIPPING NO :", new Font(baseFont, 10f, Font.NORMAL)));
            cell2.DisableBorderSide(15);
            table.AddCell(cell2);
        ...
        private static object PartSoldTo(object sender, EventArgs<PdfBuilder> e)
        {
            //var entity = (PdfBuilder)e.Entity;
            ...
            var cell1 = new PdfPCell();
            cell1.AddElement(new Phrase("SOLD TO:", new Font(baseFont, 10f, Font.NORMAL)));
            cell1.DisableBorderSide(15);
            table.AddCell(cell1);
            ...
            cell3.AddElement(new Phrase("PAYMENT TERMS", new Font(baseFont, 10f, Font.NORMAL)));
        ...
        private static object PartShipTo(object sender, EventArgs<PdfBuilder> e)
        {
            ...
            var cell2 = new PdfPCell();
            cell2.AddElement(new Phrase("HONG KONG CHANGYUN INTERNATIONAL LOGISTICS CO", new Font(baseFont, 10f, Font.NORMAL)));
            cell2.AddElement(new Phrase("LIMITED", new Font(baseFont, 10f, Font.NORMAL)));
            cell2.DisableBorderSide(15);
            table.AddCell(cell2);

            var cell3 = new PdfPCell();
            cell3.AddElement(new Phrase("SHIPPING TERMS :", new Font(baseFont, 10f, Font.NORMAL)));
            cell3.DisableBorderSide(15);
            table.AddCell(cell3);
        ...
        private static object PartLast(object sender, EventArgs<PdfBuilder> e)
        {
            ...
            cell1.AddElement(new Phrase("Company Name： HK Huanyu Electronics Technology co., ltd.", new Font(baseFont, 10f, Font.NORMAL)));
            cell1.AddElement(new Phrase("Company bank account：012- 591-2-005070-5", new Font(baseFont, 10f, Font.NORMAL)));
            cell1.AddElement(new Phrase("  ", new Font(baseFont, 10f, Font.NORMAL)));
            cell1.AddElement(new Phrase("1.We can’t accept returns without RMA and real failure test report.", new Font(baseFont, 10f, Font.NORMAL)));
            cell1.AddElement(new Phrase("2.No refunds are issued after 30 days of receipt of parts or otherwise specified.", new Font(baseFont, 10f, Font.NORMAL)));
            cell1.DisableBorderSide(15);
            table.AddCell(cell1);
        ...
        private static object PartBlank(object sender, EventArgs<PdfBuilder> e)
        {
            //var entity = (PdfBuilder)e.Entity;
            ...
            Image image11 = Image.GetInstance(System.Configuration.ConfigurationManager.AppSettings["ContentPath"] + @"\Content\Images\Signs\HY.png");
            image11.ScalePercent(40f);
            var bbbb = new PdfPCell(image11) { VerticalAlignment = Rectangle.ALIGN_CENTER, PaddingLeft = 5f, };
            bbbb.DisableBorderSide(15);
            table.AddCell(bbbb);
        ...
        private static object PartSingnature(object sender, EventArgs<PdfBuilder> e)
        {
            //var entity = (PdfBuilder)e.Entity;
            ...
            table.TotalWidth = 500; //绝对宽度
            table.LockedWidth = true;
            table.SetWidths(new int[] { 70, 25, 5, });
            ...
            var cell2 = new PdfPCell();
            cell2.AddElement(new Phrase("  Authorized Singnature", new Font(baseFont, 10f, Font.NORMAL)));
            cell2.DisableBorderSide(14);
            table.AddCell(cell2);
