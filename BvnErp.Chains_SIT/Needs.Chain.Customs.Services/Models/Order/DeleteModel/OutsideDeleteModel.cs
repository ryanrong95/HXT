...
namespace Needs.Ccs.Services.Models
{
    ...
    /// 外单删除型号 Do
    /// </summary>
    public class OutsideDeleteModel : DeleteModelDo
    {
        ...
        public OutsideDeleteModel(Layer.Data.Sqls.ScCustomsReponsitory reponsitory, string orderItemID, string sortingID, string orderID, Enums.OrderStatus orderStatus,
