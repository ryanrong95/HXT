...
namespace Needs.Ccs.Services.Views
{
    ...
    /// 陈翰陆凯优化
    /// </remarks>
    public class OrdersBillsView : UniqueView<Models.OrderBill, ScCustomsReponsitory>
    {
        public OrdersBillsView()
        {

        }

        public OrdersBillsView(ScCustomsReponsitory reponsitory) : base(reponsitory)
        {
        }
