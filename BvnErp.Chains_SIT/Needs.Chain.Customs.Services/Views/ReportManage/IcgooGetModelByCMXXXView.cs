...
{
    public class IcgooGetModelByCMXXXView : UniqueView<Models.IcgooModelDetail, ScCustomsReponsitory>
    {
        private string CMXXX;

        public IcgooGetModelByCMXXXView()
        { }

        public IcgooGetModelByCMXXXView(string CMXXX)
        {
            this.CMXXX = CMXXX;
        }

        internal IcgooGetModelByCMXXXView(ScCustomsReponsitory reponsitory) : base(reponsitory)
        {
        }
        ...
        public IQueryable<IcgooModelDetail> GetModelDetailPre()
        {
            ...
            var result = from orderitem in orderitems
                         ...
                         select new IcgooModelDetail
                         {
                             ...
                             //InvoiceType = invoice?.InvoiceType.GetDescription(),
        ...
        public Layer.Data.Sqls.ScCustoms.OrderItems[] GetOrderItems()
        {
            return (from orderitem in this.Reponsitory.ReadTable<Layer.Data.Sqls.ScCustoms.OrderItems>()
                    join map in this.Reponsitory.ReadTable<Layer.Data.Sqls.ScCustoms.IcgooOrderMap>() on orderitem.OrderID equals map.OrderID
                    where map.IcgooOrder == this.CMXXX
                    select orderitem
                    ).ToArray();
        }
