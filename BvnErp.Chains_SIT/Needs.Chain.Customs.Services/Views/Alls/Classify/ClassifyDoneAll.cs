...
{
    public class ClassifyDoneAll : View<Models.ClassifyDoneAllModels, ScCustomsReponsitory>
    {
        protected override IQueryable<Models.ClassifyDoneAllModels> GetIQueryable()
        {
            ...
            var query = from category in this.Reponsitory.ReadTable<Layer.Data.Sqls.ScCustoms.OrderItemCategories>()
                        ...
                        select new Models.ClassifyDoneAllModels
                        {
                            ...
                            IsOrdered = true,
                            OrderID = order.ID,
                            ClassifyLog = logs.Where(t => t.Model == orderitem.Model && t.Manufacturer == orderitem.Manufacturer).Select(t => t.Summary)
                        };
