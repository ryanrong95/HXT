...
{
    public class BuyImportView : UniqueView<Models.AcceptanceBill, ScCustomsReponsitory>
    {
        public BuyImportView()
        {
        }

        internal BuyImportView(ScCustomsReponsitory reponsitory) : base(reponsitory)
        {
        }
