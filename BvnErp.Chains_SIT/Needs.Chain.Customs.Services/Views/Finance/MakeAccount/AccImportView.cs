...
{
    public class AccImportView : UniqueView<Models.AcceptanceBill, ScCustomsReponsitory>
    {
        public AccImportView()
        {
        }

        internal AccImportView(ScCustomsReponsitory reponsitory) : base(reponsitory)
        {
        }
        ...
        protected override IQueryable<Models.AcceptanceBill> GetIQueryable()
        {
            ...
            var result = from c in this.Reponsitory.ReadTable<Layer.Data.Sqls.ScCustoms.MoneyOrders>()
                         ...
                         //join fundTran in this.Reponsitory.ReadTable<Layer.Data.Sqls.ScCustoms.FundTransferApplies>()
                         //on c.Code equals fundTran.FromSeqNo
                         //join fundTranAccount in accountsView on fundTran.OutAccountID equals fundTranAccount.ID
                         select new Models.AcceptanceBill
                         {
                             ...
                             //FundTransferAccountName = fundTranAccount.AccountName,
