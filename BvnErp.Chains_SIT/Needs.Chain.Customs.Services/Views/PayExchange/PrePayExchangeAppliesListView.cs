...
{
    public class PrepaymentApplyListView : QueryView<PrepaymentApplyListViewModel, ScCustomsReponsitory>
    {
        public PrepaymentApplyListView()
        {
        }

        protected PrepaymentApplyListView(ScCustomsReponsitory reponsitory, IQueryable<PrepaymentApplyListViewModel> iQueryable) : base(reponsitory, iQueryable)
        {
        }

        protected override IQueryable<PrepaymentApplyListViewModel> GetIQueryable()
        {
            ...
            var iQuery = from paymentApplyItem in payExchangeApplyItems
                         ...
                         select new PrepaymentApplyListViewModel
                         {
    ...
    public class PrepaymentApplyListViewModel
    {
        /// <summary>
        /// PayExchangeApplyID
        /// </summary>
