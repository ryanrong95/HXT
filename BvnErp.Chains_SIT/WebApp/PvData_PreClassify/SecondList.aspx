<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecondList.aspx.cs" Inherits="WebApp.PvData_PreClassify.SecondList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Search(flag) {
            ...
            var DueDateBegin = $('#DueDateBegin').textbox('getValue');
            var DueDateEnd = $('#DueDateEnd').textbox('getValue');
        ...
        function Reset() {
            ...
            $('#DueDateBegin').textbox('setValue', null);
            $('#DueDateEnd').textbox('setValue', null);
    ...
    <div id="topBar">
        ...
        <div id="search">
            <ul>
                ...
                <li>
                    <span class="lbl">到货时间: </span>
                    <input class="easyui-datebox" data-options="" id="DueDateBegin" />
                    <span class="lbl" style="margin: 0 12px;">至</span>
                    <input class="easyui-datebox" data-options="" id="DueDateEnd" />
        ...
        <table id="products" title="待归类产品" data-options="nowrap:false,border:false,fitColumns:false,fit:true,toolbar:'#topBar',singleSelect:false,">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'DueDate',align:'center',sortable:true" style="width: 150px;">预计到货日期</th>
