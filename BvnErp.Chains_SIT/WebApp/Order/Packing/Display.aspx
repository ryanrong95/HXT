<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Display.aspx.cs" Inherits="WebApp.Order.Packing.Display" %>
        ...
        */
        ...
        function Split() {
            ...
            for (var i = 0; i < rows.length; i++) {
                if (rows[i].Status == "已封箱") {
                    $.messager.alert('提示', '请勾选未封箱的箱号！');
                    return;
                } else {
                    ids.push(rows[i].BoxIndex);
                }

            }
            id = ids.join();

            var referenceInfo1 = $("#products-area").html();
            var referenceInfo2 = $("#packing-list-area").html();

            var model = {
                ID: id,
                OrderID: Order.ID,
                //Summary: $('#Summary').textbox('getValue')
                ReferenceInfo1: referenceInfo1,
    ...
    <div class="easyui-panel" style="width: 100%; height: 100%; border: 0px;">
        ...
        <div style="text-align: center; height: 40%; margin: 5px;">
            <table id="products">
                <thead>
                    <tr>
                        <th data-options="field:'Batch',align:'center'" style="width: 150px">批号</th>
                        ...
                        <th data-options="field:'DeclaredQuantity',align:'center'" style="width: 150px">已申报数量</th>
                        <th data-options="field:'TotalPrice',align:'center',formatter:FormatTotalPrice" style="width: 150px">总价</th>
                        <th data-options="field:'GrossWeight',align:'center'" style="width: 150px">毛重</th>
                        <th data-options="field:'ProductDeclareStatus',align:'center'" style="width: 100px">申报状态</th>
                    </tr>
                </thead>
            </table>
        </div>
        ...
        <div style="margin-left: 5px; margin-top: 20px">
            <label id="hangUpMsg">该订单已挂起,不能拆分</label>
            <a id="btnSplit" href="javascript:void(0);" class="easyui-linkbutton ml10" data-options="iconCls:'icon-search'" onclick="Split()">拆分报关</a>
        </div>
        <div style="text-align: center; margin: 5px; height: 40%">
            <table id="DivInf" data-options="fit:false,queryParams:{ action: 'dataPackings' }">
                <thead>
                    <tr>
                        ...
                        <th data-options="field:'BoxIndex',align:'center'" style="width: 150px">箱号</th>
                        <th data-options="field:'Model',align:'center'" style="width: 120px">型号</th>
                        <th data-options="field:'CustomsName',align:'center'" style="width: 180px">品名</th>
                        <th data-options="field:'Manufacturer',align:'center'" style="width: 150px">品牌</th>
                        <th data-options="field:'Origin',align:'center'" style="width: 150px">产地</th>
                        <th data-options="field:'Quantity',align:'center'" style="width: 150px">数量</th>
                        <th data-options="field:'GrossWeight',align:'center'" style="width: 150px">毛重（KG）</th>
                        <th data-options="field:'PickDate',align:'center'" style="width: 150px;">装箱日期</th>
                        <th data-options="field:'Status',align:'center'" style="width: 150px">状态</th>
                    </tr>
                </thead>
            </table>
        </div>
