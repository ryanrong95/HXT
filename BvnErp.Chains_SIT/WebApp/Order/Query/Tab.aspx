<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tab.aspx.cs" Inherits="WebApp.Order.Query.Tab" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            AddTab('order', '详情', '../Detail2.aspx?ID=' + id + '&From=' + from, 'detail',2000);
            ...
            AddTab('order', '杂费', '../Fee/Display.aspx?ID=' + id + '&From=' + from, 'fee',900);
