<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Exited.aspx.cs" Inherits="WebApp.ExitOrder.Exit.Exited" %>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="datagrid" title="已出库" data-options="fitColumns:true,fit:true,scrollbarSize:0,singleSelect:true" class="easyui-datagrid" style="width: 100%; height: 100%" toolbar="#topBar">
            <thead>
                <tr>
