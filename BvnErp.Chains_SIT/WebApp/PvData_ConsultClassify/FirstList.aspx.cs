...
namespace WebApp.PvData_ConsultClassify
{
    ...
    public partial class FirstList : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            Expression<Func<PD_PreClassifyProduct, bool>> expression = item => item.ClassifyStatus == ClassifyStatus.Unclassified && item.PreProduct.UseType == PreProductUserType.Consult;
            ...
            var products = Needs.Wl.Admin.Plat.AdminPlat.Current.Classify.PD_PreClassifyProductsAll.GetPageList(
                page,
                rows,
                expression,
        ...
        protected object ValidateClassify()
        {
            try
            {
                ...
                var preClassifyProduct = Needs.Wl.Admin.Plat.AdminPlat.Current.Classify.PD_PreClassifyProductsStep1[itemId];
