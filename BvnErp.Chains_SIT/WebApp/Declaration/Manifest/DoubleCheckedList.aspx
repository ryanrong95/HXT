<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoubleCheckedList.aspx.cs" Inherits="WebApp.Declaration.Manifest.DoubleCheckedList" %>
...
<%--        var Status = eval('(<%=this.Model.Status%>)');--%>
        ...
        function Edit(index) {
            ...
            if (rowdata) {
                var url = location.pathname.replace(/DoubleCheckedList.aspx/ig, 'Edit.aspx') + '?ID=' + rowdata.BillNo + '&Edit=true&VoyageNo=' + rowdata.VoyageNo;
                $.myWindow({
                    iconCls: "",
                    url: url,
                    noheader: false,
