...
{
    public partial class DoubleCheckedList : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            //已复核状态
            ManifestBills = ManifestBills.Where(item => item.CusMftStatus == Needs.Ccs.Services.MultiEnumUtils.ToCode<Needs.Ccs.Services.Enums.CusMftStatus>(Needs.Ccs.Services.Enums.CusMftStatus.DoubleChecked));
