...
namespace WebApp.Declaration.DeclarantCandidates
{
    ...
    /// 设置核对人
    /// </summary>
    public partial class SetChecker : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            declarantCandidatesView = declarantCandidatesView.Where(t => t.Type == Needs.Ccs.Services.Enums.DeclarantCandidateType.Checker);
