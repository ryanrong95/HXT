...
namespace WebApp.Declaration.DeclarantCandidates
{
    ...
    /// 设置候选制单人
    /// </summary>
    public partial class SetCandidateMainfestDoubleChecker : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            declarantCandidatesView = declarantCandidatesView.Where(t => t.Type == Needs.Ccs.Services.Enums.DeclarantCandidateType.ManifestDoubleChecker);
