...
namespace WebApp.Declaration.DeclarantCandidates
{
    ...
    /// 设置候选发单人
    /// </summary>
    public partial class SetCandidateCustomSubmiter : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            declarantCandidatesView = declarantCandidatesView.Where(t => t.Type == Needs.Ccs.Services.Enums.DeclarantCandidateType.CustomSubmiter);
