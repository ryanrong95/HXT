<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyDoubleChecker.aspx.cs" Inherits="WebApp.Declaration.DeclarantCandidates.ModifyDoubleChecker" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ModifyCustomSubmiter(DecHeadID, OrderID) {
            ...
            var url = location.pathname.replace(/ModifyDoubleChecker.aspx/ig, 'ModifyDoubleCheckerWindow.aspx') + "?Params=" + params;
...
<body class="easyui-layout">
    ...
    <table id="datagrid" title="调整报关单复核员" data-options="nowrap:false,fitColumns:true,fit:true,border:false,singleSelect:false," toolbar="#topBar">
        <thead>
            <tr>
                ...
                <th data-options="field:'DoubleCheckerName',align:'left'" style="width: 8%">复核员</th>
