<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetChecker.aspx.cs" Inherits="WebApp.Declaration.DeclarantCandidates.SetChecker" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Add() {
            var url = location.pathname.replace(/SetChecker.aspx/ig, 'AddDeclarantCandidate.aspx')
                + "?From=<%=Needs.Ccs.Services.Enums.DeclarantCandidateType.Checker.ToString()%>";
...
<body class="easyui-layout">
    ...
    <table id="Checkers" title="设置核对人" data-options="nowrap:false,fitColumns:true,fit:true,border:false,singleSelect:false," toolbar="#topBar">
        <thead>
            <tr>
                <th data-options="field:'AdminName',align:'left'" style="width: 10%">核对人</th>
