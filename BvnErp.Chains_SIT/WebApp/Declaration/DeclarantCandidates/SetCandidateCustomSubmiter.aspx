<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetCandidateCustomSubmiter.aspx.cs" Inherits="WebApp.Declaration.DeclarantCandidates.SetCandidateCustomSubmiter" %>
...
<head runat="server">
    ...
    <title>设置候选录入及申报员</title>
    <uc:EasyUI runat="server" />
    <script src="../../Scripts/Ccs.js"></script>
    <link href="../../App_Themes/xp/Style.css" rel="stylesheet" />
    <script type="text/javascript">
        $(function () {
            $('#CustomSubmiters').myDatagrid({
                nowrap: false,
                fitColumns: true,
                fit: true,
                border: false,
        ...
        function Add() {
            var url = location.pathname.replace(/SetCandidateCustomSubmiter.aspx/ig, 'AddDeclarantCandidate.aspx')
                + "?From=<%=Needs.Ccs.Services.Enums.DeclarantCandidateType.CustomSubmiter.ToString()%>";
            ...
            self.$.myWindow({
                ...
                url: url,
                onClose: function () {
                    $('#CustomSubmiters').datagrid('reload');
                }
            });
        }
...
<body class="easyui-layout">
    ...
    <table id="CustomSubmiters" title="设置候选录入及申报员" data-options="nowrap:false,fitColumns:true,fit:true,border:false,singleSelect:false," toolbar="#topBar">
        <thead>
            <tr>
                <th data-options="field:'AdminName',align:'left'" style="width: 10%">候选录入及申报员</th>
