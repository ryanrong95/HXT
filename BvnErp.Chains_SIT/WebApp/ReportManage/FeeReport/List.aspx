<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.ReportManage.FeeReport.List" %>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="datagrid" title="费用汇总" data-options="fitColumns:false,fit:true,toolbar:'#topBar'">
            <thead>
                <tr>
                    <th data-options="field:'Date',align:'left',width:100">日期</th>
                    <th data-options="field:'ClientName',align:'center',width:200">客户名称</th>
                    <th data-options="field:'OrderID',align:'center',width:180">订单号</th>
                    <th data-options="field:'Type',align:'center',width:130">费用科目明细</th>
                    <th data-options="field:'ReceivableAmount',align:'center',width:130">应付未税金额</th>
                    <th data-options="field:'ReceivableCurrency',align:'center',width:130">应付币制</th>
                    <th data-options="field:'PayableAmount',align:'center',width:130">应收未税金额</th>
                    <th data-options="field:'PayableCurrency',align:'center',width:60">应收币种</th>
                    ...
                    <th data-options="field:'Discount',align:'center',width:90">费用优惠</th>
                    <th data-options="field:'FeeCreator',align:'center',width:80">制单人</th>
