<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View.aspx.cs" Inherits="WebApp.Finance.CostApply.View" %>
...
<body class="easyui-layout">
    ...
    <div style="margin-top: 10px; margin-left: 2%; float: left; width: 660px;">
        ...
        <div style="float: left; width: 300px;">
            ...
            <div class="view-location" style="height: 190px; margin-top: 10px;">
                    ...
                    <div class="sub-container">
                        <table class="row-info" style="width: 100%;" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td>
                                    <label class="lbl" id="CostType"></label>
                                </td>
                            </tr>
                            <tr>
                                <td class="lbl">费用名称：</td>
                                <td>
                                    <label class="lbl" id="FeeTypeOrFeeDesc"></label>
                                </td>
                            </tr>
                            <tr>
                                <td class="lbl">金额：</td>
                                <td>
                                    <label class="lbl" id="Amount"></label>
                                </td>
                            </tr>
                            <tr>
                                <td class="lbl">币种：</td>
                                <td>
                                    <label class="lbl" id="Currency"></label>
                                </td>
                            </tr>
                            <tr>
                                <td class="lbl">申请人：</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="lbl" id="Summary"></label>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <div class="big-row-two view-location" style="width: calc(90% - 35% - 10px - 3px); float: left; margin-top: 10px; margin-left: 10px;">
        ...
        <div id="approve-operation-area" style="display: none;">
            <div style="padding-top: 10px; width: 660px; clear: both;">
                                ...
                                <div style="margin-top: 5px;">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="easyui-textbox" id="ApproveSummary" data-options="multiline:true,validType:'length[1,100]',tipPosition:'top'," style="width: 580px; height: 60px">
                                            </td>
                                        </tr>
                                    </table>
                                </div>
