<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproverListApped.aspx.cs" Inherits="WebApp.Finance.CenterCostApply.ApproverListApped" %>
...
<head runat="server">
    ...
    <title>费用申请-已审批(经理)</title>
    <link href="../../App_Themes/xp/Style.css" rel="stylesheet" />
    <uc:EasyUI runat="server" />
    <%--    <script>
        gvSettings.fatherMenu = '费用申请';
        gvSettings.menu = '已审批（经理）';
        gvSettings.summary = '';
    </script>--%>
