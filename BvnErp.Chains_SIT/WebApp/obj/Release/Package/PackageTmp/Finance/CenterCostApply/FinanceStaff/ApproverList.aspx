<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproverList.aspx.cs" Inherits="WebApp.Finance.CenterCostApply.FinanceStaff.ApproverList" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>费用申请-待审批(财务)</title>
    <link href="../../../App_Themes/xp/Style.css" rel="stylesheet" />
    <uc:EasyUI runat="server" />
    <%--<script>
        gvSettings.fatherMenu = '费用申请';
        gvSettings.menu = '待审批（财务）';
        gvSettings.summary = '';
    </script>--%>
