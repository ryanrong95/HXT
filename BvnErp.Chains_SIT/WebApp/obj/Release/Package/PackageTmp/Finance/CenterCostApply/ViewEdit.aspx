<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewEdit.aspx.cs" Inherits="WebApp.Finance.CenterCostApply.ViewEdit" %>
        ...
        $(function () {
            ...
            $('#items').myDatagrid({
                ...
                columns: [[
                    ...
                    {
                        field: 'FeeDesc', title: '摘要', width: 160, align: 'center',
                        editor: { type: 'textbox', options: { required: true } }
                    },
                    {
                        field: 'AccountCatalogID', title: '费用类型', width: 180, align: 'center',
                        formatter: function (value) {
                            var array = AccountCatalogs;
                        ...
                        editor: {
                            type: 'combotree',
                            options: {
                                data: eval(AccountCatalogsJson), required: true, onBeforeSelect: function (node) {
                    ...
                    {
                        field: 'Admin', title: '人员', width: 110, align: 'center',
                        editor: {
                            type: 'combobox',
                            options: { data: eval(XDTAdmins), required: true, valueField: "id", textField: "text" }
                        }
                    },
                    {
                    ...
                    { field: 'Btn', title: '操作', width: 60, align: 'center', formatter: Operation }
                ]],
                onLoadSuccess: function (data) {
                    if (firstLoad && From == 'Add') {
                        addNewRow();        //新增一行 
                        firstLoad = false;
                    }
                }
    ...
    <script>
        ...
        function Operation(val, row, index) {
            ...
            return ['<span class="easyui-formatted">',
                , '<a class="easyui-linkbutton"  data-options="iconCls:\'icon-yg-delete\'" onclick="Delete(\'' + index + '\');return false;"> </a> '
                , '</span>'].join('');
        }
    ...
    <style>
        .big-row-one {
            ...
            .big-row-one .easyui-panel {
                /* height: calc(180px - 28px);*/ /* 28px 是 header 的高度 */
            }
...
<body class="easyui-layout">
    ...
    <div style="margin-top: 10px; margin-left: 2%; float: left; width: 300px;">
        ...
        <div style="float: left;">
            <div id="file-area" class="left-block-one" style="padding-top: 10px">
                <div class="easyui-panel" title="附件信息" style="height: 300px;">
    ...
    <!-- 第2大列 -->
    <div style="margin-left: 10px; float: left; width: 650px; height: 500px">
        <div id="info-area" class="left-block-one" style="margin-top: 10px;">
            <div class="easyui-panel" title="费用信息" style="height: 500px;">
    ...
    <!-- 第3大列 -->
    <div style="margin-top: 10px; margin-left: 10px; float: left; width: 200px;">
        <div class="easyui-panel" title="审批流程" style="height: 500px;">
            <div class="sub-container">
                <iframe id="flow-iframe" height="415" width="200" border="0" frameborder="no"></iframe>
            </div>
        </div>
    </div>
