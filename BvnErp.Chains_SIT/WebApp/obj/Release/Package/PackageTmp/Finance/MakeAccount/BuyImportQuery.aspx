<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyImportQuery.aspx.cs" Inherits="WebApp.Finance.MakeAccount.BuyImportQuery" %>
        ...
        <table id="datagrid" title="承兑列表" data-options="fitColumns:true,fit:true,toolbar:'#topBar',rownumbers:true,singleSelect:false,">
            <thead>
                <tr>                  
                    ...
                    <th data-options="field:'BuyCreNo',align:'left'" style="width: 60px;">凭证号</th>
                    <th data-options="field:'BuyCreWord',align:'left'" style="width: 60px;">凭证字</th>  
