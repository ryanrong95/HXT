<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovedList.aspx.cs" Inherits="WebApp.Finance.FundTransferApplies.ApprovedList" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#datagrid').myDatagrid({
                ...
                nowrap: false,
                rownumbers: true,
                queryParams: {FundTransferApplyStatus:2},
            ...
            $('#FundTransferApplyStatus').combobox({
             ...
             $('#FundTransferApplyStatus').combobox("setValue", "2");           
        ...
        function Edit(index) {
            ...
            if (rowdata) {
                var url = location.pathname.replace(/ApprovedList.aspx/ig, 'PayingEdit.aspx') + "?ID=" + rowdata.ID;
                top.$.myWindow({
                    iconCls: "",
                    noheader: false,
                    title: '编辑付款',
