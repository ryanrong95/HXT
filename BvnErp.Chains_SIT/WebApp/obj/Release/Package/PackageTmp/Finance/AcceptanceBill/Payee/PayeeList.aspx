<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayeeList.aspx.cs" Inherits="WebApp.Finance.AcceptanceBill.PayeeList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddPayee() {
            var url = location.pathname.replace(/PayeeList.aspx/ig, '../../CenterCostApply/Payee/EditPayee.aspx') + '?From=Add';
        ...
        function EditPayee(CostApplyPayeeID) {
            var url = location.pathname.replace(/PayeeList.aspx/ig, '../../CenterCostApply/Payee/EditPayee.aspx') + '?From=Edit&ID=' + CostApplyPayeeID;
        ...
        function Select() {
            ...
            if (WindowName == "AcceptanceBillOut") {
                ewindow.$("#OutAccountID").val(selectPayee[0].ID);
                ewindow.$("#OutAccountName").textbox('setValue', selectPayee[0].AccountName);
                ewindow.$("#OutAccountNo").textbox('setValue', selectPayee[0].BankAccount);
                ewindow.$("#OutAccountBankName").textbox('setValue', selectPayee[0].BankName);
            } else if (WindowName == "AcceptanceBillIn") {
            ...
            } else if (WindowName == "AcceptanceBillName") {
                ewindow.$("#Name").textbox('setValue', selectPayee[0].AccountName);
                ewindow.$("#BankCode").textbox('setValue', selectPayee[0].BankAccount);
                ewindow.$("#BankName").textbox('setValue', selectPayee[0].BankName);
            } else if (WindowName == "RefundApplyAccountMatch") {
