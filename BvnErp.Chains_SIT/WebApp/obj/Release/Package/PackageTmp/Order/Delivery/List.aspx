<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Order.Delivery.List" %>
...
<head runat="server">
   ...
   <%-- <script>
    ...
    <script type="text/javascript">
        ...
        //查看订单详情
        function View(id) {
            var url = location.pathname.replace(/List.aspx/ig, '../MainDetail.aspx') + '?ID=' + id;
        ...
        function Operation(val, row, index) {
            var msg = row.HasNotified ? '已通知出库' : '出库通知';
            var icon = row.HasNotified ? 'icon-ok' : 'icon-add';
            ...
            var buttons = '<a href="javascript:void(0);" class="easyui-linkbutton l-btn l-btn-small" style="margin:3px" onclick = "View(\'' + row.MainOrderID + '\')" group >' +
                ...
                '</span>' +
                '</a>';
            buttons += '<a href="javascript:void(0);" class="easyui-linkbutton l-btn l-btn-small" style="margin:3px" onclick="ToExitNotice(\'' + row.MainOrderID + '\')" group >' +
                '<span class =\'l-btn-left l-btn-icon-left\'>' +
        ...
        <table id="orders" title="待发货" >
            <thead>
                <tr>
                    ...
                    <%--<th data-options="field:'SZDeliveryType',align:'center'" style="width: 10%;">国内交货方式</th>--%>
