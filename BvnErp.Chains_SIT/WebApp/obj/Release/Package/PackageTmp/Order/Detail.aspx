<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="WebApp.Order.Detail" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //$("body").click(function () {
            //    $("#models").prev().find(".datagrid-header").css("visibility", "");
            //});
            ...
            $('#pitable').myDatagrid({
                ...
                onLoadSuccess: function (data) {
                    ...
                    var heightValue = $("#pitable").prev().find(".datagrid-body").find(".datagrid-btable").height() + 30;
                    $("#pitable").prev().find(".datagrid-body").height(heightValue);
                    $("#pitable").prev().height(heightValue);
                    $("#pitable").prev().parent().height(heightValue);
                    $("#pitable").prev().parent().parent().height(heightValue);
        ...
        function SetVoyage() {
            ...
            var url = location.pathname.replace(/Detail.aspx/ig,
        ...
        function Return() {
            ...
            switch (from) {
                case 'MerchandiserQuery':
                    url = location.pathname.replace(/Detail.aspx/ig, 'Query/List.aspx');
                    break;
                case 'SalesQuery':
                    url = location.pathname.replace(/Detail.aspx/ig, 'Query/SalesList.aspx');
                    break;
                case 'AdminQuery':
                    url = location.pathname.replace(/Detail.aspx/ig, 'Query/AdminList.aspx');
                    break;
                case 'InsideQuery':
                    url = location.pathname.replace(/Detail.aspx/ig, 'Query/InsideList.aspx');
                    break;
                default:
                    url = location.pathname.replace(/Detail.aspx/ig, 'Query/List.aspx');
                    break;
                ...
                <table id="models" title="产品信息">
                    <thead>
                        <tr>
                            ...
                            <th data-options="field:'Model',align:'left'" style="width: 20%;">型号</th>
                            ...
                            <th data-options="field:'Unit',align:'center'" style="width: 8%;">单位</th>
                            <th data-options="field:'Origin',align:'center'" style="width: 8%;">产地</th>
                            <th data-options="field:'GrossWeight',align:'center'" style="width: 8%;">毛重</th>--%>

                            <th data-options="field:'Name',align:'left'" style="width: 20%;">品名</th>
                            <th data-options="field:'Manufacturer',align:'center'" style="width: 10%;">品牌</th>
                            <th data-options="field:'Model',align:'left'" style="width: 20%;">型号</th>
                            ...
                            <th data-options="field:'TotalPrice',align:'center'" style="width:5%;">总价</th>
                            <th data-options="field:'Unit',align:'center'" style="width:5%;">单位</th>
                            <th data-options="field:'Origin',align:'center'" style="width:10%;">产地</th>
                            <th data-options="field:'GrossWeight',align:'center'" style="width: 10%;">毛重</th>
                            <th data-options="field:'Btn',align:'left',formatter:OperationModel" style="width: 10%;">操作</th>
                        </tr>
                    </thead>
                </table>
            </div>
