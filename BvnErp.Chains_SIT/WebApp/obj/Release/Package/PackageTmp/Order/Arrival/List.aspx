<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Order.Arrival.List" %>
        ...
        <table id="orders" title="待报关订单" data-options="border:false,nowrap:false,fitColumns:true,fit:true,toolbar:'#topBar'">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'Currency',align:'center'" style="width: 7%;">币种</th>
                    <th data-options="field:'SupplierName',align:'center'" style="width: 15%;">供应商</th>
