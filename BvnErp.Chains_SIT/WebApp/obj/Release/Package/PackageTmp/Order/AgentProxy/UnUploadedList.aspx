<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnUploadedList.aspx.cs" Inherits="WebApp.Order.AgentProxy.UnUploadedList" %>
...
<head runat="server">
    ...
    <title>待上传代理报关委托书</title>
    <link href="../../App_Themes/xp/Style.css" rel="stylesheet" />
    <uc:EasyUI runat="server" />
   <%-- <script>
        gvSettings.fatherMenu = '代理报关委托书(XDT)';
        gvSettings.menu = '待上传';
        gvSettings.summary = '跟单员上传代理报关委托书';
    </script>--%>
    <script type="text/javascript">
        ...
        function Instrument(ID) {
            var url = location.pathname.replace(/UnUploadedList.aspx/ig, 'Instrument.aspx') + '?ID=' + ID + '&From=UnUploaded';
            window.location = url;
        }
