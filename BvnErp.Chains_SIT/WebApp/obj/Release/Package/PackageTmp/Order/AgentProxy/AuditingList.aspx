<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditingList.aspx.cs" Inherits="WebApp.Order.AgentProxy.AuditingList" %>
...
<head runat="server">
    ...
    <title>待审核代理报关委托书</title>
    <link href="../../App_Themes/xp/Style.css" rel="stylesheet" />
    <uc:EasyUI runat="server" />
   <%-- <script>
        gvSettings.fatherMenu = '代理报关委托书(XDT)';
        gvSettings.menu = '待审核';
        gvSettings.summary = '跟单员审核客户上传的代理报关委托书';
    </script>--%>
    <script type="text/javascript">
        ...
        function Instrument(ID) {
            var url = location.pathname.replace(/AuditingList.aspx/ig, 'Instrument.aspx') + '?ID=' + ID + '&From=Auditing';
            window.location = url;
        }
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="orders" title="待审核" data-options="border:false,nowrap:false,fitColumns:true,fit:true,toolbar:'#topBar'">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'ClientName',align:'left'" style="width: 15%;">委托方</th>
                    <th data-options="field:'AgentName',align:'left'" style="width: 15%;">代理方</th>                   
