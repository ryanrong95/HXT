<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reason.aspx.cs" Inherits="WebApp.Order.Reason" %>
    ...
    <div id="Edit" class="easyui-panel" data-options="border:false,fit:true,closable:true,onClose:function(){$.myWindow.close();}" style="margin-top: 10px">
        <form id="form1" runat="server" method="post">
            <div data-options="region:'center',border:false" style="text-align: center">
                <input id="reason" name="reason" class="easyui-textbox" data-options="multiline:true,required:true,tipPosition:'bottom',validType:'length[1,400]'" style="width: 350px; height: 150px" />
            </div>
