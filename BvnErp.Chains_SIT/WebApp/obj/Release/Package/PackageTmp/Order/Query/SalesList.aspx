<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesList.aspx.cs" Inherits="WebApp.Order.Query.SalesList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //查看订单信息
        function View(ID) {
            var url = location.pathname.replace(/SalesList.aspx/ig, 'Tab.aspx?ID=' + ID + '&From=SalesQuery');
            window.location = url;
        }
        ...
        function Operation(val, row, index) {
         ...
         function ViewMainOrderBill(ID) {
            var url = location.pathname.replace(/SalesList.aspx/ig, '../MainOrder/Tab.aspx?ID=' + ID + '&From=MerchandiserQuery');
            window.location = url;
        }
