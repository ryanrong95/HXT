<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Order.Packing.List" %>
...
<head runat="server">
  ...
  <%--  <script>
        ...
        gvSettings.menu = '装箱信息';
        gvSettings.summary = '跟单员查看装箱信息';
    </script>--%>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="orders" title="待报关订单" data-options="border:false,nowrap:false,fitColumns:true,fit:true,toolbar:'#topBar'">
            <thead>
                <tr>
                    <th data-options="field:'ID',align:'left'" style="width: 12%;">订单编号</th>
                    ...
                    <th data-options="field:'DeclarePrice',align:'center'" style="width: 9%;">报关总货值</th>
                    <th data-options="field:'Currency',align:'center'" style="width: 5%;">币种</th>
                    <th data-options="field:'SupplierName',align:'left'" style="width: 15%;">供应商</th>
                    <th data-options="field:'HKWay',align:'center'" style="width: 8%;">香港交货方式</th>
                    <th data-options="field:'PackingStatus',align:'center'" style="width: 8%;">封箱状态</th>
