<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditingList.aspx.cs" Inherits="WebApp.Order.Bill.AuditingList" %>
...
<head runat="server">
    ...
    <%--<script>
        ...
        gvSettings.menu = '待审核';
        gvSettings.summary = '跟单员审核客户上传的对账单';
    </script>--%>
    <script type="text/javascript">
        ...
        function OrderBill(ID) {
            var url = location.pathname.replace(/AuditingList.aspx/ig, 'OrderBill.aspx') + '?ID=' + ID + '&From=Auditing';
            window.location = url;
        }
