<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditedList.aspx.cs" Inherits="WebApp.Order.Bill.AuditedList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function OrderBill(ID) {
            var url = location.pathname.replace(/AuditedList.aspx/ig, 'OrderBill.aspx') + '?ID=' + ID + '&From=Audited';
            window.location = url;
        }
        ...
        <table id="orders" title="已审核" data-options="border:false,nowrap:false,fitColumns:true,fit:true,toolbar:'#topBar'">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'CustomsExchangeRate',align:'center'" style="width: 100px;">海关汇率</th>
                    <th data-options="field:'RealExchangeRate',align:'center'" style="width: 100px;">实时汇率</th>
