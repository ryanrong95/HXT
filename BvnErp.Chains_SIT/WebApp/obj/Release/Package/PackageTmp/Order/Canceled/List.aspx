<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Order.Canceled.List" %>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="orders" data-options="border:false,nowrap:false,fitColumns:true,fit:true,toolbar:'#topBar'" title="已取消">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'CanceledSummary',align:'left'" style="width: 14%;">取消原因</th>
