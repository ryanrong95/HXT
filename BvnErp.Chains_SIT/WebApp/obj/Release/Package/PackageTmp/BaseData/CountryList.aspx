<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CountryList.aspx.cs" Inherits="WebApp.BaseData.CountryList" %>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="datagrid" title="国家地区列表" class="easyui-datagrid" data-options="fitColumns:true,fit:true,border:false,scrollbarSize:0"  style="width: 100%; height: 100%" toolbar="#topBar"
            singleselect="true">
            <thead>
                <tr>
                    <th field="Code" data-options="align:'center'" style="width: 150px">国家地区代码</th>
