<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.InvoiceManagement.ValueAddedInvoice.List" %>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="decheads" title="增值税专用发票" data-options="
            fitColumns:true,
            fit:true,
            scrollbarSize:0,
            nowrap:false,
