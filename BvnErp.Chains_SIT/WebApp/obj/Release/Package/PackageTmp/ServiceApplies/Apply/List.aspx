<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Ccs.ServiceApplies.Apply.List" %>
        ...
        <table id="applies" data-options="singleSelect:true,fit:true,nowrap:false,scrollbarSize:0" title="注册申请" class="easyui-datagrid" style="width: 100%; height: 100%" toolbar="#topBar"
            ...
            <thead>
                <tr>
                    ...
                    <th data-options="field:'Contact',align:'center'" style="width: 9%;">联系人</th>
                    <th data-options="field:'Mobile',align:'center'" style="width: 8%;">手机</th>
                    <th data-options="field:'Tel',align:'center'" style="width: 9%;">电话</th>
                    <th data-options="field:'Email',align:'center'" style="width: 11%;">邮箱</th>
                    <th data-options="field:'Admin',align:'center'" style="width: 9%;">处理人</th>
