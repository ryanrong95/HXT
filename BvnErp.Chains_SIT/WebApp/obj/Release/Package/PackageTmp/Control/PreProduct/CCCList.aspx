<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CCCList.aspx.cs" Inherits="WebApp.Control.PreProduct.CCCList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function BatchApprove() {
            ...
            $.messager.confirm('确认', '同意报关员，所选产品无需3C认证？', function (success) {
                if (success) {
                    MaskUtil.mask();
        ...
        function BatchVeto() {
            ...
            $.messager.confirm('确认', '不同意报关员，所选产品需要3C认证？', function (success) {
                if (success) {
                    MaskUtil.mask();
    ...
    <div id="topBar">
        ...
        <div id="search">
            <ul>
                ...
                <li>
                    <span style="font-style: italic; color: orangered; font-size: 13px">*点击“同意”表示产品无需3C认证；点击“否决”表示产品需要3C认证，客户需提供证明文件。</span>
                </li>
            </ul>
        </div>
    </div>
    <div id="data" data-options="region:'center',border:false">
        <table id="controls" title="3C认证产品信息（报关员归类为无需3C认证）" data-options="nowrap:false,fitColumns:true,fit:true,toolbar:'#topBar'">
            <thead>
                <tr>
