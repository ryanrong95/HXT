<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CCCList.aspx.cs" Inherits="WebApp.Control.Headquarters.CCCList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Auditing(index) {
            ...
            var url = location.pathname.replace(/CCCList.aspx/ig, 'CCCDisplay.aspx') + '?ID=' + rowdata.ID;
            window.location = url;
        }
