<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerchandiserDetail.aspx.cs" Inherits="WebApp.GeneralManage.Profit.MerchandiserDetail" %>
    ...
    <div id="topBar">
        <div id="search">
            ...
            <%--            <div style="margin-top: 15px">
                <div class="divstyle">
                    <span style="color: red; font-size: 14px">跟单员：</span>
        ...
        <table id="datagrid" title="提成明细" data-options="
            ...
            <thead>
                <tr>
                    ...
                    <th data-options="field:'MerchandiserCommission',align:'center'" style="width: 10%;">跟单提成</th>
                </tr>
            </thead>
        </table>
    </div>
