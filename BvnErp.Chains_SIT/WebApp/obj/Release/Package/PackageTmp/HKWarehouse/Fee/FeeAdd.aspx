<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeeAdd.aspx.cs" Inherits="WebApp.HKWarehouse.Fee.FeeAdd" %>
    ...
    <script type="text/javascript">
        ...
        function ShowInfo(val, row, index) {
            return '<img src="../../App_Themes/xp/images/blue-fujian.png" />'
                + '<a href="javascript:void(0);" style="margin-left: 5px; text-decoration:none" onclick="View(\'' + row.WebUrl + '\')">' + row.Name + '</a>'
                ...
                <table id="editTable" style="margin-left: 20px">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <%-- <select class="easyui-combobox UnitPrice"  name="UnitPrice" style="width: 150px; height: 26px"
                        ...
                        <%-- <td class="div2">
                            ...
                            <select class="easyui-combobox UnitName"  name="UnitName" style="width: 95px; height: 26px"
                                data-options="required:true,editable:false">
                                <option>个</option>
                            </select>
                        </td>--%>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <div id="pi-fujian-table" class="ProductTable pi">
                                <table id="pi" data-options="pageSize:50,fitColumns:true,fit:false,pagination:false">
                                    <%-- <thead>
                                                <tr>
