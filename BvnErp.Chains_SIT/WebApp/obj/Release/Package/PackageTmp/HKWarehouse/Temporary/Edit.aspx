<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="WebApp.HKWarehouse.Temporary.Edit" %>
    ...
    <script type="text/javascript">
        ...
        function Init() {
            if (Temporary != null && Temporary != "") {
                $("#EntryNumber").combobox('setValue', Temporary.EntryNumber);
      ...
      //  var isRemovePIRow = false;
        ...
        function Save() {
            ...
            if (!isValid) {
                ...
                //验证成功
                var entryNumber = $("#EntryNumber").combobox('getValue');
...
<body class="easyui-layout">
    <div id="content" data-options="region:'center',border:false,collapsible:false,split:true" title="" style="min-width: 330px">
