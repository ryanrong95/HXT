<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetCandidateDoubleChecker.aspx.cs" Inherits="WebApp.Declaration.DeclarantCandidates.SetCandidateDoubleChecker" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Add() {
            var url = location.pathname.replace(/SetCandidateDoubleChecker.aspx/ig, 'AddDeclarantCandidate.aspx')
                + "?From=<%=Needs.Ccs.Services.Enums.DeclarantCandidateType.DoubleChecker.ToString()%>";
...
<body class="easyui-layout">
    ...
    <table id="CandidateDeclareCreators" title="候选复核员列表" data-options="nowrap:false,fitColumns:true,fit:true,border:false,singleSelect:false," toolbar="#topBar">
        <thead>
            <tr>
