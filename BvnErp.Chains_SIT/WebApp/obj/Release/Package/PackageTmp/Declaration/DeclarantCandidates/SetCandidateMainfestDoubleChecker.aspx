<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetCandidateMainfestDoubleChecker.aspx.cs" Inherits="WebApp.Declaration.DeclarantCandidates.SetCandidateMainfestDoubleChecker" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Add() {
            var url = location.pathname.replace(/SetCandidateMainfestDoubleChecker.aspx/ig, 'AddDeclarantCandidate.aspx')
                + "?From=<%=Needs.Ccs.Services.Enums.DeclarantCandidateType.ManifestDoubleChecker.ToString()%>";
...
<body class="easyui-layout">
    ...
    <table id="CandidateDeclareCreators" title="候选舱单复核员列表" data-options="nowrap:false,fitColumns:true,fit:true,border:false,singleSelect:false," toolbar="#topBar">
        <thead>
            <tr>
                <th data-options="field:'AdminName',align:'left'" style="width: 10%">候选复核员</th>
