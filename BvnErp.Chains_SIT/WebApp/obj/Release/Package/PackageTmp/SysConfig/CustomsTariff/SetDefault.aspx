<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetDefault.aspx.cs" Inherits="WebApp.SysConfig.CustomsTariff.SetDefault" %>
        ...
        function getElements() {
            ...
            $.post('?action=GetElements', { HSCode: HSCode }, function (data) {
                if (data && data != null && data != '') {
                    ...
                    var tempall = '<table style="margin: 0 auto; width: 90%;font-size:12px; border-spacing: 0px 5px;">' +
                        '<tr>' +
...
<body class="easyui-layout">
    <div id="content">
        <form id="form1" runat="server">
            <div>
                <table style="margin: 0 auto; width: 90%;font-size:12px; border-spacing: 0px 5px;">
                    <tr>
                        <th style="width: 10%"></th>
                        <th style="width: 20%"></th>
                        <th style="width: 10%"></th>
