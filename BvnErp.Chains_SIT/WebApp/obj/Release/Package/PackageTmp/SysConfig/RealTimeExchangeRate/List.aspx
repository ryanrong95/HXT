<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.SysConfig.RealTimeExchangeRate.List" %>
...
<head runat="server">
   ...
   <%-- <script>       
        ...
        gvSettings.menu = '实时汇率';
        gvSettings.summary = ''
    </script>--%>
    <script type="text/javascript">
        var exchangeRateType = '<%=this.Model.ExchangeRateType%>';
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="datagrid" title="实时汇率" class="easyui-datagrid" style="width: 100%; height: 100%" toolbar="#topBar"
            singleselect="true" fitcolumns="true" data-options="border:false">
            <thead>
                <tr>
                    <th field="Type" data-options="align:'center'" style="width: 100px">汇率时间</th>
