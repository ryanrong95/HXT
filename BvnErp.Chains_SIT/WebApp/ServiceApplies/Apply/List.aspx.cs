...
namespace WebApp.Ccs.ServiceApplies.Apply
{
    public partial class List : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            applies = applies.Where(t => t.Status == Needs.Ccs.Services.Enums.HandleStatus.Processed);
            ...
            if (!string.IsNullOrEmpty(Status))
            {
                ...
                applies = applies.Where(t => t.Status == (Needs.Ccs.Services.Enums.HandleStatus)status);
            }
            ...
            Func<Needs.Ccs.Services.Models.ServiceApplies, object> convert = apply => new
            {
                ...
                UpdateDate = apply.UpdateDate.ToShortDateString(),
