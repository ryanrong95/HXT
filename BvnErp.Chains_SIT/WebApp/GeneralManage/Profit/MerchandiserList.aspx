<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MerchandiserList.aspx.cs" Inherits="WebApp.GeneralManage.Profit.MerchandiserList" %>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script>
        ...
        function Search() {
            ...
            $('#datagrid').myDatagrid('search', { StartDate: StartDate, EndDate: EndDate, MerchandiserId: MerchandiserId });
        }
        ...
        function Reset() {
            $('#StartDate').datebox('setValue', dateMonth(0));
            $('#EndDate').datebox('setValue', dateMonth(1));
            $("#Merchandiser").combobox('setValue', "");
            Search();
        }
        ...
        function View(id) {
            if (id) {
                ...
                //window.location = url;
                var url = location.pathname.replace(/MerchandiserList.aspx/ig, 'MerchandiserDetail.aspx')
...
<body class="easyui-layout">
        ...
        <div id="search">
            <ul>
                <li>
                    ...
                    <span class="lbl">跟单员: </span>
                    <input class="easyui-combobox" id="Merchandiser" data-options="valueField:'Key',textField:'Value',limitToList:true,editable:false,missingMessage:'请选择跟单员'" name="Merchandiser" />
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="datagrid"  title="利润提成列表" >
            <thead>
                <tr>
                    <th field="Name" data-options="align:'center'" style="width: 50px">跟单员</th>
                    <th field="Profits" data-options="align:'center'" style="width: 50px">报关总货值(RMB)</th>
