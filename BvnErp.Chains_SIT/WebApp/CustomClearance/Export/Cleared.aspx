<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cleared.aspx.cs" Inherits="WebApp.CustomClearance.Cleared" %>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="datagrid" class="easyui-datagrid" title="已清关" data-options="
            fitColumns:true,
            fit:true,
            scrollbarSize:0,
            toolbar:'#topBar' ">
