<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Clearing.aspx.cs" Inherits="WebApp.OrderWaybill.Clearing" %>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="datagrid" class="mygrid" title="待清关" data-options="
            fitColumns:true,
            fit:true,
            scrollbarSize:0,
            toolbar:'#topBar',
