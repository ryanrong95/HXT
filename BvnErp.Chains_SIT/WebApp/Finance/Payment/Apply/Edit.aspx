<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="WebApp.Finance.Payment.Edit" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Init() {
            if (ApplyData != null) {
                $('#PayeeName').textbox('setValue', ApplyData['PayeeName'])
                $('#BankAccount').textbox('setValue', ApplyData['BankAccount'])
                $('#BankName').textbox('setValue', ApplyData['BankName'])
                $('#FeeType').combobox('setValue', ApplyData['FeeType'])
                $('#FeeDesc').combobox('setValue', ApplyData['FeeDesc'])
                $('#Amount').numberbox('setValue', ApplyData['Amount'])
                $('#Currency').combobox('setValue', ApplyData['Currency'])
                $('#PayType').combobox('setValue', ApplyData['PayType'])
                $('#PayDate').datebox('setValue', ApplyData['PayDate'])
            }
        }
        ...
        function Submit() {
            ...
            data.append('FeeDesc', $('#FeeDesc').textbox('getValue'))
