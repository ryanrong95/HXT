<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovedList.aspx.cs" Inherits="WebApp.Finance.Payment.PayExchange.ApprovedList" %>
...
<head runat="server">
    ...
    <script>
            ...
            $('#datagrid').myDatagrid({
                ...
                onLoadSuccess: function (data) {
                    ...
                    if (rows) {
                        ...
                        $('#SumTotal').html("合计金额：" + sum.toFixed(2));
        ...
        //查看
        function Details(id) {
            var url = location.pathname.replace(/ApprovedList.aspx/ig, 'Detail.aspx') + "?ApplyID=" + id;
            window.location = url;
        }

        //操作
        function Operation(val, row, index) {
            var buttons = '<a id="btnDetails" href="javascript:void(0);" class="easyui-linkbutton l-btn l-btn-small" style="margin:3px;" onclick="Details(\'' + row.ID + '\')" group >' +
        ...
        <div id="search">
            <table id="table1" style="margin: 5px 0 5px 0">
                <tr>
                    ...
                    <td>
                        <span id ="SumTotal" style="color:red;padding-left:20px"></span>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table id="datagrid" class="mygrid" title="付汇申请记录" data-options="
            ...
            <thead>
                <tr>
                    ...
                    <th field="SupplierName" data-options="align:'left'" style="width: 150px">供应商名称</th>
                    ...
                    <th field="IsAdvanceMoney" data-options="align:'center'" style="width: 50px">是否垫款</th>
                    <th field="FatherID" data-options="align:'center'" style="width: 50px">付汇类型</th>
                    <th data-options="field:'btn',width:'160px',formatter:Operation,align:'center'">操作</th>
                </tr>
            </thead>
        </table>
    </div>
