...
namespace WebApp.Finance.Payment.PayExchange
{
    public partial class ApprovedList : Uc.PageBase
    {
        ...
        ///// 数据加载
        ///// </summary>
        //protected void datass()
        //{
        //    string ClientCode = Request.QueryString["ClientCode"];
        //    string StartDate = Request.QueryString["StartDate"];
        //    string EndDate = Request.QueryString["EndDate"];

        //    var applyView = Needs.Wl.Admin.Plat.AdminPlat.Current.Clients.AdminPayExchangeApply.AsQueryable()
        //            .Where(item => item.PayExchangeApplyStatus == PayExchangeApplyStatus.Approvaled || item.PayExchangeApplyStatus == PayExchangeApplyStatus.Completed);
        ...
        protected void data()
        {
            ...
            int AuditedInt = (int)PayExchangeApplyStatus.Completed;
