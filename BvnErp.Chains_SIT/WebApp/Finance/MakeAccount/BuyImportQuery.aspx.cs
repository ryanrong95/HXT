...
{
    public partial class BuyImportQuery : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            var financeAccounts = new Needs.Ccs.Services.Views.AcceptanceBillView().Where(item => item.Status == Needs.Ccs.Services.Enums.Status.Normal && item.ExchangeDate != null && item.BuyCreSta == true);
