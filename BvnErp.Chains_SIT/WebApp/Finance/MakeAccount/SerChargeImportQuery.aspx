<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerChargeImportQuery.aspx.cs" Inherits="WebApp.Finance.MakeAccount.SerChargeImportQuery" %>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="payments" title="手续费" data-options="
            fitColumns:true,
            fit:true,
            scrollbarSize:0,
            nowrap:false,
            ...
            <thead>
                <tr>               
                    <th data-options="field:'RequestID',align:'left'" style="width: 60px">请求ID</th>
