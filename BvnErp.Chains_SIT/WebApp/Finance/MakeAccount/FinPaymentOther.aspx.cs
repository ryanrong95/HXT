...
{
    public partial class FinPaymentOther : Uc.PageBase
    {
        ...
        protected void MakeAccountAll()
        {
            ...
            var query = new Needs.Ccs.Services.Views.FinancePaymentViewRJ().
                            Where(t => t.FinPCreSta == false && t.PayeeName == "暂收款" && t.PayDate > sDate && t.PayDate < eDate).ToArray();
