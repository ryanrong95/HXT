<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinPaymentOther.aspx.cs" Inherits="WebApp.Finance.MakeAccount.FinPaymentOther" %>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="payments" title="进口税金" data-options="
            fitColumns:true,
            fit:true,
            scrollbarSize:0,
            nowrap:false,
            ...
            <thead>
                <tr>
                    ...
                    <th data-options="field:'FeeType',align:'center'" style="width: 40px">类型</th>
