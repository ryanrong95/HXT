<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QRImport.aspx.cs" Inherits="WebApp.Finance.MakeAccount.QRImport" %>
        ...
        <table id="datagrid" title="扫描提现" data-options="fitColumns:true,fit:true,toolbar:'#topBar',nowrap:false,rownumbers:true, singleSelect: false,">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'CreateDate',align:'left'" style="width: 100px;">完成时间</th>                                                
                </tr>
            </thead>
        </table>
    </div>
