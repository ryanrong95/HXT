<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproverListApped.aspx.cs" Inherits="WebApp.Finance.CenterCostApply.FinanceStaff.ApproverListApped" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>费用申请-已审批(财务)</title>
    <link href="../../../App_Themes/xp/Style.css" rel="stylesheet" />
    <uc:EasyUI runat="server" />
    <%--<script>
        gvSettings.fatherMenu = '费用申请';
        gvSettings.menu = '已审批（财务）';
        gvSettings.summary = '';
    </script>--%>
    <script type="text/javascript">
        ...
        function View(costApplyID) {
            var url = location.pathname.replace(/ApproverListApped.aspx/ig, '../View.aspx')
                + '?CostApplyID=' + costApplyID
                + '&From=FinanceApprover';
        ...
        function Operation(val, row, index) {
            var buttons = '';
            if (row.CostStatusInt == '<%=Needs.Ccs.Services.Enums.CostStatusEnum.FinanceStaffUnApprove.GetHashCode()%>') {
...
<body class="easyui-layout">
        ...
        <div id="search">
            <ul>
                <li>
                    ...
                    <input class="easyui-textbox" id="PayeeName" data-options="validType:'length[1,50]'" />
            ...
            <ul>
                <li>
                    ...
                    <input class="easyui-datebox" id="CreateDateBegin" data-options="validType:'length[1,50]'" />
                    <span class="lbl">至</span>
                    <input class="easyui-datebox" id="CreateDateEnd" data-options="validType:'length[1,50]'" />
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="ApproverList" title="费用申请(已审批)" data-options="toolbar:'#topBar',">
            <thead>
                <tr>
