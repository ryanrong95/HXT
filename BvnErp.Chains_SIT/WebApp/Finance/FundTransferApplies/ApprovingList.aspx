<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovingList.aspx.cs" Inherits="WebApp.Finance.FundTransferApplies.ApprovingList" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#datagrid').myDatagrid({
                ...
                nowrap: false,
                rownumbers: true,
                queryParams: {FundTransferApplyStatus:1},
            ...
            $('#FundTransferApplyStatus').combobox("setValue", "1");           
            $('#FundTransferApplyStatus').combobox('disable');
        });
        ...
        function Edit(index) {
            ...
            if (rowdata) {
                var url = location.pathname.replace(/ApprovingList.aspx/ig, 'Detail.aspx') + "?ID=" + rowdata.ID+"&PageFunction=Approve";;
                top.$.myWindow({
                    iconCls: "",
                    noheader: false,
                    title: '审批调拨',
