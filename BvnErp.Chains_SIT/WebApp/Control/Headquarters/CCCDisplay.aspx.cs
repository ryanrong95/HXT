...
namespace WebApp.Control.Headquarters
{
    ...
    /// 北京总部3c认证产品审批界面
    /// </summary>
    public partial class CCCDisplay : Uc.PageBase
    {
        ...
        private void Control_ApproveSuccess(object sender, OrderControledEventArgs e)
        {
            ...
            noticeLog.NoticeType = Needs.Ccs.Services.Enums.SendNoticeType.HQCCC;
        ...
        private void Control_RejectSuccess(object sender, OrderControledEventArgs e)
        {
            ...
            noticeLog.NoticeType = Needs.Ccs.Services.Enums.SendNoticeType.CCC;
