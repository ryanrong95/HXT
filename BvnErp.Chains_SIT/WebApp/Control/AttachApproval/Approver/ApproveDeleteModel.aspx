<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveDeleteModel.aspx.cs" Inherits="WebApp.Control.AttachApproval.Approver.ApproveDeleteModel" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#ApproveAdminName").html(approveDeleteModelInfo.ApproveAdminName);
            $("#OrderControlStatusDes").html(approveDeleteModelInfo.OrderControlStatusDes);
            $("#ApproveReason").html(approveDeleteModelInfo.ApproveReason);

            //通过/拒绝字样换颜色
            if (approveDeleteModelInfo.OrderControlStatusInt == '<%=Needs.Ccs.Services.Enums.OrderControlStatus.Approved.GetHashCode()%>') {
                $("#OrderControlStatusDes").css('color', 'green');
            } else if (approveDeleteModelInfo.OrderControlStatusInt == '<%=Needs.Ccs.Services.Enums.OrderControlStatus.Rejected.GetHashCode()%>') {
