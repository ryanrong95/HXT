<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnApprovedList.aspx.cs" Inherits="WebApp.Control.AttachApproval.Approver.UnApprovedList" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function Operation(val, row, index) {
            var buttons = '<a href="javascript:void(0);" class="easyui-linkbutton l-btn l-btn-small" style="margin:3px" onclick="showApproveWindow(\''
        ...
        //显示审核弹框
        function showApproveWindow(orderControlStepID, controlTypeInt) {
            var url = '';
            var width = 0;
            var height = 0;
            if (controlTypeInt == '<%=Needs.Ccs.Services.Enums.OrderControlType.GenerateBillApproval.GetHashCode()%>') {
                url = location.pathname.replace(/UnApprovedList.aspx/ig, 'UnApproveGenerateBill.aspx')
