...
namespace WebApp.Control.Risk
{
    ...
    public partial class List : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            var controls = Needs.Wl.Admin.Plat.AdminPlat.Current.Control.RiskControlApprovalNotHangUp1
            ...
            Func<Needs.Ccs.Services.Models.MerchandiserControl, object> convert = control => new
            {
                ...
                DepartmentCode = control.DepartmentCode
            };
