...
namespace WebApp.PayExchange.Auditing
{
    public partial class List : Uc.PageBase
    {
        ...
        //    var applyView = Needs.Wl.Admin.Plat.AdminPlat.Current.Clients.MyUnAuditedPayExchangeApply.AsQueryable();
        ...
        //    Func<UnAuditedPayExchangeApply, object> linq = item => new
        //    {
        //        ID = item.ID,
        ...
        protected void data()
        {
            ...
            using (var query = new Needs.Ccs.Services.Views.GendanAuditePayExchangeApplyListView())
            {
                ...
                view = view.SearchByPayExchangeApplyStatus_Equal(Needs.Ccs.Services.Enums.PayExchangeApplyStatus.Auditing);
