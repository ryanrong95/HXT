<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.PayExchange.Auditing.List" %>
...
<head runat="server">
    ...
    <script>
        ...
        function Auditing(Index) {
            ...
            if (rowdata) {
                var url = location.pathname.replace(/List.aspx/ig, 'Audit.aspx') + "?ID=" + rowdata.ID;
                MaskUtil.mask();
                window.location = url;
            }
        }
        ...
        function Operation(val, row, index) {
            var buttons = '<a id="btnAuditing" href="javascript:void(0);" class="easyui-linkbutton l-btn l-btn-small" style="margin:3px;" onclick="Auditing(' + index + ')" group >' +
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="datagrid" class="mygrid" title="待审核付汇申请">
            <thead>
                <tr>
                    ...
                    <th field="SupplierEnglishName" data-options="align:'center'" style="width: 100px">供应商</th>
