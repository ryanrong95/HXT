<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.PayExchange.Audited.List" %>
        ...
        <table id="datagrid" class="mygrid" title="付汇申请记录" data-options="
            ...
            <thead>
                <tr>
                    ...
                    <%--<th field="SupplierEnglishName" data-options="align:'center'" style="width: 100px">英文名称</th>--%>
