...
namespace WebApp.Permissions.Role
{
    public partial class List : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            var vaultlist = Needs.Wl.Admin.Plat.AdminPlat.Current.Permissions.Roles.AsQueryable()
            ...
            Func<Needs.Ccs.Services.Models.Role, object> convert = item => new
            {
                ID = item.ID,
                Name = item.Name,
        ...
        protected void Delete()
        {
            ...
            var del = Needs.Wl.Admin.Plat.AdminPlat.Current.Permissions.Roles[id];
            if (del != null)
            {
