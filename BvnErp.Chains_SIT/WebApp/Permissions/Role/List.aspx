<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Permissions.Role.List" %>
   ...
   <%-- <script>       
    ...
    <script type="text/javascript">
        ...
        function Search() {
            ...
            $('#tariffs').myDatagrid('search', { Name: name });
        }
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="tariffs" data-options="singleSelect:true,fit:true,scrollbarSize:0,border:false" title="角色" class="easyui-datagrid" style="width: 100%; height: 100%" toolbar="#topBar"
            fitcolumns="true">
            <thead>
                <tr>
                    <th data-options="field:'Name',align:'center'" style="width: 80px;">名称</th>
                    <th data-options="field:'SysCode',align:'left'" style="width: 100px;">系统代码</th>
