<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditedList.aspx.cs" Inherits="WebApp.Client.Control.AuditedList" %>


<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>会员列表-已审核</title>
    ...
    <script type="text/javascript">
        ...
        function Operation(val, row, index) {
            var buttons = '<a id="btnDetail" href="javascript:void(0);" class="easyui-linkbutton l-btn l-btn-small" style="margin:3px" onclick="Edit(\'' + row.ClientID + '\')" group >' +
        ...
        function Edit(id) {
            var url = location.pathname.replace(/AuditedList.aspx/ig, './Detail.aspx')
                + '?ID=' + id;
            top.$.myWindow({
                iconCls: "",
                url: url,
        ...
        <table id="clients" data-options="singleSelect:true,border:false,fit:true,nowrap:false,scrollbarSize:0" title="会员列表" toolbar="#topBar">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'StorageServiceManagerName',align:'center'" style="width: 10%;">仓储业务员</th>
