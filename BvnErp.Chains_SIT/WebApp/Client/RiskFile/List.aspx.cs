    ...
    public partial class List : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            var files = new Needs.Ccs.Services.Models.CenterFilesTopView().Where(x => x.ClientID == id 
                                                                                      ...
                                                                                      &&(x.Type==(int)Needs.Ccs.Services.Enums.FileType.SignVideo||
                                                                                      x.Type == (int)Needs.Ccs.Services.Enums.FileType.Photos ||
                                                                                      x.Type == (int)Needs.Ccs.Services.Enums.FileType.DeclareAgreement ||
                                                                                      x.Type == (int)Needs.Ccs.Services.Enums.FileType.SupplementAgreement ||
                                                                                      x.Type == (int)Needs.Ccs.Services.Enums.FileType.PECommitment
                                                                                      ));
