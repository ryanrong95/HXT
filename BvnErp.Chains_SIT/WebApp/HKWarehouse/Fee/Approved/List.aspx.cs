...
namespace WebApp.HKWarehouse.Fee.Approved
{
    public partial class List : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            var Fees = Needs.Wl.Admin.Plat.AdminPlat.Current.Warehouse.OrderWhesPremium.Where(item => item.WarehousePremiumsStatus == WarehousePremiumsStatus.Audited).AsQueryable();
