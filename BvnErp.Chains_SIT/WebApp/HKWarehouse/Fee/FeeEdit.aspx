<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeeEdit.aspx.cs" Inherits="WebApp.HKWarehouse.Fee.FeeEdit" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var datajson = [{ "Value": "5", "Text": "5" }, { "Value": "20", "Text": "20" }, { "Value": "30", "Text": "30" }, { "Value": "40", "Text": "40" },
        { "Value": "50", "Text": "50" }, { "Value": "100", "Text": "100" }, { "Value": "150", "Text": "150" }, { "Value": "200", "Text": "200" }];

        var datajson1 = [{ "Value": "20", "Text": "20" }, { "Value": "30", "Text": "30" }, { "Value": "40", "Text": "40" }];
           ...
           $('#pi').myDatagrid({
            ...
            $("#FeeType").combobox({
                ...
                onChange: function (record) {
                    if (record == '<%=Needs.Ccs.Services.Enums.WarehousePremiumType.ChangeBoxFee.GetHashCode()%>') {
                        $('#UnitPrice').combobox({
                            data: datajson1
                        });
                        } else {
        ...
        function Init() {
            if (FeeData != null) {
                ...
                $('#PaymentType').combobox('setValue', FeeData.PaymentType);
                $('#Currency').combobox('setValue', FeeData.Currency);
                $('#FeeType').combobox('setValue', FeeData.FeeType);
                $('#Count').numberbox('setValue', FeeData.Count);
                $('#UnitPrice').combobox('setValue', FeeData.UnitPrice);
                $('#UnitName').combobox('setValue', FeeData.UnitName);
        ...
        <form id="form1" runat="server" method="post">
                 <table id="editTable" style="margin-left: 20px">
                    <tr>
                        ...
                        <td>
                            <input class="easyui-combobox" id="PaymentType" name="PaymentType" style="width: 250px; height: 28px"
                                data-options="disabled:true, required:true,valueField:'Value',textField:'Text',limitToList:true,editable:false,tipPosition:'right',missingMessage:'请选择收款方式'" />
                        </td>
                          <td class="lbl">币种：</td>
                        <td>
                    ...
                    <tr>
                        <td class="lbl">单价：</td>
                        <td>
                             <input class="easyui-combobox" id="UnitPrice" name="UnitPrice" style="width: 150px; height: 26px"
                                data-options="required:true,valueField:'Value',textField:'Text',limitToList:true,tipPosition:'right',missingMessage:'请输入单价'" />
