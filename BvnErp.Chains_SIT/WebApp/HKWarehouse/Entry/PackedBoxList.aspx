<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackedBoxList.aspx.cs" Inherits="WebApp.HKWarehouse.Entry.PackedBoxList" %>
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="packedBoxList-datagrid" class="easyui-datagrid" title="装箱单" data-options="
            ...
            <thead>
                <tr>
                    <th field="PackingDate" data-options="align:'center'" style="width: 45px">装箱日期</th>
                    <th field="BoxIndex" data-options="align:'left'" style="width: 70px">箱号</th>
                    <th field="StockCode" data-options="align:'center'" style="width: 60px">库位号</th>
                    <th field="OrderID" data-options="align:'left'" style="width: 80px">订单编号</th>
                    <th field="ClientCode" data-options="align:'center'" style="width: 60px">客户编号</th>
                    <th field="ClientName" data-options="align:'left'" style="width: 80px">客户名称</th>
                    <th field="SealedDate" data-options="align:'center'" style="width: 45px">封箱时间</th>
                    <th field="SealedName" data-options="align:'center'" style="width: 45px">封箱人</th>
                    <th data-options="field:'btn',width:50,formatter:PackedBoxListDatagridOperation,align:'center'">操作</th>
                </tr>
            </thead>
        </table>
    </div>
    ...
    <div id="boxDetail-dialog" class="easyui-dialog" title="明细" style="width:800px;height:450px;" 
        ...
        <table id="boxDetail-datagrid" data-options="
            ...
            <thead>
                <tr>
                    <th data-options="field:'Model',align:'center'" style="width: 18px;">型号</th>
                    <th data-options="field:'Name',align:'center'" style="width: 18px;">品名</th>
                    <th data-options="field:'Manufacturer',align:'center'" style="width: 12px;">品牌</th>
                    <th data-options="field:'Quantity',align:'left'" style="width: 8px;">数量</th>
                    <th data-options="field:'Origin',align:'center'" style="width: 8px;">产地</th>
                    <th data-options="field:'GrossWeight',align:'left'" style="width: 10px;">毛重</th>
                </tr>
            </thead>
        </table>
    </div>
