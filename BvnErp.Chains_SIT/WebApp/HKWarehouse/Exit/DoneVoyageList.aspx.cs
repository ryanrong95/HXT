...
namespace WebApp.HKWarehouse.Exit
{
    ...
    /// 运输批次
    /// </summary>
    public partial class DoneVoyageList : Uc.PageBase
    {
        ...
        protected void data()
        {
            ...
            var manifest = Needs.Wl.Admin.Plat.AdminPlat.Current.Voyage.ManifestSure.Where(v => v.CutStatus == CutStatus.Completed).AsQueryable();
