<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoneVoyageList.aspx.cs" Inherits="WebApp.HKWarehouse.Exit.DoneVoyageList" %>
...
<head runat="server">
    ...
    <script>
        ...
        function Search() {
            ...
            $('#voyageGrid').bvgrid('search', { VoyageNo: voyageNo, Carrier: carrier });
        }
        ...
        //查看
        function View(id) {
            var url = location.pathname.replace(/DoneVoyageList.aspx/ig, '../../Logistics/ManifestVoyage/Detail.aspx') + '?ID=' + id + '&From=HKWarehouse';
            window.location = url;
        }
