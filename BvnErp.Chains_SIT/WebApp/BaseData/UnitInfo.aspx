<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitInfo.aspx.cs" Inherits="WebApp.BaseData.UnitInfo" %>
    ...
    <div id="content">
        <form id="form1" runat="server">
            <table id="editTable">
                ...
                <tr>
                    <td class="lbl">计量单位名称</td>
                    <td>
                        <input class="easyui-textbox input" id="Name" name="Name"
                            data-options="required:true,validType:'length[1,50]',tipPosition:'bottom',missingMessage:'请输入计量单位名称'" />
                    </td>
                </tr>
            </table>
        </form>
