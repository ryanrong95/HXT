<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.SysConfig.CustomsTariff.List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Search() {
            ...
            $('#tariffs').myDatagrid('search', { HSCode: hsCode, Name: name });
        }
