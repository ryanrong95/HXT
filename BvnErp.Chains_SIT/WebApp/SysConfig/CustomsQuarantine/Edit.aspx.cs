...
namespace WebApp.SysConfig.CustomsQuarantine
{
    public partial class Edit : Uc.PageBase
    {
        ...
        protected void LoadData()
        {
            ...
            {
                var quarantines = Needs.Wl.Admin.Plat.AdminPlat.Current.Customs.CustomsQuarantines[id];
        ...
        protected void Save()
        {
            ...
            var quarantines = Needs.Wl.Admin.Plat.AdminPlat.Current.Customs.CustomsQuarantines[id] as
             Needs.Ccs.Services.Models.CustomsQuarantine ?? new Needs.Ccs.Services.Models.CustomsQuarantine();
