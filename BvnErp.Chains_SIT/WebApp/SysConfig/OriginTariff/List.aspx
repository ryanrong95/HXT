<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.SysConfig.OriginTariff.List" %>
   ...
   <%-- <script>       
    ...
    <script type="text/javascript">
        ...
        function Search() {
            ...
            $('#datagrid').myDatagrid('search', { Origin: Origin, HSCode: HSCode, Name: Name });
        }
