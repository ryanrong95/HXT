    ...
    public partial class Edit : Uc.PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    ID = id,
                    RateType = (int)Needs.Cbs.Services.Enums.ExchangeRateType.Custom
                }.Json();
        ...
        protected void Save()
        {
            ...
            exchangeRate.Type = Needs.Cbs.Services.Enums.ExchangeRateType.Custom;
        ...
        private void ExchangeRateChanging(object sender, Needs.Cbs.Services.Hanlders.ExchangeRateChangingEventArgs e)
        {
            ...
            {
                e.ExchangeRate.Log( "管理员[" + Needs.Wl.Admin.Plat.AdminPlat.Current.RealName + "]新增了海关汇率");
            }
            else
            {
                e.ExchangeRate.Log( "管理员[" + Needs.Wl.Admin.Plat.AdminPlat.Current.RealName + "]修改了海关汇率");
            }
        }
    }
}