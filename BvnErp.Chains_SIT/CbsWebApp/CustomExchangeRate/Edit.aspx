<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Needs.Cbs.WebApp.CustomExchangeRate.Edit" %>
        ...
        <form id="form1" runat="server">
            <table id="editTable" style="margin-left:20px;">
                <tr>
                    <td>币种：</td>
                    <td>
                        <input class="easyui-combobox input" id="Code" name="Code" data-options="valueField:'value',textField:'text',tipPosition:'bottom',required:true,editable:false,missingMessage:'请选择币种类型',panelHeight:'100px'" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">汇率：</td>
                    <td>                                                                      
                        <input class="easyui-textbox input" id="Rate" name="Rate"
                            data-options="required:true,validType:'length[1,18]',tipPosition:'bottom',missingMessage:'请输入汇率'" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">备注：</td>
                    <td>
                        <input class="easyui-textbox input" id="Summary" name="Summary"
                            data-options="multiline:true,required:false,validType:'length[0,200]'" style="height:60px"/>
                    </td>
                </tr>               
            </table>
        </form>
