<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Needs.Cbs.WebApp.CustomsQuarantine.List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Search() {
            ...
            $('#datagrid').bvgrid('search', { Origin: Origin });
        }
...
<body class="easyui-layout">
    ...
    <div id="data" data-options="region:'center',border:false">
        <table id="datagrid" data-options="singleSelect:true,fit:true,scrollbarSize:0,border:false" title="地区" class="easyui-datagrid" style="width: 100%; height: 100%" toolbar="#topBar"
            fitcolumns="true">
            <thead>
                <tr>
