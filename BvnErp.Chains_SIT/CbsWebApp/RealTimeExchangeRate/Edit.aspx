<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Needs.Cbs.WebApp.RealTimeExchangeRate.Edit" %>
        ...
        <form id="form1" runat="server">
            <table id="editTable" style="margin-left:20px;">
                <tr>
                    <td>币种：</td>
                    <td>
                        <input class="easyui-combobox input" id="Code" name="Code" data-options="valueField:'value',textField:'text',tipPosition:'bottom',required:true,editable:false,missingMessage:'请选择币种类型'" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">汇率</td>
                ...
                <tr>
                    ...
                    <td>
                        <input class="easyui-textbox input" id="Summary" name="Summary"
                            data-options="required:false,validType:'length[0,200]'" />
                    </td>
                </tr>               
            </table>
        </form>
