...
namespace Needs.Cbs.WebApp.CustomsTariff
{
    public partial class Edit : Uc.PageBase
    {
        ...
        protected void LoadData()
        {
            ...
            var tariff = Needs.Wl.Admin.Plat.AdminPlat.Current.Cbs.CustomsTariffs[tariffID];
            ...
            {
                this.Model.TariffData = tariff.Json();
            }
        }
        ...
        protected void Save()
        {
            ...
            var tariff = Needs.Wl.Admin.Plat.AdminPlat.Current.Cbs.CustomsTariffs[tariffID] ?? new Needs.Cbs.Services.Models.Origins.CustomsTariff();
