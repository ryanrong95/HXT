...
namespace Needs.Cbs.WebApp.CustomsTariff
{
    public partial class List : Uc.PageBase
    {
        ...
        protected void data()
        {
            var tariffs = Needs.Wl.Admin.Plat.AdminPlat.Current.Cbs.CustomsTariffs.AsQueryable();
            ...
            Func<Needs.Cbs.Services.Models.Origins.CustomsTariff, object> convert = tariff => new
            {
                tariff.ID,
                tariff.HSCode,
                tariff.Name,
