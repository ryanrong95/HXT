...
namespace Needs.Cbs.WebApp.CustomsTariff
{
    public partial class SetDefault : Uc.PageBase
    {
        ...
        protected void SaveDefaults()
        {
            try
            {
                ...
                var tariff = Needs.Wl.Admin.Plat.AdminPlat.Current.Cbs.CustomsTariffs.Where(item => item.HSCode == hsCode.Trim()).FirstOrDefault();
                var elements = tariff.Elements.Split(';');
                var elementsDefaults = tariff.ElementsDefaults;
                CustomsElementsDefault elementsDefault;
                ...
                foreach (var element in elements)
                {
                    ...
                    elementsDefault = elementsDefaults.Where(item => item.ElementName == elementName).FirstOrDefault() ?? new CustomsElementsDefault();
                ...
                elementsDefault = elementsDefaults.Where(item => item.ElementName == "其他").FirstOrDefault() ?? new CustomsElementsDefault();
