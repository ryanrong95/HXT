...
{
    public class OrderMainsView : QueryView<OrderMain, Layer.Data.Sqls.BvOrdersReponsitory>
    {
        public OrderMainsView()
        {
        }



        protected override IQueryable<OrderMain> GetIQueryable()
        {
