...
namespace Layer.Data.Sqls.ScCustoms
{
    ...
    partial void InsertDecGoodsLimits(DecGoodsLimits instance);
    partial void UpdateDecGoodsLimits(DecGoodsLimits instance);
    partial void DeleteDecGoodsLimits(DecGoodsLimits instance);
    #endregion
		...
		public System.Data.Linq.Table<DecGoodsLimits> DecGoodsLimits
		{
			get
			{
				return this.GetTable<DecGoodsLimits>();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.DecGoodsLimits")]
	public partial class DecGoodsLimits : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _LicWrtofQty;
		
		private string _LicWrtofQtyUnit;
    ...
    partial void OnDecListIDChanging(string value);
    partial void OnDecListIDChanged();
    partial void OnGoodsNoChanging(int value);
    partial void OnGoodsNoChanged();
    partial void OnLicTypeCodeChanging(string value);
    partial void OnLicTypeCodeChanged();
    partial void OnLicenceNoChanging(string value);
    partial void OnLicenceNoChanged();
    partial void OnLicWrtofDetailNoChanging(string value);
    partial void OnLicWrtofDetailNoChanged();
    partial void OnLicWrtofQtyChanging(string value);
    partial void OnLicWrtofQtyChanged();
    partial void OnLicWrtofQtyUnitChanging(string value);
    partial void OnLicWrtofQtyUnitChanged();
    partial void OnFileUrlChanging(string value);
    partial void OnFileUrlChanged();
    #endregion
		
		public DecGoodsLimits()
		{
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GoodsNo", DbType="Int NOT NULL")]
		public int GoodsNo
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LicTypeCode", DbType="VarChar(10) NOT NULL", CanBeNull=false)]
		public string LicTypeCode
		{
			get
			{
				return this._LicTypeCode;
			}
			set
			{
				if ((this._LicTypeCode != value))
				{
					this.OnLicTypeCodeChanging(value);
					this.SendPropertyChanging();
					this._LicTypeCode = value;
					this.SendPropertyChanged("LicTypeCode");
					this.OnLicTypeCodeChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LicenceNo", DbType="VarChar(100) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LicWrtofDetailNo", DbType="VarChar(10)")]
		public string LicWrtofDetailNo
		{
			get
			{
				return this._LicWrtofDetailNo;
			}
			set
			{
				if ((this._LicWrtofDetailNo != value))
				{
					this.OnLicWrtofDetailNoChanging(value);
					this.SendPropertyChanging();
					this._LicWrtofDetailNo = value;
					this.SendPropertyChanged("LicWrtofDetailNo");
					this.OnLicWrtofDetailNoChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LicWrtofQty", DbType="VarChar(50)")]
		public string LicWrtofQty
		{
			get
			{
				return this._LicWrtofQty;
			}
			set
			{
				if ((this._LicWrtofQty != value))
				{
					this.OnLicWrtofQtyChanging(value);
					this.SendPropertyChanging();
					this._LicWrtofQty = value;
					this.SendPropertyChanged("LicWrtofQty");
					this.OnLicWrtofQtyChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LicWrtofQtyUnit", DbType="VarChar(10)")]
		public string LicWrtofQtyUnit
		{
			get
			{
				return this._LicWrtofQtyUnit;
			}
			set
			{
				if ((this._LicWrtofQtyUnit != value))
				{
					this.OnLicWrtofQtyUnitChanging(value);
					this.SendPropertyChanging();
					this._LicWrtofQtyUnit = value;
					this.SendPropertyChanged("LicWrtofQtyUnit");
					this.OnLicWrtofQtyUnitChanged();
				}
			}
		}
