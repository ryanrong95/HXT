...
namespace YaHv.Csrm.Services.Views.Origins
{
    ...
    /// Crm后台专用
    /// </summary>
    public class nPayeeViewOrigin : Yahv.Linq.UniqueView<nPayee, PvbCrmReponsitory>
    {
        /// <summary>
        /// 默认构造器
        /// </summary>
        internal nPayeeViewOrigin()
        {
        ...
        internal nPayeeViewOrigin(PvbCrmReponsitory reponsitory) : base(reponsitory)
        {
        }
