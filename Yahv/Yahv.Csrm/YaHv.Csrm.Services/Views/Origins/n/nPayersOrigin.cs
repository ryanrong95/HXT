...
{
    public class nPayersOrigin : Yahv.Linq.UniqueView<nPayer, PvbCrmReponsitory>
    {
        /// <summary>
        /// 默认构造器
        /// </summary>
        internal nPayersOrigin()
        {
        }
        /// <summary>
        /// 构造函数
        ...
        internal nPayersOrigin(PvbCrmReponsitory reponsitory) : base(reponsitory)
        {
        }
