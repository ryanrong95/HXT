...
{
    public class nPayersViewOrigin : Yahv.Linq.UniqueView<nPayer, PvbCrmReponsitory>
    {
        /// <summary>
        /// 默认构造器
        /// </summary>
        internal nPayersViewOrigin()
        {
        }
        /// <summary>
        /// 构造函数
        ...
        internal nPayersViewOrigin(PvbCrmReponsitory reponsitory) : base(reponsitory)
        {
        }
        protected override IQueryable<nPayer> GetIQueryable()
        {
            var enterpriseView = new Origins.EnterprisesOrigin(this.Reponsitory);
            return from entity in Reponsitory.ReadTable<Layers.Data.Sqls.PvbCrm.nPayers>()
