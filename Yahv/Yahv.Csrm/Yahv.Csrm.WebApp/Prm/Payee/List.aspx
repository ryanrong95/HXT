<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Prm.Payee.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        ...
        function showEditPage(payeeid) {
            $.myWindow({
                title: "修改收款人信息",
                url: 'Edit.aspx?id=' + model.ID + '&payeeid=' + payeeid, onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "60%",
                height: "80%",
        ...
        function enable(id) {
         ...
         function deleteItem(payeeid) {
             $.messager.confirm('确认', '您确认想要删除该收款人吗？', function (r) {
                 if (r) {
                     $.post('?action=Del', { id: model.ID, payeeid: payeeid }, function (success) {
                         if (success) {
                             top.$.timeouts.alert({
                                 position: "TC",
                                 msg: "删除成功!",
    ...
    <table id="dg" style="width: 100%">
        <thead>
            <tr>
                ...
                <th data-options="field:'RealName',width:120">实际收款人</th>
                 <th data-options="field:'Place',width:140">国家/地区</th>
