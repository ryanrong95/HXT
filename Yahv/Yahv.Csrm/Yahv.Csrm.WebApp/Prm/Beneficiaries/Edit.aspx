<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Prm.Beneficiaries.Edit" %>
    ...
    <div class="easyui-panel" id="tt" data-options="fit:true">
        <div style="width: 600px">
            <div style="padding: 10px 60px 20px 60px;">
                <table class="liebiao">
                    <tr>
                        <td style="width: 120px">实际的企业名称</td>
                        <td colspan="3">
                    ...
                    <tr>
                        <td>开户行</td>
                        <td colspan="3">
                            <input id="txtBank" name="Bank" class="easyui-textbox readonly_style"
                                data-options="prompt:'开户银行',required:true,validType:'length[1,100]'"  style="width: 350px;"/>
                        </td>
                    </tr>
                    <tr>
                        <td>账号</td>
