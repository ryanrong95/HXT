<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Prm.Contacts.Edit" %>
            ...
            <div style="padding: 10px 60px 20px 60px;">
                <table class="liebiao">
                    <tr>
                        ...
                        <td colspan="3">
                            <input id="txtName" name="Name" class="easyui-textbox readonly_style" style="width: 350px;" data-options="validType:'length[1,50]'">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input id="txtTel" name="Tel" class="easyui-validatebox easyui-textbox readonly_style" style="width: 350px;" data-options="validType:'telNum',required:false">
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100px">手机号</td>
                        <td colspan="3">
                            <input id="txtMobile" name="Mobile" class="easyui-validatebox easyui-textbox readonly_style" style="width: 350px;" data-options="validType:'phoneNum',required:false">
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100px">邮箱</td>
                        <td colspan="3">
                            <input id="txtEmai" name="Email" class="easyui-validatebox easyui-textbox readonly_style" style="width: 350px;" data-options="validType:'email',required:false">
                        </td>
                    </tr>
                </table>
