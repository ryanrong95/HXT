<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.nSuppliers.nPayees.Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        $(function () {
            ...
            <%--$('#selOrigin').siblings('span').bind('DOMNodeInserted', function (e) {

                var val = $(e.target).html();
                var required = (val != '<%=Origin.HKG.GetOrigin().Code%>');
                var options = {};
                options['required'] = required;
                $('#txtBankAddress').textbox(options);
                $('#txtAccount').textbox(options);
            ...
            $('#selOrigin').combobox({
                ...
                onChange: function (n, o) {
                    var required = (n != '<%=Origin.HKG.GetOrigin().Code%>');
                    var options = {};
                    options['required'] = required;
                    $('#txtBankAddress').textbox(options);
                    $('#txtSwiftCode').textbox(options);
            ...
            if (!jQuery.isEmptyObject(model.Entity)) {
                ...
                //$("#txtAccount").textbox({ readonly: true });
                $('#selOrigin').combobox('setValue', model.Entity.Place);
            }
            else {
                $('#selOrigin').combobox('setValue', '<%=Origin.CHN.GetOrigin().Code%>')
            }
        })
                ...
                <table class="liebiao">
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <select id="selOrigin" name="Palce" class="easyui-combobox" data-options="required:true,editable:true,panelheight:'auto'" style="width: 200px"></select>
                        </td>
                    </tr>
