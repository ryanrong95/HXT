<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.Manufacturers.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    ...
    <div style="padding: 10px 60px 20px 60px;">
        ...
        <%-- <div>
             <div style="width: 1px; height: 5px; padding: 10px"></div>
        </div>--%>
    </div>
    <%--</div>--%>
</asp:Content>
