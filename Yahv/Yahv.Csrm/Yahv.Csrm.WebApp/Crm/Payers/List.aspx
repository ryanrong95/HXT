<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.Payers.List" %>
    ...
    <script>
        ...
        function enable(id) {
            $.messager.confirm('确认', '您确认想要启用该付款人吗？', function (r) {
                if (r) {
                    $.post('?action=enable', { id: id, clientid: model.ID }, function () {
                        top.$.timeouts.alert({
                            position: "TC",
                            msg: "已启用!",
                            type: "success"
    ...
    <table id="dg" style="width: 100%">
        <thead>
            <tr>
                ...
                <th data-options="field:'RealName',width:120">实际付款人</th>
