<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.Payers.Edit" %>
        ...
        $(function () {
           ...
           <%-- $('#selCurrency').combobox({
            ...
            $('#selOrigin').combobox({
                ...
                limitToList: true,
                onLoadSuccess: function () {
                    $(this).combobox('select', model.Entity == null ? '<%=Origin.CHN.GetOrigin().Code%>' : model.Entity.Place);
                }
            })
            if (!jQuery.isEmptyObject(model.Entity)) {
                ...
                $('#selOrigin').combobox('setVal', '<%=Origin.CHN.GetOrigin().Code%>')
            }
        })
                ...
                <table class="liebiao">
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <select id="selOrigin" name="Place" class="easyui-combobox" data-options="required:true,editable:true,panelheight:'auto'" style="width: 200px"></select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="txtBank" name="Bank" class="easyui-textbox readonly_style" style="width: 200px;" data-options="required:false,validType:'length[1,200]'">
                        </td>
                        <td style="width: 100px">账号</td> 
                        <td>
                            <input id="txtAccount" name="Account" class="easyui-textbox readonly_style" style="width: 200px;" data-options="required:false,validType:'length[1,50]'">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="txtBankAddress" name="BankAddress" class="easyui-textbox readonly_style" style="width: 200px;" data-options="required:false,validType:'length[1,200]'">
                        </td>
                        <td style="width: 100px">SwiftCode</td>
                        <td>
                            <input id="txtSwiftCode" name="SwiftCode" class="easyui-textbox readonly_style" style="width: 200px;" data-options="required:false,validType:'length[1,50]'">
                        </td>
                    </tr>
