...
namespace Yahv.Csrm.WebApp.Crm.Contacts
{
    public partial class Edit : BasePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            var client = Erp.Current.Crm.Clients[Request.QueryString["clientid"]];
            var entity = Erp.Current.Crm.MyContacts[contactid] ?? new TradingContact();

            entity.Enterprise = client.Enterprise;
            entity.EnterpriseID = client.ID;
        ...
        private void Entity_EnterSuccess(object sender, Usually.SuccessEventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(Request.QueryString["clientid"]))
            {
                Yahv.Oplogs.Oplog(Yahv.Erp.Current, Request.Url.ToString(),
                                        ...
                                        "ContactInsert", "新增联系人：" + entity.ID + ",关系ID:" + entity.MapsID, "");
            }
            else
            {
                Yahv.Oplogs.Oplog(Yahv.Erp.Current, Request.Url.ToString(),
