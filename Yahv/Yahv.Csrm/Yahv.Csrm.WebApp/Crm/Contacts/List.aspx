<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.Contacts.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        function showEditPage(id) {
            $.myWindow({
                title: "联系人详情",
                url: 'Edit.aspx?id=' + id + "&clientid=" + model.Entity.ID + '&enterprisetype=' + model.EnterpriseType, onClose: function () {
        ...
        function showAddPage() {
            $.myDialog({
                title: "添加联系人",
                url: 'Edit.aspx?clientid=' + model.Entity.ID + '&enterprisetype=' + model.EnterpriseType, onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "50%",
                height: "50%",
