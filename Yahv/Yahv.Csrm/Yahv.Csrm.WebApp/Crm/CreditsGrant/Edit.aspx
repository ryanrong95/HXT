<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.CreditsGrant.Edit" %>
        ...
        <div>
            <table class="liebiao">
                ...
                <tr id="trMoney">
                    ...
                    <td>总计</td>
                    <td>
                        <input id="Total" name="Total" class="easyui-textbox" style="width: 200px;" readonly="readonly" />
                    </td>
                </tr>
            </table>
