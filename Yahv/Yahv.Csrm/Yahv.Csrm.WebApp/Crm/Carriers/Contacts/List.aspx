<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.Carriers.Contacts.List" %>
        ...
        $(function () {
            ...
            $("#btnEnable").click(function () {
                ...
                if (nomal.length) {
                    ...
                    $.post('?action=Enable', { items: arry.toString(), carrierid: model.Entity.ID }, function () {
            ...
            $("#btnDel").click(function () {
                ...
                if (arry.length > 0) {
                    $.messager.confirm('确认', '您确认想要删除选中的联系人吗？', function (r) {
                        if (r) {
                            $.post('?action=del', { items: arry.toString(), carrierid: model.Entity.ID }, function () {
            ...
            $("#btnUnable").click(function () {
                ...
                if (unable.length) {
                    ...
                    $.post('?action=Unable', { items: arry.toString(), carrierid: model.Entity.ID }, function () {
    ...
    <script>
        ...
        function deleteItem(id) {
            $.messager.confirm('确认', '您确认想要删除该联系人吗？', function (r) {
                if (r) {
                    $.post('?action=del', { items: id, carrierid: model.Entity.ID }, function () {
                        //top.$.messager.alert('操作提示', '删除成功!', 'info', function () {
                        //    grid.myDatagrid('flush');
                        //});
                        top.$.timeouts.alert({
        ...
        function showEditPage(id) {
            $.myWindow({
                title: "联系人详情",
                url: 'Detail.aspx?id=' + id + "&carrierid=" + model.Entity.ID,
                onClose: function () {
        ...
        function showAddPage() {
            $.myDialog({
                title: "添加联系人",
                url: 'Edit.aspx?carrierid=' + model.Entity.ID,
                onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "50%",
