<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.Carriers.Beneficiaries.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        function showAddPage() {
            $.myDialog({
                title: "添加受益人",
                url: 'Edit.aspx?carrierid=' + model.CarrierID, onClose: function () {
        ...
        function showEditPage(id) {
            $.myDialog({
                title: "编辑受益人信息",
                url: 'Edit.aspx?carrierid=' + model.CarrierID + '&benefitid=' +id , onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "50%",
                height: "80%",
        ...
        function deleteItem(id) {
            $.messager.confirm('确认', '您确认想要删除该受益人吗？', function (r) {
                if (r) {
                    $.post('?action=del', { carrierid: model.CarrierID, benefitid: id }, function () {
                        top.$.timeouts.alert({
                            position: "TC",
                            msg: "删除成功!",
                            type: "success"
