<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.vInvoices.Add" %>
    ...
    <div class="easyui-panel" id="tt" data-options="fit:true" style="padding: 10px 10px 0px 10px;">
        <table class="liebiao">
            ...
            <tr>
                ...
                <td>
                    <input id="txtPostRecipient" name="PostRrecipient" class="easyui-textbox" style="width: 350px;" data-options="validType:'length[1,50]',required:false">
                </td>
            </tr>
            <tr>
