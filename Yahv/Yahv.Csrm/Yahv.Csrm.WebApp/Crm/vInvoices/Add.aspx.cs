    ...
    public partial class Add : ErpParticlePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //下拉绑定
                //1.发票类型
                this.Model.InvoiceType = ExtendsEnum.ToArray<InvoiceType>(InvoiceType.Unkonwn,InvoiceType.None).Select(item => new
                {
                    value = (int)item,
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string postRecipient = Request.Form["PostRecipient"];
            ...
            vInvoice entity = new vInvoice();
            entity.EnterpriseID = enterprieid;
            ...
            entity.PostRecipient = postRecipient;
