<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.WareHouses.Edit" %>
    ...
    <script>
        $(function () {
            ...
            $('#cboDistrict').combobox({
                ...
                multiple: false,
                onLoadSuccess: function (data) {
                    $(this).combobox('select', model.Entity == null||model.Entity.Region==null ?data[data.length - 1].value: (model.Entity.Region==0?data[data.length - 1].value:model.Entity.Region ));
                } 
            });
                ...
                $('#form1').form('load',
                    {
                        ...
                        Address: model.Entity.Address,//库房详细地址
                        DyjCode: model.Entity.DyjCode,//大赢家编码
                        District:model.Entity.District//库房地区
                    });
                $('#txtName').textbox('readonly');
                //wscode，district不可编辑
                $('#cboDistrict').combobox('readonly');
                ...
                <table class="liebiao">
                    ...
                    <tr>
                        <td style="width: 100px">
                            <label for="lblRegion"><span style="color: red">*</span>所属地区</label>
                        </td>
                        <td colspan="3">
                            <select id="cboDistrict" name="District" class="easyui-combobox readonly_style" data-options="editable:false ,required:true" style="width: 130px"></select>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100px">详细地址</td>
                        <td colspan="3">
                            <input id="txtAddress" name="Address" class="easyui-textbox" style="width: 350px;" data-options="prompt:'',required:false,validType:'length[1,50]'">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input id="txtAdminCode" name="AdminCode" class="easyui-textbox" style="width: 350px;" data-options="prompt:'',required:false,validType:'length[1,50]'">
                        </td>
                    </tr>
                    <tr>
