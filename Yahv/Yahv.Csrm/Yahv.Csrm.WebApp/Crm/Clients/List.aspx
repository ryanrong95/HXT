<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.Clients.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
        ...
        $(function () {
            ...
            var getQuery = function () {
                var params = {
                    ...
                    Sale: $.trim($('#txtSale').textbox("getText")),
            ...
            $("#btnBlack").click(function () {
                ...
                if (errors.length) {
                    ...
                    $.post('?action=Black', { items: arry.toString() }, function () {
                        //top.$.messager.alert('操作提示', '成功加入黑名单!', 'info', function () {
                        //    grid.myDatagrid('flush');
                        //});
                        top.$.timeouts.alert({
                            position: "TC",
    ...
    <script>
        ...
        var hasPower = '<%=Yahv.Erp.Current.Role.ID == FixedRole.ClientManager.GetFixedID() || Yahv.Erp.Current.IsSuper%>' == 'True';
        ...
        function btnformatter(value, rowData) {
            ...
            if (rowData.ClientStatus == '<%=(int)ApprovalStatus.Waitting%>' && hasPower) {
            ...
            if (rowData.ClientStatus == '<%=(int)ApprovalStatus.Normal%>') {
        ...
        function showAddPage() {
            $.myWindow({
                title: "新增客户",
                url: 'Edit.aspx?fromtype=' + '<%=(int)FromType.Trade%>', onClose: function () {
        ...
        function showEditPage(id) {
            $.myWindow({
                title: "编辑客户信息",
                url: 'Edit.aspx?id=' + id + '&fromtype=' + '<%=(int)FromType.Trade%>', onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "50%",
                height: "65%",
        ...
        function showApprovePage(id) {
            $.myWindow({
                title: "审批客户",
                url: location.pathname.replace('Clients/List.aspx', 'PendingClients/Edit.aspx?id=' + id),
                onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "50%",
        ...
        //            result += "<span class='vip'>"+rec.Company.Name+"</span><br/>";
        //        }
        //    }
        //    return result;
        //}
        ...
        <div>
            <table class="liebiao-compact">
                ...
                <tr>
                    ...
                    <td style="width: 90px;">销售</td>
                    <td>
                        <input id="txtSale" data-options="prompt:'ID/姓名/用户名',validType:'length[1,75]',isKeydown:true" class="easyui-textbox" /></td>
                    <td>
