...
namespace Yahv.Csrm.WebApp.Crm.Consignees
{
    public partial class Edit : BasePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            TradingConsignee entity = Erp.Current.Crm.MyConsignees[id] ?? new TradingConsignee();
        ...
        {
            var entity = sender as TradingConsignee;
            if (string.IsNullOrEmpty(Request.QueryString["id"]))
            {
                Yahv.Oplogs.Oplog(Yahv.Erp.Current, Request.Url.ToString(),
                                         nameof(Yahv.Systematic.Crm),
                                        "ConsigneeInsert", "新增到货地址：" + entity.ID + ",关系ID" + entity.MapsID, "");
            }
            else
            {
                Yahv.Oplogs.Oplog(Yahv.Erp.Current, Request.Url.ToString(),
                                         nameof(Yahv.Systematic.Crm),
                                        "ConsigneeUpdate", "修改到货地址信息：" + entity.ID, "");
            }
