<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Crm.WarehousePlates.List" %>
    ...
    <table id="dg" data-options="fit:true" style="width: 100%">
        <thead>
            <tr>
                ...
                <%
                    if (this.Model.EnterpriseType == EnterpriseType.WareHouse)
                    {
                %>
                <th data-options="field: 'Title',width:100">门牌</th>
                <th data-options="field: 'PlateCode',width:100">门牌编码</th>
                <%
                    }
                %>
