<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Srm.Beneficiaries.List" %>
    ...
    <script>
        $(function () {
            ...
            $("#btnDel").click(function () {
                ...
                if (errors.length) {
                    top.$.messager.alert('操作失败', "包含正在审核中的受益人，删除失败");
                }
                else {
            ...
            $("#btnEnable").click(function () {
                ...
                if (errors.length) {
                    top.$.messager.alert('操作失败', "包含正在审核中的受益人，不能启用");
                }
            ...
            $("#btnUnable").click(function () {
                ...
                if (errors.length) {
                    top.$.messager.alert('操作失败', "包含正在审核中的受益人，不能停用");
                }
        ...
        <table id="dg" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th data-options="field: 'BankCode',width:100">银行代码(行号)</th>
