<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Srm.Beneficiaries.Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        $(function () {
            ...
            $('#txtRealName').textbox('setValue', jQuery.isEmptyObject(model) ? "" : model.Enterprise.Name);
            ...
            <div style="padding: 10px 60px 20px 60px;">
                <table class="liebiao">
                    ...
                    <tr>
                        <td>银行代码(行号)</td>
                        <td>
                            <input id="txtBankCode" name="BankCode" class="easyui-textbox readonly_style" style="width: 350px;"
                                data-options="prompt:'银行代码(行号)',required:false,validType:'length[1,75]'" />
                        </td>
                    </tr>
                    <tr>
                        <td>账号</td>
                        <td>
                            <input id="txtAccount" name="Account" class="easyui-textbox readonly_style" style="width: 350px;"
                                data-options="prompt:'银行账号',required:true,validType:'length[1,50]'" />
                        </td>
                    </tr>
                    <tr>
                        <td>开户行地址</td>
                        <td>
                            <input id="txtBankAddress" name="BankAddress" class="easyui-textbox readonly_style"
                                data-options="prompt:'开户银行地址',validType:'length[1,200]'" style="width: 350px;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="txtSwiftCode" name="SwiftCode" class="easyui-textbox readonly_style" style="width: 350px;"
                                data-options="prompt:'SwiftCode',validType:'length[1,75]'" />
                        </td>
                    </tr>
                    <tr>
                        <td>支付方式</td>
                    ...
                    <tr>
                        <td>邮箱</td>
                        <td>
                            <input id="txtEmail" name="Email" class="easyui-validatebox textbox" style="width: 350px;" data-options="validType:'email',required:false,prompt:'必填'">
                        </td>
                    </tr>
