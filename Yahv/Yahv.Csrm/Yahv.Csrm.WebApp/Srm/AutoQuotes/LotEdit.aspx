<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="LotEdit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Srm.AutoQuotes.LotEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    },
    {
        ...
        dateFormat: 'MM/DD/YYYY'
                ...
                rowHeaders: true,
                colHeaders: ['型号', '供应商', '品牌', '批次', '封装', '包装', '单价', '数量', '有效期'],//当值为true时显示列头，当值为数组时，列头为数组的值
            ...
            $('.sumbitBtn').click(function () {
                ...
                for (var i = 0; i < rows; i++) {
                    ...
                    // 验证必填项
                    if ($.trim(rowdata[0]) == "" || $.trim(rowdata[2]) == "" || $.trim(rowdata[7]) == "") {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    ...
    <p class="vaildtxt" style="color: red;"></p>
