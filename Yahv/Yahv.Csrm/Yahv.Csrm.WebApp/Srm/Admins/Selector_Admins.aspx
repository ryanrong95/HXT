<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Selector_Admins.aspx.cs" Inherits="Yahv.Csrm.WebApp.Srm.Admins.Selector_Admins" %>
    ...
    <div data-options="region:'center',title:'',split:false" style="height: 109px;">
        ...
        <div id="tb">
            <table class="liebiao-compact">
                <tr>
                    <td style="width:110px;">ID/姓名/用户名</td>
                    <td>
                        <input id="s_name" data-options="prompt:'ID/姓名/用户名',validType:'length[1,50]',isKeydown:true" class="easyui-textbox"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
