<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Srm.PendingWsSuppliers.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        function btnformatter(value, rowData) {
            ...
            if (rowData.WsSupplierStatus == '<%=(int)ApprovalStatus.Waitting%>') {
