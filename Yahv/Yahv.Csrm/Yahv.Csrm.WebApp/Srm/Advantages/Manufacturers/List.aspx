<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Uc/Works.Master" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Srm.Advantages.Manufacturers.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        $(function () {
            document.getElementById("ptf").style.display = "none";
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    <div data-options="region:'center',title:'优势品牌',split:false">
        <input type="hidden" id="supplierid" value="<%=SupplierID %>" />
        <div style="margin: 10px;">
            <h2 style="width: 400px;">说明：</h2>
        ...
        <%--<a id="btnAdd" class="easyui-linkbutton" data-options="iconCls:'icon-yg-add'">添加</a>--%>
