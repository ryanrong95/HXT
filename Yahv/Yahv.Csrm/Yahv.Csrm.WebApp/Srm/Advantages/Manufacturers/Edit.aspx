<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Uc/Works.Master"  CodeBehind="Edit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Srm.Advantages.Manufacturers.Edit" %>
        ...
        $(function () {
            ...
            $('#btnSave').click(function () {
                ...
                for (var i = 0; i < rows; i++) {
                    ...
                    var obj = {
                        Name: rowdata[0],
                        Agent: (rowdata[1] == "是" || rowdata[1]) ? true : false,
                    };
                    source.push(obj);
                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    <input type="hidden" id="adminid" value="<%=SupplierID %>" />
