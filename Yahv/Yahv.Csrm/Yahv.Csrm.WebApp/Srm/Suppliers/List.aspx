<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Csrm.WebApp.Srm.Suppliers.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        function btnformatter(value, rowData) {
            ...
            if (rowData.SupplierStatus == '<%=(int)ApprovalStatus.Normal%>') {
        ...
        function showAddPage() {
            $.myWindow({
                title: "新增供应商",
                url: 'Edit1.aspx', onClose: function () {
        ...
        function showEditPage(id) {
            $.myWindow({
                title: "供应商基本信息",
                url: 'Edit1.aspx?id=' + id, onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "50%",
                height: "65%",
