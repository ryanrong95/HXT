<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Csrm.WebApp.Srm.Suppliers.Edit1" %>
        ...
        $(function () {
            ...
            $('#selSupplierType').combobox({
                ...
                onLoadSuccess: function (data) {
                    if (data.length > 0) {
                        $("#selSupplierType").combobox('select', model.Entity == null ? data[0].value : model.Entity.Type);  //全部
                    }
                }
            });
            $('#selSupplierNature').combobox({
                ...
                onLoadSuccess: function (data) {
                    if (data.length > 0) {
                        $("#selSupplierNature").combobox('select', model.Entity == null ? data[0].value : model.Entity.Nature);  //全部
                    }
                }
            });
            $('#selInvoiceType').combobox({
                ...
                onLoadSuccess: function (data) {
                    if (data.length > 0) {
                        $("#selInvoiceType").combobox('select', model.Entity == null ? data[0].value : model.Entity.InvoiceType);  //全部
                    }
                }
            });
            ...
            $('#selCurrency').combobox({
                ...
                onLoadSuccess: function (data) {
                    if (data.length > 0) {
                        $("#selCurrency").combobox('select', model.Entity == null ? data[0].value : model.Entity.Currency);  //全部
                    }
                }
            });
            $('#cboGrade').combobox({
    ...
    <div class="easyui-panel" id="tt" data-options="fit:true" style="padding: 10px 10px 0px 10px;">
        ...
        <table class="liebiao">
            <tr>
                ...
                <td colspan="3">
                    <input id="txtName" name="Name" class="easyui-textbox readonly_style"
                        data-options="prompt:'供应商名称,名称要保证全局唯一',required:true,validType:'length[1,75]'" style="width: 350px;">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input id="chbFactory" class="easyui-checkbox" name="IsFactory" value="1" />&nbsp;&nbsp;&nbsp;&nbsp;
                            <%--使用内部公司控件--%>
                    <input id="txt_InternalCompany" class="easyui-InternalCompany" name="txt_InternalCompany" value="" data-options="width:316" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input id="txtRepayCycle" name="RepayCycle" class="easyui-numberspinner" style="width: 350px;" data-options="min:0,precision:0,required:true," value="0">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input id="txtPrice" name="Price" class="easyui-numberbox" style="width: 350px;" data-options="min:0,precision:5,validType:'number',required:true" value="0">
                </td>
            </tr>
        </table>
