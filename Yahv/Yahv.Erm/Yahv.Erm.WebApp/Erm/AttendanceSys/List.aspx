<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm.AttendanceSys.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
            ...
            $.post("?action=getData", getQuery(),
                function (result) {
                    ...
                    settings = {
                        ...
                        wordWrap: false,    //自动换行
                        width: "100%",
                        height: $(window).height() - 100,      //设置了高度以后就会出现横向滚动条
                        //隐藏列
                        hiddenColumns: {
                            columns: [0, 1],
                            indicators: false
        ...
        function getColNames() {
            return [
                { data: "PayID", title: "PayID", type: "text", readOnly: true },
                { data: "StaffID", title: "StaffID", type: "text", readOnly: true },
                { data: "City", title: "地区", type: "text", readOnly: true },
                { data: "CompanyName", title: "所属公司", type: "text", readOnly: true },
                { data: "DyjCompanyCode", title: "分公司", type: "text", readOnly: true },
                { data: "DyjDepartmentCode", title: "部门", type: "text", readOnly: true },
                { data: "DyjCode", title: "ID（工号）", type: "text", readOnly: true },
                { data: "StaffName", title: "姓名", type: "text", readOnly: true },
                { data: "PostionName", title: "考核岗位", type: "text", readOnly: true },
                //{ data: "IDCard", title: "身份证号码", type: "text", readOnly: true },
                //{ data: "StaffStatusName", title: "员工状态", type: "text", readOnly: true },
                { data: "考勤扣款", title: "考勤扣款", type: "text", readOnly: false }
            ];
        }
    </script>
</asp:Content>
