<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="AllList.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm.PayBills.AllList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        var getQuery = function () {
            var params = {
                s_name: $("#<%= s_name.ClientID %>").val(),
                s_begin: $("#<%= s_begin.ClientID %>").val(),
                s_end: $("#<%= s_end.ClientID %>").val(),
            };
            return params;
        };
        ...
        function Edit(dateIndex, staffId) {
            $.myDialog({ title: '个税详情', isHaveOk: false, url: 'IncomeTax.aspx?dateIndex=' + dateIndex + '&staffId=' + staffId });
        }
    </script>
</asp:Content>
    ...
    <div id="topper">
        ...
        <table class="liebiao-compact">
            <tr>
                ...
                <td>
                    <input id="s_name" runat="server" data-options="prompt:'姓名/工号',validType:'length[1,75]',isKeydown:true" class="easyui-textbox" />
                </td>
                <td style="width: 90px;">工资日期</td>
                <td>
                    <input id="s_begin" runat="server" type="text" class="easyui-datebox" />
                    至
                    <input id="s_end" runat="server" type="text" class="easyui-datebox"/>
                </td>
                <td>
