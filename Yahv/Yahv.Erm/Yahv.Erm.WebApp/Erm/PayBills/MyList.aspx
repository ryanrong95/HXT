<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="MyList.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm.PayBills.MyList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
        ...
        <table class="liebiao-compact">
            <tr>
                ...
                <td style="width: 150px;">
                    <input id="s_wageDate" type="text" class="easyui-datebox">
                </td>
                <td>
    ...
    <table id="tab1" title="我的工资列表"></table>
</asp:Content>
