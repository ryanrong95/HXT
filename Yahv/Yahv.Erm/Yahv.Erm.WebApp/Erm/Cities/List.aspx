<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm.Cities.List" %>

<%@ Import Namespace="Yahv.Underly" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        var category = "<%=(int)Category.StaffInCity %>";
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    <table id="tg" class="easyui-treegrid" title="" style="">
        <thead>
            <tr>
                <th data-options="field:'name',width:180">城市名称</th>
