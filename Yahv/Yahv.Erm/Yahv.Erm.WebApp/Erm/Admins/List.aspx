<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm.Admins.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        function Manufaturers(id) {
            $.myWindow({
                title: '优势品牌',
                url: '../Advantages/Manufacturers/List.aspx?id=' + id,
                onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "50%",
        ...
        function Partnumbers(id) {
            $.myWindow({
                title: '优势型号',
                url: '../Advantages/PartNumbers/List.aspx?id=' + id,
                onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "50%",
    ...
    <table id="tab1" title="管理员列表">
        <thead>
            <tr>
                ...
                <th data-options="field:'btn',formatter:btn_formatter,width:300">操作</th>
            </tr>
        </thead>
    </table>
</asp:Content>
