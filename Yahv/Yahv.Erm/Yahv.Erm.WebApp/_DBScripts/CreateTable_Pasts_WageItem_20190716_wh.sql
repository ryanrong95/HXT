...
/****** Object:  Table [dbo].[Pasts_WageItem]    Script Date: 07/16/2019 11:40:22 ******/
SET ANSI_NULLS ON
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'工资项名称' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Pasts_WageItem', @level2type=N'COLUMN',@level2name=N'Name'
GO
