<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_ArchiveBorrow.Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#Financer").combobox('setValue', model.FinanceAdmin.ID);
            //文件信息
            $('#file').myDatagrid({
                fitColumns: true,
                fit: false,
            ...
            $("#btnSubmit").click(function () {
                ...
                data.append('ArchiveName', $("#ArchiveName").textbox("getValue"));
                data.append('BorrowDate', $("#BorrowDate").datetimebox("getValue"));
                data.append('ReturnDate', $("#ReturnDate").datetimebox("getValue"));
                data.append('Reason', $("#Reason").textbox("getValue"));
                data.append('Keeper', $("#Keeper").combobox("getValue"));
                data.append('Financer', $("#Financer").combobox("getValue"));
                //文件信息
    ...
    <script>
        ...
        function Init() {
            if (model.ApplicationData != null) {
                ...
                if (model.ApplicationData.Financer != "" && model.ApplicationData.Financer != null) {
                    $("#Financer").combobox('setValue', model.ApplicationData.Financer);
                }
            }
            else {
        ...
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                <tr>
                    ...
                    <td>
                        <input id="ArchiveName" class="easyui-textbox" style="width: 350px;" data-options="required:true," />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">借阅事由：</td>
                    <td>
                ...
                <tr>
                    <td class="lbl">借阅时间：</td>
                    <td>
                        <input id="BorrowDate" class="easyui-datetimebox" style="width: 350px;" data-options="required:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">归还时间：</td>
                    <td>
                        <input id="ReturnDate" class="easyui-datetimebox" style="width: 350px;" data-options="required:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">借阅员工：</td>
                    <td>
                        <input id="Staff" class="easyui-combobox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">借阅部门：</td>
                    <td>
                ...
                <tr>
                    <td class="lbl">单证档案保管人：</td>
                    <td>
                        <input id="Keeper" class="easyui-combobox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">财务部负责人：</td>
                    <td>
                        <input id="Financer" class="easyui-combobox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
