<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Complete.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Recruit.Complete" %>
        ...
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                <tr>
                    ...
                    <td>
                        <input id="Department" class="easyui-combobox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                    <td class="lbl">岗位名称：</td>
                    <td>
                        <input id="PostionName" class="easyui-textbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">需求人数：</td>
                    <td>
                        <input id="NumberOfNeeds" class="easyui-numberbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                    <td class="lbl">工作地点：</td>
                    <td>
                        <input id="WorkAddress" class="easyui-textbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">现有岗位数量：</td>
                    <td>
                        <input id="NumberOfPositions" class="easyui-numberbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                    <td class="lbl">现有在岗人数：</td>
                    <td>
                        <input id="NumberOfNow" class="easyui-numberbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">拟招聘人数：</td>
                    <td colspan="3">
                        <input id="NumberOfRecruiters" class="easyui-numberbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">招聘途经：</td>
                    <td>
                        <input id="SocialRecruitment" name="SocialRecruitment" class="easyui-checkbox" data-options="label:'社会招聘',labelPosition:'after',disabled:true">
                        <input id="CampusRecruitment" name="CampusRecruitment" class="easyui-checkbox" data-options="label:'校园招聘',labelPosition:'after',disabled:true">
                        <input id="InternalTransfer" name="InternalTransfer" class="easyui-checkbox" data-options="label:'内部调动',labelPosition:'after',disabled:true">
                        <input id="OtherWay" name="OtherWay" class="easyui-checkbox" data-options="label:'其它',labelPosition:'after',disabled:true">
                    </td>
                    <td class="lbl">岗位需求：</td>
                    <td>
                        <input id="LeaveSupplement" name="LeaveSupplement" class="easyui-checkbox" data-options="label:'离职补充',labelPosition:'after',disabled:true">
                        <input id="CoordinateSupplement" name="CoordinateSupplement" class="easyui-checkbox" data-options="label:'调协补充',labelPosition:'after',disabled:true">
                        <input id="PostAddition" name="PostAddition" class="easyui-checkbox" data-options="label:'岗位新增',labelPosition:'after',disabled:true">
                        <input id="PostExpansion" name="PostExpansion" class="easyui-checkbox" data-options="label:'岗位扩员',labelPosition:'after',disabled:true">
                    </td>
                </tr>
                <tr>
                    <td class="lbl">出差需求：</td>
                    <td>
                        <input class="easyui-radiobutton" id="NotNeed" name="BusinessTripRequirement" data-options="labelPosition:'after',checked: true,label:'不需要',disabled:true">
                        <input class="easyui-radiobutton" id="NotOften" name="BusinessTripRequirement" data-options="labelPosition:'after',label:'偶尔',disabled:true">
                        <input class="easyui-radiobutton" id="Often" name="BusinessTripRequirement" data-options="labelPosition:'after',label:'经常',disabled:true">
                    </td>
                    <td class="lbl">需求等级：</td>
                    <td>
                        <input class="easyui-radiobutton" id="NotEmergent" name="EmergentRequirement" data-options="labelPosition:'after',checked: true,label:'不紧急',disabled:true">
                        <input class="easyui-radiobutton" id="GeneralEmergent" name="EmergentRequirement" data-options="labelPosition:'after',label:'一般紧急',disabled:true">
                        <input class="easyui-radiobutton" id="Emergent" name="EmergentRequirement" data-options="labelPosition:'after',label:'紧急',disabled:true">
                    </td>
                </tr>
                <tr>
                    <td class="lbl">试用期薪资：</td>
                    <td>
                        <input id="PeriodSalary" class="easyui-numberbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                    <td class="lbl">转正后薪资：</td>
                    <td>
                        <input id="NormalSalary" class="easyui-numberbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">期望到岗时间：</td>
                    <td colspan="3">
                        <input id="ExpectedArrivalTime" class="easyui-datebox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    ...
                    <td>
                        <div style="width: 400px">
                            <input class="easyui-radiobutton" id="Male" name="GenderRequirement" data-options="labelPosition:'after',checked: true,label:'男',disabled:true">
                            <input class="easyui-radiobutton" id="Female" name="GenderRequirement" data-options="labelPosition:'after',label:'女',disabled:true">
                            <input class="easyui-radiobutton" id="MaleOrFemale" name="GenderRequirement" data-options="labelPosition:'after',label:'不限',disabled:true">
                        </div>
                    </td>
                    <td class="lbl">学历要求：</td>
                    <td>
                        <div style="width: 400px">
                            <input class="easyui-radiobutton" id="CollegeDegree" name="EducationRequirement" data-options="labelPosition:'after',checked: true,label:'大专及以上',disabled:true">
                            <input class="easyui-radiobutton" id="BachelorDegree" name="EducationRequirement" data-options="labelPosition:'after',label:'本科及以上',disabled:true">
                            <input class="easyui-radiobutton" id="MasterDegree" name="EducationRequirement" data-options="labelPosition:'after',label:'硕士及以上',disabled:true">
                            <input class="easyui-radiobutton" id="OtherDegree" name="EducationRequirement" data-options="labelPosition:'after',label:'其它',disabled:true">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input id="AgeRequirement" class="easyui-textbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                    <td class="lbl">专业要求：</td>
                    <td>
                        <input id="MajorRequirement" class="easyui-textbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">经验要求：</td>
                    <td>
                        <input id="ExperienceRequirement" class="easyui-textbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                    <td class="lbl">其他要求：</td>
                    <td>
                        <input id="OtherRequirement" class="easyui-textbox" style="width: 200px;" data-options="required: true,disabled:true" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <input id="PositionDescription" class="easyui-textbox" style="width: 600px; height: 50px"
                            data-options="multiline:true,required: true,disabled:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl" style="color: red">招聘结果：</td>
                    <td colspan="3">
                        <input id="Argument" class="easyui-textbox" style="width: 600px; height: 50px" data-options="multiline:true,required: true," />
                    </td>
                </tr>
            </table>
