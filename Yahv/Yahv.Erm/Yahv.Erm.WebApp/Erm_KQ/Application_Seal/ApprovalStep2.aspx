<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ApprovalStep2.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Seal.ApprovalStep2" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                //基本信息
                data.append('ID', ID);
                data.append('Sealer', $("#Sealer").combobox("getValue"));
                //文件信息
    ...
    <div class="easyui-layout" style="width: 100%; height: 100%; border: none">
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    ...
                    <td>
                        <input id="BorrowDate" class="easyui-datebox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">归还日期：</td>
                    <td>
                        <input id="ReturnDate" class="easyui-datebox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input id="Sealer" class="easyui-combobox" style="width: 350px;" />
                    </td>
                </tr>
            </table>
        ...
        <div data-options="region:'south',height:40" style="background-color: #f5f5f5">
            <div style="float: right; margin-right: 5px; margin-top: 8px;">
                <a id="btnSubmit" class="easyui-linkbutton" iconcls="icon-yg-confirm">已安排</a>
                <a id="btnReject" class="easyui-linkbutton" iconcls="icon-back">退回</a>
