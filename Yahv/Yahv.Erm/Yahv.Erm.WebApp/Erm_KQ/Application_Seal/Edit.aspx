<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Seal.Edit" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                data.append('SealType', $("#SealType").combogrid("getValues"));
                data.append('SealBorrowType', $("#SealBorrowType").combobox("getValue"));
                data.append('BorrowDate', $("#BorrowDate").datebox("getValue"));
                data.append('ReturnDate', $("#ReturnDate").datebox("getValue"));
    ...
    <script>
        ...
        function Init() {
            if (model.ApplicationData != null) {
                ...
                $("#SealType").combogrid('setValues', model.ApplicationData.SealType);
        ...
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    ...
                    <td>
                        <input id="SealType" class="easyui-combogrid" style="width: 350px;height:40px" />
                    </td>
                </tr>
                <tr>
