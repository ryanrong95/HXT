    ...
    public partial class Edit : ErpParticlePage
    {
        ...
        protected void Submit()
        {
            try
            {
                ...
                string SealType = Request.Form["SealType"];
                string SealBorrowType = Request.Form["SealBorrowType"];
                DateTime BorrowDate = Convert.ToDateTime(Request.Form["BorrowDate"]);
                DateTime ReturnDate = string.IsNullOrEmpty(Request.Form["ReturnDate"]) ? BorrowDate : Convert.ToDateTime(Request.Form["ReturnDate"]);
                ...
                application.Title = "印章借用申请";
                application.Context = new SealBorrowContext()
                {
                    ApproveID = Manager,
                    ApproveName = ManagerName,
                    DepartmentCode = staff.DepartmentCode,
                    SealType = SealType,
                    SealBorrowType = SealBorrowType,
                ...
                application.ApplicationType = Services.ApplicationType.SealBorrow;
