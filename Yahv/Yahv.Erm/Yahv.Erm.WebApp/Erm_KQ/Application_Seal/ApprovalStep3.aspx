<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ApprovalStep3.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Seal.ApprovalStep3" %>
        ...
        $(function () {
            ...
            $("#SealType").combogrid({
                ...
                columns: [[
                    ...
                    { field: 'Staff', title: '保管人', width: 80, align: 'center' },
                ]],
            })
            $("#SealBorrowType").combobox({
                required: true,
                disabled: true,
                valueField: 'Value',
                textField: 'Text',
                data: model.SealBorrowType,
            })
            $("#Sealer").combobox({
                editable: false,
                required: true,
                valueField: 'Value',
                textField: 'Text',
                data: model.SealerData,
            })
            ////借用日期（只能选当天或之后的日期）
            //$('#BorrowDate').datebox('calendar').calendar({
            ...
            //            validator: function (date) {
            //                var borrow = new Date($('#BorrowDate').datebox('getValue'));
            //                var d1 = new Date(borrow.getFullYear(), borrow.getMonth(), borrow.getDate());
            //                return date >= d1;
            //            },
            //        })
            //    }
    ...
    <script>
        ...
        function Init() {
            if (model.ApplicationData != null) {
                ...
                $("#SealType").combobox('setValue', model.ApplicationData.SealType);
                $("#SealBorrowType").combobox('setValue', model.ApplicationData.SealBorrowType);
                $("#BorrowDate").datebox('setValue', model.ApplicationData.BorrowDate);
                $("#ReturnDate").datebox('setValue', model.ApplicationData.ReturnDate);
                $("#Reason").textbox('setValue', model.ApplicationData.Reason);
                $("#Sealer").combobox('setValue', model.ApplicationData.Sealer);
            }
            else {
    ...
    <div class="easyui-layout" style="width: 100%; height: 100%; border: none">
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    <td class="lbl">使用性质：</td>
                    <td>
                        <input id="SealBorrowType" class="easyui-combobox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">印章证照：</td>
                    <td>
                        <input id="SealType" class="easyui-combobox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">使(借)用日期：</td>
                    <td>
                        <input id="BorrowDate" class="easyui-datebox" style="width: 350px;" data-options="disabled: true"/>
                    </td>
                </tr>
                <tr>
                    <td class="lbl">归还日期：</td>
                    <td>
                        <input id="ReturnDate" class="easyui-datebox" style="width: 350px;" data-options="disabled: true"/>
                    </td>
                </tr>
                <tr>
                    <td class="lbl">使(借)用事由：</td>
                    <td>
                ...
                <tr>
                    <td class="lbl">印章盖章人：</td>
                    <td>
                        <input id="Sealer" class="easyui-combobox" style="width: 350px;" data-options="disabled: true"/>
                    </td>
                </tr>
            </table>
        ...
        <div data-options="region:'south',height:40" style="background-color: #f5f5f5">
            <div style="float: right; margin-right: 5px; margin-top: 8px;">
                <a id="btnSubmit" class="easyui-linkbutton" iconcls="icon-yg-confirm">已盖章</a>
