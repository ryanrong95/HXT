<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfMy.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Seal.ListOfMy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    ...
    <table id="tab1" title="我的印章使用/借用申请列表">
        <thead>
            <tr>
