<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works_hidden.Master" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Offtime.Approval" %>
    ...
    <script>
        ...
        function Init() {
            ...
            if (model.ApplicationData != null) {
                ...
                if(model.ApplicationData.Days>=10)
                {
                    $("#SwapStaff").combobox({ 
                        valueField: 'Value',
                        textField: 'Text',
