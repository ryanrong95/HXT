<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfMy.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Offtime.ListOfMy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        //新增
        function Add() {
            var url = location.pathname.replace(/ListOfMy.aspx/ig, 'Add.aspx')+ '?AdminID='+model.CurrentAdmin.ID;
            $.myWindow({
                title: "新增请假申请",
                url: url,
                onClose: function () {
    ...
    <table id="tab1" title="我的请假申请列表">
        <thead>
            <tr>
                ...
                <th data-options="field:'Dates',align:'left',width:150">请假日期</th>
