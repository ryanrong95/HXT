<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ApprovalStep2.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_WorkCard.ApprovalStep2" %>
    ...
    <div class="easyui-layout" style="width: 100%; height: 100%; border: none">
        ...
        <div data-options="region:'south',height:40" style="background-color: #f5f5f5">
            <div style="float: right; margin-right: 5px; margin-top: 8px;">
                <a id="btnSubmit" class="easyui-linkbutton" iconcls="icon-yg-confirm">受理</a>
