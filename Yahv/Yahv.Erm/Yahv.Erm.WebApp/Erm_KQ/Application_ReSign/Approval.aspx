<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_ReSign.Approval" %>
        ...
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    ...
                    <td>
                        <input id="Date" class="easyui-datebox" style="width: 350px;" data-options="disabled:true"/>
                    </td>
