<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfApproval.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_ReSign.ListOfApproval" %>
    ...
    <table id="tab1" title="补签审批列表">
        <thead>
            <tr>
                ...
                <th data-options="field:'DepartmentType',align:'center',width:100">部门</th>
                <th data-options="field:'Manager',align:'center',width:100">部门负责人</th>
                <th data-options="field:'Date',align:'center',width:100">补签日期</th>
