<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfMy.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_ReSign.ListOfMy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        function Edit(id) {
            ...
            var url = location.pathname.replace(/ListOfMy.aspx/ig, 'Edit.aspx')+ '?ID=' + id+'&AdminID='+model.CurrentAdmin.ID+'&DateStr=';
            $.myWindow({
                title: title,
                url: url,
                onClose: function () {
