    ...
    public partial class Edit : ErpParticlePage
    {
        ...
        protected void Submit()
        {
            ...
            try
            {
                ...
                string TravelExpenses = Request.Form["TravelExpenses"];
                string InstitutionName = Request.Form["InstitutionName"];
                string CourseValue = Request.Form["CourseValue"];
                ...
                application.Title = "外训申请";
                application.Context = new ExternalTrainingContext()
                {
                    ApproveID = Manager,
                ...
                application.ApplicationType = Services.ApplicationType.ExternalTraining;
