<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfMy.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_ExternalTraining.ListOfMy" %>
    ...
    <table id="tab1" title="我的外训申请列表">
        <thead>
            <tr>
                ...
                <th data-options="field:'TrainingTime',align:'left',width:150">培训时间</th>
                <th data-options="field:'TrainingLocation',align:'left',width:150">培训地址</th>
                <th data-options="field:'CourseName',align:'left',width:150">课程名称</th>
                <th data-options="field:'InstitutionName',align:'left',width:150">培训机构</th>
