<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ApprovalStep.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_ExternalTraining.ApprovalStep" %>
        ...
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    ...
                    <td>
                        <input id="TrainingTime" class="easyui-datetimebox" style="width: 350px;" data-options="disabled:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">外训地点：</td>
                    <td>
                        <input id="TrainingLocation" class="easyui-textbox" style="width: 350px;" data-options="disabled:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">外训课程名称：</td>
                    <td>
                        <input id="CourseName" class="easyui-textbox" style="width: 350px;" data-options="disabled:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">学费(RMB)：</td>
                    <td>
                        <input id="Tuition" class="easyui-numberbox" style="width: 350px;" data-options="disabled:true,min:0,precision:2" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">差旅费(RMB)：</td>
                    <td>
                        <input id="TravelExpenses" class="easyui-numberbox" style="width: 350px;" data-options="disabled:true,min:0,precision:2" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">外训机构名称：</td>
                    <td>
                        <input id="InstitutionName" class="easyui-textbox" style="width: 350px;" data-options="disabled:true" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input id="Trainees" class="easyui-combogrid" style="width: 600px; height: 60px" data-options="disabled:true"/>
                    </td>
                </tr>
                <tr>
