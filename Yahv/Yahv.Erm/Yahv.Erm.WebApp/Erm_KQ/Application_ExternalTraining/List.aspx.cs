    ...
    public partial class List : ErpParticlePage
    {
        ...
        protected object data()
        {
            ...
            var applications = Erp.Current.Erm.ApplicationsRoll
                .Where(item => item.ApplicationType == Services.ApplicationType.ExternalTraining)
                .Where(expression);
            ...
            var result = data.OrderByDescending(item => item.CreateDate).ToArray().Select(item => new
            {
                ...
                DepartmentType = item.ExternalTrainingContext.DepartmentName,
                Manager = item.ExternalTrainingContext.ApproveName,
                TrainingTime = item.ExternalTrainingContext.TrainingTime.ToString("yyyy-MM-dd HH:mm:ss"),
                TrainingLocation = item.ExternalTrainingContext.TrainingLocation,
                CourseName = item.ExternalTrainingContext.CourseName,
                InstitutionName = item.ExternalTrainingContext.InstitutionName,
