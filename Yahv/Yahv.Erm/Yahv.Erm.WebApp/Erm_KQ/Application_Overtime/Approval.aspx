<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Overtime.Approval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#OvertimeExchangeType").combobox({
                required: true,
                disabled: false,
                valueField: 'Value',
                textField: 'Text',
                data: model.OvertimeExchangeType,
            })
            $("#Date").datebox({
                required: true,
            })
            ...
            $("#btnSubmit").click(function () {
                ...
                data.append('OvertimeExchangeType', $("#OvertimeExchangeType").combobox("getValue"));
                //文件信息
    ...
    <script>
        ...
        function Init() {
            ...
            $("#OvertimeExchangeType").combobox('setValue', model.ApplicationData.OvertimeExchangeType);

            $("#AttendRecord").textbox('setValue', model.AttendData.AttendTime);
        }
    </script>
    <script>
        //文件操作
    ...
    <div class="easyui-layout" style="width: 100%; height: 100%;">
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    <td class="lbl">加班兑换类型：</td>
                    <td>
                        <input id="OvertimeExchangeType" class="easyui-combobox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
