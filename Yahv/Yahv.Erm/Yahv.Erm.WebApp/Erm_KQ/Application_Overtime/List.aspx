<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Overtime.List" %>
    ...
    <table id="tab1" title="加班申请列表">
        <thead>
            <tr>
                ...
                <th data-options="field:'Date',align:'center',width:50">加班日期</th>
                <th data-options="field:'Reason',width:150">加班原因</th>
