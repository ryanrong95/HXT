<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfApproval.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Overtime.ListOfApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        function Edit(id) {
            ...
            var url = location.pathname.replace(/ListOfApproval.aspx/ig, 'Edit.aspx') + '?ID=' + id + '&AdminID=';
            $.myWindow({
                title: "新增申请",
                url: url,
                onClose: function () {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    ...
    <table id="tab1" title="加班审批列表">
        <thead>
            <tr>
                <th data-options="field:'btn',align:'center',formatter:Operation,width:100">操作</th>
                <th data-options="field:'ApplicantName',align:'center',width:100">加班人</th>
                <th data-options="field:'CreateDate',align:'center',width:100">申请日期</th>
                <th data-options="field:'Date',align:'center',width:100">加班日期</th>
                ...
                <th data-options="field:'Reason',width:200">加班原因</th>
            </tr>
        </thead>
    </table>
</asp:Content>
