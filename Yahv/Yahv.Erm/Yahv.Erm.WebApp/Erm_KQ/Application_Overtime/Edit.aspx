<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Overtime.Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        var PayDay = <%=Yahv.Erm.Services.OvertimeExchangeType.PayDay.GetHashCode()%>;
        ...
        $(function () {
            ...
            $("#OvertimeExchangeType").combobox('setValue',PayDay)
            //加班日期（只能选当天或之后的日期）
