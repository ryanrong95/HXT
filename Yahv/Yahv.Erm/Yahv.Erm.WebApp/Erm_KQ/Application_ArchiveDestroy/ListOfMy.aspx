<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfMy.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_ArchiveDestroy.ListOfMy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    ...
    <table id="tab1" title="我的单证档案销毁申请">
        <thead>
            <tr>
                ...
                <th data-options="field:'Supervisor',align:'center',width:100">监销人</th>
