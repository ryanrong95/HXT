    ...
    public partial class List : ErpParticlePage
    {
        ...
        protected object data()
        {
            ...
            var applications = Erp.Current.Erm.ApplicationsRoll
                .Where(item => item.ApplicationType == Services.ApplicationType.ArchiveDestroy)
                .Where(expression);
            ...
            var result = data.OrderByDescending(item => item.CreateDate).ToArray().Select(item => new
            {
                ...
                DepartmentType = item.ArchiveDestroyContext.DepartmentName,
                Manager = item.ArchiveDestroyContext.ApproveName,
                Supervisor = item.ArchiveDestroyContext.SupervisorName,
