<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_SealEngrave.Edit" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                data.append('SealName', $("#SealName").textbox("getValue"));
                data.append('SealShape', $("#SealShape").combobox("getValue"));
                data.append('SealShapeDec', $("#SealShapeDec").textbox("getValue"));
                data.append('SealSize', $("#SealSize").textbox("getValue"));
                data.append('Reason', $("#Reason").textbox("getValue"));
                //文件信息
                var file = $('#file').datagrid('getRows');
                if (file.length == 0) {
                    top.$.timeouts.alert({ position: "TC", msg: "请上传印章模板", type: "error" });
                    return false;
                }
                var files = [];
        ...
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    ...
                    <td>
                        <input id="SealName" class="easyui-textbox" style="width: 350px;" data-options="required:true"/>
                    </td>
                </tr>
                <tr>
                    <td class="lbl">印章形状：</td>
                    <td>
                        <input id="SealShape" class="easyui-combobox" style="width: 350px;" />
                    </td>
                </tr>
                <tr class="Dec" style="display: none">
                    <td class="lbl">形状描述：</td>
                    <td>
                        <input id="SealShapeDec" class="easyui-textbox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">印章规格：</td>
                    <td>
                        <input id="SealSize" class="easyui-textbox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
