<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ApprovalStep.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_SealEngrave.ApprovalStep" %>
        ...
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    ...
                    <td>
                        <input id="SealName" class="easyui-textbox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
