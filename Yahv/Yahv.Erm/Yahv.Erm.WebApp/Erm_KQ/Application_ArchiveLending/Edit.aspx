<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_ArchiveLending.Edit" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                data.append('Count', $("#Count").numberspinner("getValue"));
                //文件信息
        ...
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    ...
                    <td>
                        <input id="Count" class="easyui-numberspinner" style="width: 350px;" data-options="value:1,min:1,max:100">
                    </td>
                </tr>
                <tr>
