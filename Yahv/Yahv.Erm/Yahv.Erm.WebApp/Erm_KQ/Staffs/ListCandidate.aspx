<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListCandidate.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Staffs.ListCandidate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        //详情
        function Detail(id) {
            var url = location.pathname.replace(/ListCandidate.aspx/ig, 'TabDetail.aspx') + '?ID=' + id;
            $.myWindow({
                title: "员工综合信息",
                url: url,
                minWidth: 1000,
    ...
    <table id="tab1" title="应聘人员列表">
        <thead>
            <tr>
                ...
                <th data-options="field:'ApprovalStep',width:100">当前步骤</th>
                <th data-options="field:'StatusDec',width:80">当前状态</th>
