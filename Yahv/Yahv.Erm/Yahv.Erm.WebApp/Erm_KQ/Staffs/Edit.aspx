<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Staffs.Edit" %>
        ...
        $(function () {
            ...
            $("#dg").myDatagrid({
                ...
                columns: [[
                    ...
                    { field: 'Position', title: '职务名称', width: 100, align: 'center', editor: { type: 'textbox', options: { required: true } } },
                    { field: 'Salary', title: '薪资', width: 100, align: 'center', editor: { type: 'numberbox', options: { required: true } } },
                    { field: 'LeaveReason', title: '离职原因', width: 200, align: 'center', editor: { type: 'textbox', options: { required: true } } },
                    { field: 'Phone', title: '单位电话', width: 100, align: 'center', editor: { type: 'textbox', options: { required: false } } },
