<%@ Page Language="C#" MasterPageFile="~/Uc/Works_hidden.Master" AutoEventWireup="true" CodeBehind="UnReport.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Staffs.UnReport" %>
    ...
    <div class="easyui-layout" style="width: 100%; height: 100%;">
        ...
        <div data-options="region:'south',height:40" style="background-color: #f5f5f5">
            <div style="float: right; margin-right: 5px; margin-top: 8px;">
                <a id="btnSubmit" class="easyui-linkbutton" iconcls="icon-ok">确认</a>
