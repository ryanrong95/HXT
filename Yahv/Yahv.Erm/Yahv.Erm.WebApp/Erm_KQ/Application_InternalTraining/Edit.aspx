<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_InternalTraining.Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#TrainingMethods").combobox({
                required: true,
                editable: false,
                multiple: true,
                valueField: 'Value',
                textField: 'Text',
                data: model.TrainingMethod,
            })
            $("#Trainees").combogrid({
                required: true,
                editable: false,
            ...
            $("#btnSubmit").click(function () {
                ...
                data.append('TrainingMethods', $("#TrainingMethods").combobox("getValues"));
                ...
                data.append('TrainingContent', $("#TrainingContent").textbox("getValue"));
                //文件信息
    ...
    <script>
        ...
        function Init() {
            if (model.ApplicationData != null) {
                ...
                $("#TrainingMethods").combobox('setValues', model.ApplicationData.TrainingMethods);
                ...
                $("#TrainingContent").textbox('setValue', model.ApplicationData.TrainingContent);
            }
            else {
    ...
    <div class="easyui-layout" style="width: 100%; height: 100%; border: none">
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    <td class="lbl">培训方式：</td>
                    <td>
                        <input id="TrainingMethods" class="easyui-combobox" style="width: 350px;" data-options="required:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">培训时间：</td>
                    <td>
                        <input id="TrainingTime" class="easyui-datetimebox" style="width: 350px;" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">培训地点：</td>
                    <td>
                        <input id="TrainingLocation" class="easyui-textbox" style="width: 350px;" data-options="required:true" />
                    </td>
                </tr>
                <tr>
                    <td class="lbl">申请原因：</td>
                    <td>
                        <input id="Reason" class="easyui-textbox" style="width: 600px; height: 60px"
                ...
                <tr>
                    <td class="lbl">培训内容：</td>
                    <td>
                        <input id="TrainingContent" class="easyui-textbox" style="width: 600px; height: 100px"
                            data-options="required:true,multiline:true" />
                    </td>
                </tr>
                <tr>
