<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfMy.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_InternalTraining.ListOfMy" %>
    ...
    <table id="tab1" title="我的培训申请">
        <thead>
            <tr>
                ...
                <th data-options="field:'Reason',align:'left',width:200">申请理由</th>
