<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_InternalTraining.Details" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#Trainees").combobox({
                ...
                data: model.StaffData,
                onChange: function () {
                    var values = $("#Trainees").combobox('getValues');
    ...
    <script>
        ...
        function Init() {
            if (model.ApplicationData != null) {
                ...
                $("#Trainees").combobox('setValues', model.ApplicationData.Trainees);
        ...
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr>
                    ...
                    <td>
                        <input id="TrainingMethods" class="easyui-combobox" style="width: 350px;" data-options="disabled:true" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input id="Trainees" class="easyui-combobox" style="width: 600px; height: 60px" data-options="disabled:true" />
                    </td>
                </tr>
                <tr>
