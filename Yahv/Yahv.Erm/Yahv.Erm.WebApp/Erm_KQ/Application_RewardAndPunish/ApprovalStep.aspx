<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ApprovalStep.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_RewardAndPunish.ApprovalStep" %>
        ...
        <div data-options="region:'center'" style="border: none">
            <table id="tab1" class="liebiao">
                ...
                <tr class="Punish" style="display: none">
                    ...
                    <td>
                        <input id="PunishType" class="easyui-combobox" style="width: 350px;" data-options="disabled:true"/>
                    </td>
                </tr>
                <tr class="Punish" style="display: none">
