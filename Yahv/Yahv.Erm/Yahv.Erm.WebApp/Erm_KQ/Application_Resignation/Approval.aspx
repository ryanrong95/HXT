<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Resignation.Approval" %>
        ...
        <div data-options="region:'center'" style="border: none">
            <table class="liebiao">
                ...
                <tr>
                    <td>工作承接人</td>
                    <td colspan="3">
                        <input id="HandoverID" name="HandoverID" class="easyui-textbox" style="width: 200px;" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>工作内容描述</td>
                    <td colspan="3">
                        <input id="JobDescription" name="JobDescription" class="easyui-textbox" style="width: 350px; height: 40px;"
                            data-options="required:true,validType:'length[1,500]',multiline:true" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <input id="Argument" name='Argument' class="easyui-textbox" style="width: 350px; height: 60px"
