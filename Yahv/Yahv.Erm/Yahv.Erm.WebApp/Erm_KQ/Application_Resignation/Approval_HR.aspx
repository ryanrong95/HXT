<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Approval_HR.aspx.cs" Inherits="Yahv.Erm.WebApp.Erm_KQ.Application_Resignation.Approval_HR" %>
        ...
        $(function () {
            ...
            $('#file').myDatagrid({
                ...
                columns: [[
                    ...
                    { field: 'Type', title: '', width: 70, align: 'center', hidden: true },
        ...
        <div data-options="region:'center'" style="border: none">
            <table class="liebiao">
                ...
                <tr>
                    <td>员工岗位</td>
                    <td>
                        <input id="PostionName" name="PostionName" class="easyui-textbox" style="width: 200px;" readonly="readonly" data-options="required:true" />
                    </td>
                    <td>离职日期</td>
                    <td>
                        <input id="ResignationDate" name="ResignationDate" class="easyui-datebox" style="width: 200px;" data-options="required:true" />
                    </td>
                </tr>
                <tr>
                    <td>部门负责人</td>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <div>
                            <input id="fileType" class="easyui-combobox" style="width: 200px;" data-options="prompt:'文件类型'" />
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input id="Argument" name='Argument' class="easyui-textbox" style="width: 350px; height: 40px"
