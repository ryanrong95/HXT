...
(function ($) {
    ...
    //接口地址
    var ajaxUrl = {
        getEnterpriseData: '/Finance/BasicInfo/Companies/Infos.aspx?action=Index_Company',//获取企业数据(前20条)
        getEnterprises: '/Finance/BasicInfo/Companies/Infos.aspx?action=Search_Company&name=',//通过企业名称搜索企业的数据
        getEnterpriseById: '/Finance/BasicInfo/Companies/Infos.aspx?action=Getbyid_Company&id='
    }
    ...
    $.fn.Company = function (opt, param) {
        ...
        (function () {
            ...
            if (s) {
                ...
                options = $.extend(true, {}, $.fn.Company.defaults, data_options, options);
            } else {
        ...
        if (options.value && options.value != "") {
            $(sender).Company('setVal', options.value);
    ...
    //企业插件的默认配置
    $.fn.Company.defaults = $.extend({}, $.fn.combobox.defaults, {
        width: 220,
        target: null,
        value: null,
        valueField: 'ID',
