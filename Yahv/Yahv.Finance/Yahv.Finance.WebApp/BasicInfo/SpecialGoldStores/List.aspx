<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Finance.WebApp.BasicInfo.SpecialGoldStores.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        $(function () {
            ...
            $("#btnAdd").click(function () {
                $.myDialog({
                    title: '添加',
                    url: '/Finance/BasicInfo/SpecialGoldStores/Edit.aspx',
                    width: "576",
                    height: "300",
                    onClose: function () {
                        $("#tab1").myDatagrid('search', getQuery());
    ...
    <script>
        ...
        function edit(id) {
            $.myDialog({
                title: '金库详情',
                url: '/Finance/BasicInfo/SpecialGoldStores/Edit.aspx?id=' + id,
                width: "576",
                height: "300",
                onClose: function () {
                    $("#tab1").myDatagrid('search', getQuery());
