<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="EditPrivate.aspx.cs" Inherits="Yahv.Finance.WebApp.BasicInfo.Accounts.EditPrivate" %>
    ...
    <script>
        $(function () {
            ...
            $('#GoldStore').combobox({
                ...
                onLoadSuccess: function (data) {
                    if (data.length > 0 && model.Data != null) {
                        $(this).combobox('select', model.Data.GoldStoreID);
                    }
                },
                filter: function (q, row) {
                    var opts = $(this).combobox('options');
            ...
            $('#Source').combobox({
                ...
                onSelect: function (record) {
                    ...
                    if ('<%=(int)Yahv.Finance.Services.Enums.AccountSource.Standard%>' == record.value) {
                        ...
                        $("#GoldStore").combobox('textbox').validatebox('options').required = true;
                    ...
                    //简易
                        ...
                        $("#GoldStore").combobox('textbox').validatebox('options').required = false;
    ...
    <div style="padding-bottom: 5px;">
        ...
        <table class="liebiao">
            <tr>
                <td>名称</td>
                <td>
                    <input id="Name" class="easyui-textbox" name="Name" data-options="required:true,width:200" value="" />
                </td>
                <td>银行名称</td>
                <td>
                    <input id="BankName" name="BankName" class="easyui-combobox" data-options="editable:false,required:true," style="width: 200px;" />
                </td>
            ...
            <tr>
                <td>关联公司</td>
                <td>
                    <input id="Enterprise" class="easyui-Enterprise" name="Enterprise" data-options="required:false,width:200,valueField: 'Name',textField: 'Name'" value="" />
                </td>
                <td>银行账户类型</td>
                <td>
            ...
            <tr>
                <td>所在金库</td>
                <td>
                    <input id="GoldStore" name="GoldStore" class="easyui-combobox" data-options="editable:true,required:true," style="width: 200px;" />
                </td>
                <td>是否虚拟账户</td>
                <td>
