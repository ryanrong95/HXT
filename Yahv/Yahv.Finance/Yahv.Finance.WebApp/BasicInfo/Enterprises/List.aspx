<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Finance.WebApp.BasicInfo.Enterprises.List" %>
    ...
    <script>
        $(function () {
            ...
            $("#btnAdd").click(function () {
                $.myDialog({
                    title: '添加',
                    url: '/Finance/BasicInfo/Enterprises/Edit.aspx',
                    width: "576",
                    height: "300",
                    //isHaveOk: false,
                    //isHaveCancel: false,
            ...
            $("#btnEnable").click(function () {
                ...
                $.messager.confirm('Confirm', '确定要启用这些往来单位信息吗？', function (r) {
                    if (r) {
            ...
            $("#btnUnable").click(function () {
                ...
                $.messager.confirm('Confirm', '确定要停用这些往来单位信息吗？', function (r) {
                    if (r) {
    ...
    <script>
        var getQuery = function () {
            var params = {
                ...
                s_district: $.trim($('#s_district').combobox('getValue')),
        ...
        function btnFormatter(value, row) {
            return ['<span class="easyui-formatted">',
                , '<a class="easyui-linkbutton"  data-options="iconCls:\'icon-yg-edit\'" onclick="edit(\'' + row.EnterpriseID + '\');return false;">编辑</a> '
                , '</span>'].join('');
        }

        function edit(EnterpriseID) {
            $.myDialog({
                title: '详情',
                url: '/Finance/BasicInfo/Enterprises/Edit.aspx?id=' + EnterpriseID,
                width: "576",
                height: "300",
                //isHaveOk: false,
                //isHaveCancel: false,
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    <div id="topper">
        ...
        <table class="liebiao-compact">
            <tr>
                <td style="width: 90px;">往来单位</td>
                <td style="width: 300px;">
                    <input id="s_name" data-options="prompt:'往来单位'" style="width: 200px;" class="easyui-textbox" />
                </td>
                <td style="width: 120px;">地区</td>
                <td style="width: 300px;">
                    <select id="s_district" data-options="editable: true," class="easyui-combobox" style="width: 200px;" />
                </td>
    ...
    <table id="tab1" title="往来单位管理">
        <thead>
            <tr>
                <th data-options="field:'ck',checkbox:true"></th>
                <th data-options="field:'EnterpriseID',align:'center',width:fixWidth(12)">编码</th>
                <th data-options="field:'Name',align:'center',width:fixWidth(15)">往来单位</th>
                <th data-options="field:'District',align:'center',width:fixWidth(10)">地区</th>
                <th data-options="field:'TypeName',align:'left',width:fixWidth(12)">类型</th>
