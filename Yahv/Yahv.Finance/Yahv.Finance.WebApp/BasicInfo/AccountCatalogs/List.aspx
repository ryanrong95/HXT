<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Finance.WebApp.BasicInfo.AccountCatalogs.List" %>
    ...
    <script>
        ...
        function edit(id) {
            ...
            $.myDialogFuse({
                ...
                isHaveOk: true,
                isHaveCancel: true,
                url: '/Finance/BasicInfo/AccountCatalogs/Edit.aspx?id=' + id + '&&fatherid=' + node._parentId,
                onClose: function () {
                    loadtree();
                }
            });
        ...
        function add(id) {
            $.myDialogFuse({
                ...
                isHaveOk: true,
                isHaveCancel: true,
                url: '/Finance/BasicInfo/AccountCatalogs/Edit.aspx?fatherid=' + id,
                onClose: function () {
                    loadtree();
                }
            });
