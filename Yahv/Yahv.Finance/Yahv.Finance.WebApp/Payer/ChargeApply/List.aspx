<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.ChargeApply.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        $(function () {
            ...
            $("#btnAdd").click(function () {
                $.myDialog({
                    title: '添加',
                    url: '/Finance/Payer/ChargeApply/Edit.aspx',
                    width: "60%",
                    height: "80%",
                    onClose: function () {
                        $("#tab1").myDatagrid('search', getQuery());
    ...
    <script>
        ...
        function detail(id) {
            $.myDialog({
                title: '详情',
                url: '/Finance/Payer/ChargeApply/Detail.aspx?id=' + id,
                width: "60%",
                height: "80%",
                isHaveOk: false,
                isHaveCancel: true,
        ...
        function edit(id) {
            $.myDialog({
                title: '编辑',
                url: '/Finance/Payer/ChargeApply/Edit.aspx?id=' + id,
                width: "60%",
                height: "80%",
                isHaveOk: true,
                isHaveCancel: true,
    ...
    <div id="topper">
        ...
        <table class="liebiao-compact">
            <tr>
                ...
                <td style="width: 300px;">
                    <input id="s_payer" data-options="prompt:'请输入付款公司'" style="width: 200px;" class="easyui-textbox" />
                </td>
