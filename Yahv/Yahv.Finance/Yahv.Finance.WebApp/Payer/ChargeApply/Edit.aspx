<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.ChargeApply.Edit" %>
        ...
        $(function () {
            ...
            $("#PayeeAccountID").combogrid({
                ...
                onChange: function (now, old) {
                    ...
                    if (now.indexOf('Account') < 0)
                        doSearch(now, model.PayeeAccounts, ['Name', 'BankName', 'Code', 'Currency'], $(this));
                },
                onSelect: function () {
                    var row = $('#PayeeAccountID').combogrid('grid').datagrid('getSelected');
                    $('#PayeeAccountCurrency').combobox('setValue', row.Currency);
            ...
            $('#PayerAccountID').combogrid({
                ...
                onSelect: function () {
                    ...
                    $('#PayerAccountCode').textbox('setValue', row.Code);
                    $('#PayerAccountBankName').textbox('setValue', row.BankName);
            ...
            $('#btnSubmit').click(function () {
                ...
                //data.set('IsImmediately', $('#IsImmediately').checkbox('options').checked);
            ...
            $('#items').myDatagrid({
                ...
                columns: [[
                    ...
                    {
                        field: 'AccountCatalogID', title: '费用类型', width: 200, align: 'center',
                    ...
                    {
                        field: 'Price', title: '金额', width: 200, align: 'center',
                        editor: { type: 'numberbox', options: { min: 0, precision: 2, required: true } }
                    },
                    {
                        field: 'Summary', title: '备注', width: 200, align: 'center',
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    ...
    <div id="tt" class="easyui-tabs" style="border: none;">
        <div title="费用申请项" style="border: none">
