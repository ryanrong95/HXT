<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfExecute.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.ChargeApply.ListOfExecute" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        function edit(id) {
            $.myDialog({
                title: '付款',
                url: '/Finance/Payer/ChargeApply/Execute.aspx?id=' + id,
                width: "60%",
                height: "80%",
                isHaveOk: true,
                isHaveCancel: true,
