<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfApproval.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.ChargeApply.ListOfApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        $(function () {
            ...
            $("#btnAdd").click(function () {
                $.myDialog({
                    title: '添加',
                    url: '/Finance/Payer/FundApply/Edit.aspx',
                    width: "60%",
                    height: "80%",
                    onClose: function () {
                        $("#tab1").myDatagrid('search', getQuery());
    ...
    <script>
        var getQuery = function () {
            var params = {
                action: 'data',
                s_payer: $.trim($('#s_payer').combogrid("getText")),
        ...
        function btnFormatter(value, row) {
            ...
            array.push('<a class="easyui-linkbutton"  data-options="iconCls:\'icon-yg-edit\'" onclick="edit(\'' + row.ID + '\');return false;">审批</a> ');
            array.push('</span>');
            return array.join('');
        }
        ...
        function edit(id) {
            $.myDialog({
                title: '审批',
                url: '/Finance/Payer/ChargeApply/Approval.aspx?id=' + id,
                width: "60%",
                height: "80%",
                isHaveOk: true,
                isHaveCancel: true,
