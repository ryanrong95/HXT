<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.PaymentApply.Detail" %>
    ...
    <div style="padding-bottom: 5px;">
        ...
        <table class="liebiao">
            ...
            <tr>
                ...
                <td>手续费</td>
                <td>
                    <input id="ServiceCharge" name="ServiceCharge" class="easyui-textbox" style="width: 200px;" disabled="disabled" />
                </td>
            </tr>
            <tr>
                <td>申请人</td>
