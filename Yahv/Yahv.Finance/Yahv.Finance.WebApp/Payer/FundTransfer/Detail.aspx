<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.FundTransfer.Detail" %>
    ...
    <script>
        $(function () {
            ...
            if (model.Data) {
                ...
                if (model.Data.MoneyOrderCode) {
                    $('#tr_mo').show();

                    if (model.Data.EndorseDate) {
                        $('#tr_decors').show();
                    } else {
                        $("#tr_decors").hide();
                    }

                    if (model.Data.ExchaneDate) {
                        $('td[name="td_tx"]').show();
                    } else {
                        $('td[name="td_tx"]').hide();
                    }
