<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.AcceptanceApply.Approval" %>
    ...
    <script>
        $(function () {
            ...
            if (model.Data) {
                ...
                if (model.Data.Type == '<%=(int)AcceptanceType.Discount %>') {
                    $('td[name="td_in"]').hide();
                }
            }
