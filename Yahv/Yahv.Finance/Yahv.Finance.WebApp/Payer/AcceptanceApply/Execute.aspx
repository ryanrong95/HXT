<%@ Page Title="Title" Language="C#" MasterPageFile="~/Uc/Works.Master" CodeBehind="Execute.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.AcceptanceApply.Execute" %>
    ...
    <div style="padding-bottom: 5px;">
        ...
        <table class="liebiao">
            <tr>
                ...
                <td>
                    <input id="OutFormCode" name="OutFormCode" class="easyui-textbox" style="width: 200px;" data-options="required:true,prompt:'请您录入调出流水号'" />
                </td>
                <td>调入流水号
                </td>
                <td>
                    <input id="InFormCode" name="InFormCode" class="easyui-textbox" style="width: 200px;" data-options="required:true,prompt:'请您录入调入流水号'" />
                </td>
            </tr>
            <tr>
                <td>付款方式 
            ...
            <tr id="tr_mo">
                <td>承兑日期</td>
                <td>
                    <input id="ExchangeDate" name="ExchangeDate" class="easyui-datebox" style="width: 200px;" data-options="editable:false" />
                </td>
                <td>调入金额</td>
                <td>
                    <input id="PayeePrice" name="PayeePrice" class="easyui-textbox" style="width: 200px;" />
                </td>
            </tr>
            <tr id="tr_decors">
                <td>背书日期</td>
            ...
            <tr>
                ...
                <td>
                    <input id="MoneyOrderID" name="MoneyOrderID" class="easyui-textbox" style="width: 200px;" disabled="disabled" />
                </td>
            </tr>
            <tr>
                <td>调出账户
