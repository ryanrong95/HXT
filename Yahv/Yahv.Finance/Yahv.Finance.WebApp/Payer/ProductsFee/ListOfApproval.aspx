<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfApproval.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.ProductsFee.ListOfApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        function edit(id) {
            $.myDialog({
                title: '审批',
                url: '/Finance/Payer/ProductsFee/Approval.aspx?id=' + id,
                width: "60%",
                height: "80%",
                isHaveOk: true,
                isHaveCancel: true,
    ...
    <table id="tab1" title="货款申请">
        <thead>
            <tr>
                ...
                <th data-options="field:'Status',align:'left',width:fixWidth(10)">状态</th>
