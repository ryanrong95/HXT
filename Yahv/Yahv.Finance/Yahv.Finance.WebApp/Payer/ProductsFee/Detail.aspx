<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.ProductsFee.Detail" %>
    ...
    <script>
        $(function () {
            ...
            if (model.Data) {
                ...
                if (model.Data.PaymentMethord == '<%=PaymentMethord.BankAcceptanceBill.GetDescription() %>'
                    || model.Data.PaymentMethord == '<%=PaymentMethord.CommercialAcceptanceBill.GetDescription() %>') {
                    $('tr[name="tr_mo"]').show();
                } else {
                    $('tr[name="tr_mo"]').hide();
                }
    ...
    <div style="padding-bottom: 5px;">
        ...
        <table class="liebiao">
            ...
            <tr name="tr_mo">
                <td>背书日期</td>
                <td>
                    <input id="EndorseDate" name="EndorseDate" class="easyui-datebox" style="width: 200px;" disabled="disabled" />
                </td>
                <td>是否允许转让</td>
                <td>
                    <select id="IsTransfer" class="easyui-combobox" name="IsTransfer" data-options="editable:false" style="width: 200px;" disabled="disabled">
