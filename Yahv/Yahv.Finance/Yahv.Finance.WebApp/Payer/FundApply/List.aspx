<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.FundApply.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        function detail(id) {
            $.myDialog({
                title: '详情',
                url: '/Finance/Payer/FundApply/Detail.aspx?id=' + id,
                width: "60%",
                height: "80%",
                isHaveOk: false,
                isHaveCancel: true,
        ...
        function edit(id) {
            $.myDialog({
                title: '编辑',
                url: '/Finance/Payer/FundApply/Edit.aspx?id=' + id,
                width: "60%",
                height: "80%",
                isHaveOk: true,
                isHaveCancel: true,
