<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Approval.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.FundApply.Approval" %>
    ...
    <script>
        $(function () {
            ...
            $("#items").myDatagrid({
                ...
                actionName: 'data',
                columns: [[
                    { field: 'AccountCatalogName', title: '类型', width: fixWidth(15) },
            ...
            if (model.Data) {
                ...
                if (model.Data.IsPaid || model.Data.Status == '<%=(int)ApplyStauts.Completed %>') {
                    $('tr[name="tr_auto"]').show();
                    $('tr[name="tr_default"]').hide();
                } else {
                    $('tr[name="tr_auto"]').hide();
                    $('tr[name="tr_default"]').show();
                }
            } else {
                IsShowDate(model.Data.IsPaid);       //显示or隐藏 付款日期
            }
    ...
    <div style="padding-bottom: 5px;">
        ...
        <table class="liebiao">
            ...
            <tr name="tr_default">
                ...
                <td>
                    <input id="CurrencyName" name="CurrencyName" class="easyui-textbox" style="width: 200px;" disabled="disabled" />
                </td>
            </tr>
            <tr name="tr_auto">
                <td>付款公司
