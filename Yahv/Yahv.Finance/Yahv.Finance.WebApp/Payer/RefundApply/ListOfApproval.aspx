<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListOfApproval.aspx.cs" Inherits="Yahv.Finance.WebApp.Payer.RefundApply.ListOfApproval" %>
    ...
    <script>
        ...
        function btnFormatter(value, row) {
            return ['<span class="easyui-formatted">',
                , '<a class="easyui-linkbutton"  data-options="iconCls:\'icon-yg-edit\'" onclick="edit(\'' + row.ID + '\');return false;">审批</a> '
                , '</span>'].join('');
        }
        ...
        function edit(id) {
            $.myDialog({
                title: '审批',
                url: '/Finance/Payer/RefundApply/Approval.aspx?id=' + id,
                width: "60%",
                height: "80%",
                isHaveOk: true,
                isHaveCancel: true,
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    <div id="topper">
        ...
        <table class="liebiao-compact">
            <tr>
                ...
                <td style="width: 90px;">付款账户</td>
                <td>
                    <input id="s_name" data-options="prompt:'请输入付款账户'" style="width: 200px;" class="easyui-textbox" />
                </td>
            </tr>
            <tr>
                <td colspan="4">
    ...
    <table id="tab1" title="预收退款申请">
        <thead>
            <tr>
                <th data-options="field:'ID',align:'center',width:fixWidth(10)">申请编号</th>
                <th data-options="field:'TypeName',align:'center',width:fixWidth(8)">类型</th>
                <th data-options="field:'PayerAccountName',align:'center',width:fixWidth(18)">付款账户</th>
                <th data-options="field:'PayeeAccountName',align:'center',width:fixWidth(18)">收款人</th>
                <th data-options="field:'CurrencyName',align:'left',width:fixWidth(4)">币种</th>
