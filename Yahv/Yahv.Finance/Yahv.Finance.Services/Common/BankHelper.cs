...
namespace Yahv.Finance.Services
{
    ...
    public class BankHelper
    {
        ...
        public static string GetBankNameAndType(char[] charBin, int offset = 0)
        {
            long longBin = 0;
        ...
        public static string GetBankName(string bankCode)
        {
            ...
            {
                long longBin = 0;
                var charBin = bankCode.ToCharArray();
                int offset = 0;
                ...
                var array = BankName[index].Split(new[] { "." }, StringSplitOptions.RemoveEmptyEntries);
                return array[0];
            }
            catch (Exception)
            {
