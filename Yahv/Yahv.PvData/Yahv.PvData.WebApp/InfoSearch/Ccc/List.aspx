<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.PvData.WebApp.InfoSearch.Ccc.List" %>
    ...
    <table id="dg">
        <thead>
            <tr>
                ...
                <th data-options="field:'Ccc',align:'center',width:100">Ccc</th>
            </tr>
        </thead>
    </table>
</asp:Content>
