<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.PvData.WebApp.SysConfig.ExchangeRateManage.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        ...
        function edit(type, district, from ,to, index) {
            $.myDialog({
                title: '汇率编辑',
                url: '/PvData/SysConfig/ExchangeRateManage/Edit.aspx?type=' + type + '&district=' + district + '&from=' + from + '&to=' + to + '&opt=edit',
                width: '80%',
                height: '80%',
                onClose: function () {
        ...
        $(function () {
            ...
            $('#btnCreate').click(function () {
                $.myDialog({
                    title: '新增汇率',
                    url: '/PvData/SysConfig/ExchangeRateManage/Edit.aspx?opt=create',
                    width: '80%',
                    height: '80%',
                    onClose: function () {
                        window.grid.myDatagrid('flush');
