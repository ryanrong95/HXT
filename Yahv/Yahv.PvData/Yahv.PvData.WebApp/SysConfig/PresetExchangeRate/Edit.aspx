<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.PvData.WebApp.SysConfig.PresetExchangeRate.Edit" %>
    ...
    <script>
        $(function () {
            ...
            if (model.ExchangeRate) {
                ...
                $('#startDate').textbox('setValue', model.ExchangeRate.StartDate);
            }
        });
    </script>
</asp:Content>
    ...
    <div class="easyui-panel" data-options="border:false">
        <table class="liebiao">
            <tr>
                ...
                <td>
                    <input id="type" name="type" value="预设汇率" class="easyui-textbox" disabled/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="liebiao-label"> 开始时间:</td>
                <td>
                    <input id="startDate" name="startDate" class="easyui-datebox" data-options="prompt:'开始时间', editable:false" required/>
                </td>
            </tr>          
        </table>
