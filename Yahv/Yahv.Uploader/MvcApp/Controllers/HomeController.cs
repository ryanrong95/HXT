...
namespace MvcApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        /// 文件上传
        /// </summary>
        /// <param name="key">Config.json中的ID或Name</param>
        /// <example>http://uuws.b1b.com/upload/user/</example>
        /// <returns>JSingle 或 JMessage </returns>
        [HttpPost]
        //[Route("upload/{key}/")]        
    virtual    public ActionResult Index(string key)
        {
            //安全校验，以后提供
