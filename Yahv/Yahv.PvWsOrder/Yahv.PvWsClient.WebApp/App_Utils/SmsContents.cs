...
namespace Yahv.PvWsClient.WebApp.App_Utils
{
    ...
    public class SmsContents
    {
        ...
        /// 变更初始化密码
        /// </summary>
        public const string ChangePassword = "您好，您正在申请变更您的登录密码，请确保该操作是您本人进行，您的校验码是{0},该校验码3分钟内有效，非本人操作，请忽略本条消息。【华芯通】";
    }
    ...
    public class SmsService
    {
        ...
        public static void Send(string mobile, string message)
        {
            try
            {
                WebApp.SmsService.Service1 sms = new WebApp.SmsService.Service1();
