(function ($) {
    ...
    _proto.initImg = function () {
        ...
        img.setSrc = function () {
            ...
            if (!src || src === '') img.src = 'Content/images/verify/' + (parseInt(Math.random() * 11) + 1) + '.jpg';
            return;
            ...
            if (isIE) {
                ...
                if (version > 9) {
                    ...
                    //ie9时使用本地随机图片
                    img.src = '/Content/images/verify/' + (parseInt(Math.random() * 11) + 1) + '.jpg';
                }
            } else {
                img.src = src;
            }
    ...
    _proto.bindEvents = function () {
        ...
        var handleDragEnd = function (e) {
            ...
            that.trail = trail;
            var rslt = that.verify();
            if (rslt.spliced && rslt.verified) {
