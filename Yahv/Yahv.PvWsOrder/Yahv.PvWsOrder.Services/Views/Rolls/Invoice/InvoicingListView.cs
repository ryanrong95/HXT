...
namespace Yahv.PvWsOrder.Services.Views
{
    ...
    /// 开票中列表视图
    /// </summary>
    public class InvoicingListView : QueryView<InvoicingListViewModel, PvWsOrderReponsitory>
    {
        public InvoicingListView()
        {
        }

        protected InvoicingListView(PvWsOrderReponsitory reponsitory, IQueryable<InvoicingListViewModel> iQueryable) : base(reponsitory, iQueryable)
        {
        }

        protected override IQueryable<InvoicingListViewModel> GetIQueryable()
        {
            ...
            var iQuery = from invoiceNotice in invoiceNotices
                         ...
                         select new InvoicingListViewModel
                         {
        ...
        /// </summary>
        /// <returns></returns>
        public Tuple<T[], int> ToMyPage<T>(Func<InvoicingListViewModel, T> convert, int? pageIndex = null, int? pageSize = null) where T : class
        {
            IQueryable<InvoicingListViewModel> iquery = this.IQueryable.Cast<InvoicingListViewModel>().OrderByDescending(t => t.InvoiceNoticeCreateDate);
            ...
            var linq_invoiceNoticeItems = from invoiceNoticeItem in invoiceNoticeItems
                                          ...
                                          select new
                                          {
                                              ...
                                              Difference = invoiceNoticeItem.Difference ?? 0,
                                          };
        ...
        /// <returns></returns>
        public InvoicingListView SearchByInvoiceNoticeStatus(InvoiceEnum invoiceNoticeStatus)
        {
            var linq = from query in this.IQueryable
                       where query.InvoiceNoticeStatus == invoiceNoticeStatus
                       select query;

            var view = new InvoicingListView(this.Reponsitory, linq);
            return view;
        }
        ...
        /// <returns></returns>
        public InvoicingListView SearchByEnterCode(string enterCode)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicingListView SearchByCompanyName(string companyName)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicingListView SearchByInvoiceType(InvoiceType invoiceType)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicingListView SearchByAdminID(string adminID)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicingListView SearchByInvoiceNoticeCreateDateBegin(DateTime begin)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicingListView SearchByInvoiceNoticeCreateDateEnd(DateTime end)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicingListView SearchByInvoiceNoticeIDs(string[] invoiceNoticeIDs)
        {
            var linq = from query in this.IQueryable
        ...
        /// <summary>
        /// 根据 InvoiceNoticeID 查询
        /// </summary>
        /// <param name="invoiceNoticeID"></param>
        /// <returns></returns>
        public InvoicingListView SearchByInvoiceNoticeID(string invoiceNoticeID)
        {
            var linq = from query in this.IQueryable
    ...
    public class InvoicingListViewModel
    {
        /// <summary>
        /// 开票编号
        /// </summary>
