...
namespace Yahv.PvWsOrder.Services.Views
{
    ...
    /// 已开票列表视图
    /// </summary>
    public class InvoicedListView : QueryView<InvoicedListViewModel, PvWsOrderReponsitory>
    {
        public InvoicedListView()
        {
        }

        protected InvoicedListView(PvWsOrderReponsitory reponsitory, IQueryable<InvoicedListViewModel> iQueryable) : base(reponsitory, iQueryable)
        {
        }
        ...
        protected override IQueryable<InvoicedListViewModel> GetIQueryable()
        {
            ...
            var iQuery = from invoiceNotice in invoiceNotices
                         ...
                         select new InvoicedListViewModel
                         {
                             ...
                             InvoiceCreSta = invoiceNotice.InvoiceCreSta,
                             InCreNo = invoiceNotice.InCreNo,
                             InCreWord = invoiceNotice.InCreWord,
                             RequestID = invoiceNotice.RequestID
                         };
        ...
        /// </summary>
        /// <returns></returns>
        public Tuple<T[], int> ToMyPage<T>(Func<InvoicedListViewModel, T> convert, int? pageIndex = null, int? pageSize = null) where T : class
        {
            IQueryable<InvoicedListViewModel> iquery = this.IQueryable.Cast<InvoicedListViewModel>().OrderByDescending(t => t.InvoiceNoticeCreateDate);
        ...
        /// <returns></returns>
        public InvoicedListView SearchByInvoiceNoticeStatus(InvoiceEnum invoiceNoticeStatus)
        {
        ...
        /// <returns></returns>
        public InvoicedListView SearchByEnterCode(string enterCode)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicedListView SearchByInvoiceType(InvoiceType invoiceType)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicedListView SearchByAdminID(string adminID)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicedListView SearchByInvoiceNoticeCreateDateBegin(DateTime begin)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicedListView SearchByInvoiceNoticeCreateDateEnd(DateTime end)
        {
            var linq = from query in this.IQueryable
        ...
        /// <returns></returns>
        public InvoicedListView SearchByInvoiceNoticeID(string invoiceNoticeID)
        {
            var linq = from query in this.IQueryable
