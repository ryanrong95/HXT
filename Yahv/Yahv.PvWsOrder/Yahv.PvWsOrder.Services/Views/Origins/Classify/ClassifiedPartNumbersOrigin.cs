...
namespace Yahv.PvWsOrder.Services.Views
{
    ...
    /// 海关税则归类信息视图
    /// </summary>
    internal class ClassifiedPartNumbersOrigin : UniqueView<Models.ClassifiedPartNumber, PvWsOrderReponsitory>
    {
        internal ClassifiedPartNumbersOrigin()
        {
        }

        internal ClassifiedPartNumbersOrigin(PvWsOrderReponsitory reponsitory) : base(reponsitory)
        {
        }

        protected override IQueryable<Models.ClassifiedPartNumber> GetIQueryable()
        {
            return from entity in this.Reponsitory.ReadTable<Layers.Data.Sqls.PvWsOrder.ClassifiedPartNumbersTopView>()
