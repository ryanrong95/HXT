...
namespace Yahv.PvWsOrder.Services.Views
{
    ...
    public class TempTrackerWsClients<TReponsitory> : UniqueView<WsClient, TReponsitory>
          where TReponsitory : class, Layers.Linq.IReponsitory, IDisposable, new()
    {
        ...
        public TempTrackerWsClients(IErpAdmin admin, string companyid = "DBAEAB43B47EB4299DD1D62F764E6B6A")
        {
            this.Admin = admin;
            this.companyid = companyid;
        }
        public TempTrackerWsClients(TReponsitory reponsitory, IErpAdmin admin, string companyid = "DBAEAB43B47EB4299DD1D62F764E6B6A") : base(reponsitory)
        {
            this.Admin = admin;
            this.companyid = companyid;
        }
        ...
        {
            var wsclientids = this.Reponsitory.ReadTable<Layers.Data.Sqls.PvWms.WsClientsTopView>().Select(item => item.ID).ToArray();
