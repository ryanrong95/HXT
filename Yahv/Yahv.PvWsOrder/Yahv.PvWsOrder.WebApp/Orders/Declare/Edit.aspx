<%@ Page Language="C#" MasterPageFile="~/Uc/Works_hidden.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.PvWsOrder.WebApp.Orders.Declare.Edit" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                data.append('beneficiary', $("#beneficiary").combobox("getValues"));
                /************************产品信息*************************/
                var rows = $('#dg').datagrid('getRows');
                var products = [];
        ...
        <div data-options="region:'center'" style="border: none">
            ...
            <table class="liebiao">
                ...
                <tr class="pickUp">
                    ...
                    <td>
                        <input id="pickUpAddress" class="easyui-combogrid" style="width: 220px; height: 22px"
