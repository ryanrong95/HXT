<%@ Page Language="C#" MasterPageFile="~/Uc/Works_hidden.Master" AutoEventWireup="true" CodeBehind="AddAgency2Declare.aspx.cs" Inherits="Yahv.PvWsOrder.WebApp.Orders.AddAgency2Declare" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        var OutClientID = getQueryString("OutClientID");
        var OutEnterCode = getQueryString("OutEnterCode");
        var firstLoad = true;
        var orderType = <%= (int)Yahv.Underly.OrderType.Recieved%>;
        ...
        $(function () {
            ...
            window.grid = $('#dg').myDatagrid({
                ...
                columns: [[
                    ...
                    { field: 'TotalQty', title: '库存数量', width: 80, align: 'center' },
                    {
                        field: 'Qty', title: '发货数量', width: 80, align: 'center',
            ...
            $("#sourceDistrict").combobox('setValue', "HKG")//默认中国香港
            ...
            $("#btnSubmit").click(function () {
                ...
                data.append('OutClientID', OutClientID);
                data.append('OutEnterCode', OutEnterCode);
    ...
    <script>
        ...
        function ValidationOrder() {
            ...
            for (var i = 0; i < rows.length - 1; i++) {
                ...
                //验证出库数量是否正确
                if (Number(row.Qty) == 0) {
                    $.messager.alert('提示', '第' + (i + 1) + '行的订单项发货数量不能为0');
                    return false
                }
                if (Number(row.TotalQty) < Number(row.Qty)) {
                    $.messager.alert('提示', '第' + (i + 1) + '行的订单项发货数量不能大于库存数量');
                    return false
                }
            }
