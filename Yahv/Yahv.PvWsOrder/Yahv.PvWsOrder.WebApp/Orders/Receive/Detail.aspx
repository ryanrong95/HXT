<%@ Page Language="C#" MasterPageFile="~/Uc/Works_hidden.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="Yahv.PvOms.WebApp.Orders.Receive.Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        ...
        $(function () {
            ...
            addTab("运单信息", "../Common/InWayBill.aspx?ID=" + id, "WayBill", false);
