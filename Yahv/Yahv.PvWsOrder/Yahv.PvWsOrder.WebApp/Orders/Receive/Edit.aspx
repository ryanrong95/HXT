<%@ Page Language="C#" MasterPageFile="~/Uc/Works_hidden.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.PvWsOrder.WebApp.Orders.Receive.Edit" %>
    ...
    <script>
        function Init()
        {
            if(orderData!=null)
            {
                ...
                $("#currency").combobox("setValue", orderData.Currency);
                $("#SettlementCurrency").combobox("setValue", orderData.SettlementCurrency);
                $("#Supplier").combobox("setValue", orderData.Supplier); 
                $("#Beneficiary").combogrid('setValue', orderData.Beneficiary);
                ...
                if(orderData.WaybillType == '<%=Yahv.Underly.WaybillType.PickUp.GetHashCode()%>')
                {
                    ...
                    $("#Carrier").combobox("setValue",orderData.Carrier);
                }
                ...
                if(orderData.IsUnBoxed){
                    $('#isUnBox').checkbox({
                        checked:orderData.IsUnBoxed,
                    });
                }
                if(orderData.IsDetection){
                    $('#isDetection').checkbox({
                        checked:orderData.IsDetection,
                    });
                }
            }
        }
