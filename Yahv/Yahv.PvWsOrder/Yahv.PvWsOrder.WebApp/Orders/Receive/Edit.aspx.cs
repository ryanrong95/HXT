...
namespace Yahv.PvWsOrder.WebApp.Orders.Receive
{
    public partial class Edit : ErpParticlePage
    {
        ...
        private void LoadData()
        {
            ...
            this.Model.orderData = new
            {
                ...
                Currency = query.Orderitems.FirstOrDefault().Currency,
                ...
                IsPayForGoods = query.OrderInput.IsPayCharge,
                Beneficiary = query.OrderInput.BeneficiaryID,
                ...
                Carrier = query.OrderInput.Waybill.CarrierID,
        ...
        protected void SubmitOrder()
        {
            try
            {
                ...
                //收货人
                var enterCode = order.OrderInput.Waybill.EnterCode;
                var Company = Erp.Current.WsOrder.Companys
