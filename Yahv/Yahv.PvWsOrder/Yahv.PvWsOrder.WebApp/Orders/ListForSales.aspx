<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListForSales.aspx.cs" Inherits="Yahv.PvWsOrder.WebApp.Orders.ListForSales" %>
    ...
    <script>
        ...
        function Details(id, orderType) {
            ...
            $.myWindow({
                ...
                minWidth: 1200,
                minHeight: 600,
                url: location.pathname.replace('ListForSales.aspx', loca),
                onClose: function () {
