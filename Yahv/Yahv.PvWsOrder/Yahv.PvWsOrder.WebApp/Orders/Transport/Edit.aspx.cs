    ...
    public partial class Edit : ErpParticlePage
    {
        ...
        private void LoadData()
        {
            ...
            this.Model.orderData = new
            {
                ...
                ceePickUpTime = query.OrderOutput.Waybill.WayLoading?.TakingDate?.ToString("yyyy-MM-dd HH:mm:ss"),
                //其它信息
        ...
        {
            string ID = Request.QueryString["ID"];
            var query = new OrderFilesRoll(ID).AsEnumerable();
        ...
        protected void SubmitOrder()
        {
            try
            {
                ...
                //string s_paymentType = Request.Form["s_paymentType"];
                ...
                {
                    var WayCharge = order.OrderOutput.Waybill.WayCharge ?? new Yahv.Services.Models.WayCharge();
                    if (WayCharge.PayMethod == null)
                    {
                        WayCharge.PayMethod = Methord.TT;
                    }
                ...
                #region 运单条件
                var outWayCondition = new Yahv.Services.Models.WayCondition();
                ...
                #region 订单文件数据
                var fileList = new List<Yahv.Services.Models.CenterFileDescription>();
