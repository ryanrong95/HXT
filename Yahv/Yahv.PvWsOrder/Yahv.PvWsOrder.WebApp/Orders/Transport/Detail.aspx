<%@ Page Language="C#" MasterPageFile="~/Uc/Works_hidden.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="Yahv.PvOms.WebApp.Orders.Transport.Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        ...
        $(function () {
            ...
            addTab("基本信息", "../Common/Product.aspx?ID=" + id, "Product", false);
            addTab("收货运单", "../Common/InWayBill.aspx?ID=" + id, "InWayBill", false);
            addTab("发货运单", "../Common/OutWayBill.aspx?ID=" + id, "OutWayBill", false);
            ...
            $('#InWayBill').parent().css("overflow", "hidden");
            $('#OutWayBill').parent().css("overflow", "hidden");
