<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.PvWsOrder.WebApp.Orders.Transport.List" %>
    ...
    <script>
        ...
        function Edit(index) {
            ...
            $.myWindow({
                ...
                minWidth: 1200,
                minHeight: 600,
                url: location.pathname.replace('List.aspx', 'Edit.aspx?ID=' + data.ID + '&ClientID=' + data.ClientID + '&EnterCode=' + data.EnterCode),
                onClose: function () {
                    window.grid.myDatagrid('flush');
                },
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    ...
    <table id="tab1" title="即收即发订单" style="width: 100%">
        <thead>
            <tr>
                ...
                <th data-options="field:'RecType',align:'center'" style="width: 80px;">交货方式</th>
                <th data-options="field:'LoadingExcuteStatus',align:'center'" style="width: 80px">提货状态</th>
                <th data-options="field:'SendType',align:'center'" style="width: 80px;">发货方式</th>
                <th data-options="field:'IsPayCharge',align:'center'" style="width: 80px">代付货款</th>
