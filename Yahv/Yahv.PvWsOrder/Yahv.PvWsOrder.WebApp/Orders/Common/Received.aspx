<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Received.aspx.cs" Inherits="Yahv.PvOms.WebApp.Orders.Common.Received" %>
        ...
        <table id="tab1">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'Price',align:'center'" style="width: 100px">还款金额</th>
                    <th data-options="field:'PaidPrice',align:'center'" style="width: 100px;">信用还款金额</th>
