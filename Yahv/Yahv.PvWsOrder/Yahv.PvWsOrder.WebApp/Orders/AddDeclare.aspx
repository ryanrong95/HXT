<%@ Page Language="C#" MasterPageFile="~/Uc/Works_hidden.Master" AutoEventWireup="true" CodeBehind="AddDeclare.aspx.cs" Inherits="Yahv.PvWsOrder.WebApp.Orders.AddDeclare" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnImportStorage").click(function () {
                ...
                $.myWindow({
                    title: "我的暂存库存",
                    url: location.pathname.replace('Orders/AddDeclare.aspx', 'Stocks/Temporary/MyList.aspx?EnterCode=' + EnterCode),
                });
                return false;
            });
            //上传合同发票
