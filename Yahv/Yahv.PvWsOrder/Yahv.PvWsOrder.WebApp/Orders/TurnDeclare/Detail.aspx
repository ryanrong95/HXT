<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="Yahv.PvOms.WebApp.Orders.TurnDeclare.Detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        ...
        $(function () {
            ...
            addTab("基本信息", "Product.aspx?ID=" + id, "Product", false);
