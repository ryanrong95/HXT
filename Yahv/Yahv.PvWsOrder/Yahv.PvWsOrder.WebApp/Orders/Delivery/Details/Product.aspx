<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Yahv.PvOms.WebApp.Orders.Delivery.Product" %>
        ...
        $(function () {
            if (model.Info != null) {
                ...
                if (model.Info.IsReciveCharge) {
                    ...
                    $('#IsReciveCharge').checkbox({ disabled: true, });
                }
            }
            //页面初始化
    ...
    <table id="tab1">
        <thead>
            <tr>
                ...
                <%--<th data-options="field:'Unit',align:'center'" style="width: 60px">单位</th>--%>
                ...
                <%--<th data-options="field:'GrossWeight',align:'center'" style="width: 60px">毛重(kg)</th>--%>
                <%--<th data-options="field:'Volume',align:'center'" style="width: 60px">体积(m³)</th>--%>
