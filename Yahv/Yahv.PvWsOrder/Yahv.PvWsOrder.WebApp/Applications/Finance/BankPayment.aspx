<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="BankPayment.aspx.cs" Inherits="Yahv.PvOms.WebApp.Applications.Finance.BankPayment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        function Init() {
            $("#PayeeName").html(model.ApplicationData.PayeeName);
            $("#PayeeBankName").html(model.ApplicationData.PayeeBankName);
            $("#PayeeBankAccount").html(model.ApplicationData.PayeeBankAccount);
            $("#PayeeCurrency").html(model.ApplicationData.PayeeCurrency);

            $("#OutCompanyName").html(model.ApplicationData.OutCompanyName);
            $("#OutBankName").html(model.ApplicationData.OutBankName);
            $("#OutBankAccount").html(model.ApplicationData.OutBankAccount);
    ...
    <div class="easyui-layout" style="width: 100%; height: 100%; border: none">
        <div data-options="region:'center'" style="border: none">
            <table class="liebiao">
                ...
                <tr>
                    <td class="lbl">我方付款人：</td>
                    <td>
                        <label id="OutCompanyName"></label>
                    </td>
                    <td class="lbl">客户收款人</td>
                    <td>
                ...
                <tr style="background-color: #f3f3f3">
                    <td class="lbl" colspan="4">付款信息：</td>
                </tr>
                <tr>
            ...
            <table id="tab1" title="银行付款记录">
                <thead>
                    <tr>
                        ...
                        <th data-options="field:'CreateDate',width:100">付款时间</th>
                    </tr>
                </thead>
            </table>
        </div>
