<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="WriteOffReceive.aspx.cs" Inherits="Yahv.PvOms.WebApp.Applications.Finance.WriteOffReceive" %>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnWriteOff").click(function () {
                ...
                var price1 = $("#ReceiveAvailable").textbox("getValue");
                ...
                data.append('PayeeLeftID', res.PayeeLeftID);
    ...
    <script>
        function Init() {
            if (model.ApplicationData != null) {
                $("#PayerName").textbox("setValue", model.ApplicationData.ClientName);
                $("#PayeeName").textbox("setValue", model.PayeeData.Payee);
            }
        }
    </script>
    <style>
        ...
        <div data-options="region:'center'" style="border: none">
            <table class="liebiao">
                ...
                <tr>
                    ...
                    <td>
                        <input id="Receive" class="easyui-combogrid" data-options="editable:false" style="width: 250px; height: 23px" />
                    </td>
                </tr>
                <tr>
