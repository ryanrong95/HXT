<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ApproveReject.aspx.cs" Inherits="Yahv.PvOms.WebApp.Applications.Payments.ApproveReject" %>
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if (res.success) {
                            ...
                            var win = $.myWindow.getMyWindow("Approve");
                            win.closeFlag = true;
                            $.myWindow.close();
                        }
                        else {
