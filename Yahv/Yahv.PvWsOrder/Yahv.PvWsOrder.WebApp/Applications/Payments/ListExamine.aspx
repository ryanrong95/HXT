<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListExamine.aspx.cs" Inherits="Yahv.PvOms.WebApp.Applications.Payments.ListExamine" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        function Payment(index) {
            ...
            $.myWindow({
                title: "付款核销",
                url: '../Finance/WriteOffPayment.aspx?ID=' + data.ID,
                width: 1200,
                height: 600,
                onClose: function () {
                    window.grid.myDatagrid('flush');
        ...
        function Operation(val, row, index) {
            ...
            if (row.ApplicationStatus == Examining) {
                ...
                {
                    buttons.push('<a class="easyui-linkbutton"  data-options="iconCls:\'icon-yg-quote\'" onclick="Payment(' + index + ');return false;">付款核销</a> ');
                }
            }
            buttons.push('</span>')
            return buttons.join('');
    ...
    <table id="tab1" title="代付货款申请">
        <thead>
            <tr>
                ...
                <th data-options="field:'Btn',align:'left',formatter:Operation" style="width: 250px;">操作</th>
            </tr>
        </thead>
    </table>
</asp:Content>
