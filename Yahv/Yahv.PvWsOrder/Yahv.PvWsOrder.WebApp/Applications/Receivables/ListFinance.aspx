<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="ListFinance.aspx.cs" Inherits="Yahv.PvOms.WebApp.Applications.Receivables.ListFinance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        function Operation(val, row, index) {
            ...
            if (row.ApplicationStatus == Examined && row.ReceiveStatus == UnReceive && row.IsEntry == true) {
