...
namespace Yahv.PvWsOrder.WebApp.Invoice
{
    public partial class Details : ErpParticlePage
    {
        ...
        protected void LoadData()
        {
            ...
            var invoice = new Services.Views.Origins.InvoiceNoticesOrigin().SingleOrDefault(t => t.ID == ID);
        ...
        {
            string ID = Request.QueryString["ID"];
            var query = new Services.Views.Origins.InvoiceNoticeItemsOrigin().Where(t => t.InvoiceNoticeID == ID);
