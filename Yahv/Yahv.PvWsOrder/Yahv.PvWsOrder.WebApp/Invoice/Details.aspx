<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Yahv.PvWsOrder.WebApp.Invoice.Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    ...
    <table id="tab1" title="开票明细">
        <thead>
            <tr>
                <th data-options="field:'ProductName',width: 130,align:'center'">产品名称</th>
                ...
                <th data-options="field:'TaxName',width: 130,align:'center'">税务名称</th>
