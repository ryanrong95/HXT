<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="InvoicingList.aspx.cs" Inherits="Yahv.PvWsOrder.WebApp.Invoice.InvoicingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        ...
        //开票
        function Invoice(id) {
            var url = location.pathname.replace(/InvoicingList.aspx/ig, 'Confirm.aspx?InvoiceNoticeID=' + id);
            window.location = url;
        }

        function Operation(val, row, index) {
            return ['<span class="easyui-formatted">',
                , '<a class="easyui-linkbutton"  data-options="iconCls:\'icon-yg-confirm\'" onclick="Invoice(\'' + row.InvoiceNoticeID + '\');return false;">开票</a> '
                , '</span>'].join('');
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    ...
    <table id="tab1" title="开票中">
        <thead>
            <tr>
                <th data-options="field:'CheckBox',align:'center',checkbox:true" style="width: 20px">全选</th>
                <th data-options="field:'InvoiceNoticeID',align:'center'" style="width: 12%;">开票编号</th>
                <th data-options="field:'EnterCode',align:'center'" style="width: 8%;">客户编号</th>
                ...
                <th data-options="field:'InvoiceNoticeStatusDes',align:'center'" style="width: 8%;">开票状态</th>
                <th data-options="field:'AdminName',align:'center'" style="width: 8%;">申请人</th>
                <th data-options="field:'InvoiceNoticeCreateDateDes',align:'center'" style="width: 10%;">申请日期</th>
