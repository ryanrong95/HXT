<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.PvWsOrder.WebApp.Invoice.List" %>
    ...
    <div id="topper">
        <table class="liebiao">
            <tr>
                ...
                <td class="lbl">
                    <input class="easyui-textbox" id="ClientCode" data-options="width:150,validType:'length[1,50]'" />
                </td>
