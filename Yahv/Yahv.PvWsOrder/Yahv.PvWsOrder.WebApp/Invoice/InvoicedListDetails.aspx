<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="InvoicedListDetails.aspx.cs" Inherits="Yahv.PvWsOrder.WebApp.Invoice.InvoicedListDetails" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#InvoiceFileTable').myDatagrid({
                queryParams: { InvoiceNoticeID: getQueryString("InvoiceNoticeID"), },
        ...
        function Print() {
            ...
            var url = location.pathname.replace(/InvoicedListDetails.aspx/ig, 'PrintInvoiceConfirm.aspx?ID=' + InvoiceNoticeID);
            top.$.myWindow({
                iconCls: "",
                url: url,
                noheader: false,
        ...
        //返回
        function Back() {
            var url = location.pathname.replace(/InvoicedListDetails.aspx/ig, 'InvoicedList.aspx');
            window.location = url;
        }
                        ...
                        <div id="fileContainer" class="easyui-panel" title="发票附件">
                            <div class="sub-container">
                                <div style="margin-bottom: 5px">
                                    <span>
                                        <img src="../Content/Themes/Images/blue-fujian.png" /></span>
