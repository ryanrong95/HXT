<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Postest.aspx.cs" Inherits="WebApp.Tests.Postest" %>
            ...
            <form id="ff" method="post" runat="server">
                <table cellpadding="5">
                    <tr>
                        <td>Name:</td>
                        <td>
                            <input class="easyui-textbox" type="text" name="name" data-options="required:true" value="2222"></input></td>
                    </tr>
                    <tr>
                        <td>Email:</td>
                        <td>
                            <input class="easyui-textbox" type="text" name="email" data-options="required:true,validType:'email'"
                                value="123@123.com"></input></td>
                    </tr>
                    <tr>
                        <td>Subject:</td>
                        <td>
                            <input class="easyui-textbox" type="text" name="subject" data-options="required:true" value="1212"></input></td>
                    </tr>
                    <tr>
                        <td>Message:</td>
                        <td>
                ...
                <div style="text-align: center; padding: 5px">
                    <asp:Button ID="btnSubmit" runat="server" Text="111" OnClick="btnSubmit_Click" OnClientClick="alert('ok:click!');" Style="display: none;" />
