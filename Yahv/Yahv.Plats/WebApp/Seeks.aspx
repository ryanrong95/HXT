...
<head runat="server">
    ...
    <script src="<%=$"{Yahv.Underly.DomainConfig.Fixed}"%>/frontframe/customs-easyui/Scripts/fullscreen.js"></script>
    ...
    <script src="<%=$"{Yahv.Underly.DomainConfig.Fixed}"%>/frontframe/jquery.cookie-1.4.1.min.js"></script>
</head>
<body>
    <%
        var arry = @"
