...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHead" runat="server">
    <link href="<%=$"{Yahv.Underly.DomainConfig.Fixed}"%>/frontframe/customs-easyui/Styles/login.css" rel="stylesheet" />
    <script src="<%=$"{Yahv.Underly.DomainConfig.Fixed}"%>/frontframe/jquery.cookie.js"></script>
    <script>
        $(function () {
            ...
            <div id="login-form" class="easyui-form" method="post" data-options="novalidate:true">
                <div style="margin-bottom: 22px">
                    <input class="easyui-textbox" name="UserName"
                        data-options="iconCls:'icon-jl-user',iconAlign:'left',iconWidth:'28',prompt:'用户名',required:true"
