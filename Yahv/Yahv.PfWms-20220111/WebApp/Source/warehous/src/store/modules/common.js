...
const homeindex ={
    state:{
        ...
        showdetailHK:false, //已装箱右侧抽屉弹出
        showdetailBOX:false, //香港库房装箱右侧抽屉弹出
        ...
        TransportDetailHK:false,//报关运输详情重构
    ...
    mutations:{
        ...
        changeshowHK(state,payload){
            state.showdetailHK=payload;
        },
        changeshowBOX(state,payload){
            state.showdetailBOX=payload;
        },
        ...
        changeTransportDetailHK(state,payload){
            state.TransportDetailHK=payload;
         },
    ...
    actions:{
        ...
        setshowdetailHK(context,payload){
            context.commit("changeshowHK",payload)
        },
        setshowdetailBOX(context,payload){
            context.commit("changeshowBOX",payload)
        },
        ...
        setTransportDetailHK(context,payload){
            context.commit("changeTransportDetailHK",payload)
        },
