      ...
      newrouters:[
        {
          ...
          children:[
            ...
            {
                path: "/VoyageList", //报关运输列表
                component: "VoyageList",
                name:"VoyageList",
                prentname:"HKWarehouse" ,
                children:[
                      {
                        path: "/VoyageList/VoyageInfo/:voyageNo", //报关运输详情
                        name: "VoyageInfo",
                        component: "VoyageInfo",
                        prentname:"HKWarehouse"
                      },
                ],                     
            },  
            {
                path: "/SealedList", //已装箱列表
                component: "SealedList",
                name:"SealedList",
                prentname:"HKWarehouse" ,
                children:[
                      {
                        path: "/SealedList/SealedInfo/:entryNoticeID/:orderID/:mainOrderID", //已装箱详情
                        name: "SealedInfo",
                        component: "SealedInfo",
                        prentname:"HKWarehouse"
                      },
                ],                     
            },              
            {
                path: "/UnSortingList", //未装箱列表
                component: "UnSortingList",
                name:"UnSortingList",
                prentname:"HKWarehouse" ,
                children:[
                      {
                        path: "/UnSortingList/HKDeclare/:entryNoticeID/:orderID/:mainOrderID", //装箱
                        name: "HKDeclare",
                        component: "HKDeclare",
                        prentname:"HKWarehouse"
                      },
