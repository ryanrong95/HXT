...
export default {
  props: ["lableName","Currencyarr", "Subjectarr",'Payeearr','Payerarr','OrderID','WaybillID','Records','conduct','Files','delbookeep','EnterType','TinyOrderID'],
  data() {
    return {
      Labeltotal:'',
  ...
  methods: {
    ...
    InsertHKWarehouseFee(fee){     
      ...
      var data = {      
         ...
         //WhesFeeType:2,
         Count:fee.Quantity==""?1:this.Quantity,//标签给叔
