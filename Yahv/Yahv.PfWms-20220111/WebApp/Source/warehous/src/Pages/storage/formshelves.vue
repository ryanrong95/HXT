<template>
    <div>
        ...
        <FormItem label="所属位置" prop="parents">
            <Cascader :data="formValidate.data" @on-change="setvalues" v-model="formValidate.parents"></Cascader>
        ...
        <FormItem label="是否可添加库位" prop="goods">
...
<script>
    export default {
        ...
        methods: {
            ...
            setvalues(value){
                this.formValidatename.parents=value;
            }
        }
    }
</script>