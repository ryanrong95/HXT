          ...
          <Col span="8">
            <ul class="detail_li detail1">
              ...
              <li class="itemli">
                ...
                <span>{{waybillinfo.TotalCount}}</span>
              </li>
              <li class="itemli">
...
<script>
import {Historydetails} from "../../api";
export default {
  name: "Historygoods",
  data() {
    return {
      ...
      columns1: [
        ...
        },
        {
          ...
          render: (h, params) => {
            var vm = this;
            return h("span", {},params.row.Input.DateCode);
          }
        },
        {
          title: "本次到货",
          ...
          render: (h, params) => {
            var vm = this;
            return h("span", {}, params.row.TruetoQuantity);
          }
        },
        {
          title: "原产地",
          ...
          render: (h, params) => {
            var vm = this;
            return h("span", {}, params.row.Input.OriginDescription);
          }
        },
        {
          title: "入库库位",
