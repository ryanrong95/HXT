<template>
  <div>
    <Row>
      ...
      <Col span="5" class="itemcol" style="float: right;display: none;">
        <ul class="Navbox">
          <li>
            <p class="Navigation">
              <Icon type="md-menu" />快速入口
            </p>
          </li>
          <li class="navitem">
            <div class="icons">
              <span class="iconfont icon-ico-qtdrkdd"></span>
            </div>
            <div>入库历史查询</div>
          </li>
          <li class="navitem">
          ...
          <li class="navitem">
            <div class="icons">
              <span class="iconfont icon-chuhuo"></span>
            </div>
            <div>在线检测货物查询</div>
          </li>
          <li class="navitem">
            <div class="icons">
              <span class="iconfont icon-peijianrukutongji"></span>
            </div>
            <div>入库工作量统计查询</div>
          </li>
          <li class="navitem">
            <div class="icons">
              <span class="iconfont icon-peijianchukutongji"></span>
            </div>
            <div>出库工作量统计查询</div>
          </li>
        </ul>
