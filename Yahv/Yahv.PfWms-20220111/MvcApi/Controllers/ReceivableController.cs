...
//                    }
//                    exp = PredicateExtends.And(exp, item => item.PayMethod.Equals(PayMethod));
//                }
//                if (BusinessType > 0)
//                {
...
//                    }
//                    exp = PredicateExtends.And(exp, item => item.BusinessType.Equals(BusinessType));
//                }
//                if (Catalog > 0)
//                {
...
//                    }
//                    exp = PredicateExtends.And(exp, item => item.Catalog.Equals(Catalog));
//                }
//                if (Subject > 0)
//                {
...
//                    }
//                    exp = PredicateExtends.And(exp, item => item.Subject.Equals(Subject));
//                }
//                if (IsSpecial)
//                {
//                    exp = PredicateExtends.And(exp, item => item.IsSpecial.Equals(IsSpecial));
//                }
//                if (AccountedType > 0)
//                {
...
//                    }
//                    exp = PredicateExtends.And(exp, item => item.AccountedType.Equals(AccountedType));
//                }
