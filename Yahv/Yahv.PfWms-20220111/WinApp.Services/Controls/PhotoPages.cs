...
using WinApp.Services.Controls.UControls;

namespace WinApp.Services.Controls
{
    public partial class PhotoPages : Form
    {
        private PhotoPages()
        {
            InitializeComponent();
        ...
        public void SetUploadParams(Services.PhotoMaps map)
        {
        ...
        static PhotoPages current;
        static public PhotoPages Current
        {
            get
            {
                if (current == null)
                {
                    current = new PhotoPages();
                }
