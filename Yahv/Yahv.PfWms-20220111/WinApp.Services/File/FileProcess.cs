...
namespace WinApp.Services
{
    public class FileProcess
    {
        ...
        {
            SimHelper.TransferStatus = "下载失败1";
        }
        ...
        {
            //文件下载完成??如何获得文件名字
            SimHelper.TransferStatus = "下载完成1";
        }
        ...
        public void Process(PictureUrl data)
        {
            ...
            try
            {
                fileName = this.DownFile(data.Url);
            }
            catch (Exception)
            {
                //显示下载失败
                ...
                {
                    this.DownFailed(this, new Yahv.Usually.ErrorEventArgs("下载失败2"));
                }
                return;
            }
