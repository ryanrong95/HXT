...
namespace WinApp.Printers
{
    ...
    public class FilePrinter : PrinterBase
    {
        ...
        string DownFile(string uri)
        {
            ...
            FileInfo fi = new FileInfo(Path.Combine(@"..\", di.Name + "\\Downloads", fileName + ".pdf"));
        ...
        public void Print(PrinterConfig config/*, object data = null*/)
        {
            ...
            new Thread(() =>
            {
                ...
                try
                {
                    ...
                    SimHelper.TransferStatus = "下载完成2：" + fileName;
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        this.DownFailed(this, new Yahv.Usually.ErrorEventArgs("下载失败3"));
                    }
                    return;
                }
        ...
        {
            SimHelper.TransferStatus = "下载失败4";
        }
    }
