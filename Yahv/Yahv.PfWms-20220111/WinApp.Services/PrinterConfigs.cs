...
namespace WinApp.Services
{
    ...
    public class PrinterConfigs : IEnumerable<PrinterConfig>
    {
        ...
        PrinterConfigs()
        {
            ...
            {
                Name = "产品标签",
                Url = "/Print/html/productlable.html",
                Width = 353,
                Height = 351,
                Summary = "",
                PrinterName = null
            ...
            {
                Name = "库位标签",
                Url = "/Print/html/Storehouse.html",
                Width = 353,
                Height = 351,
                Summary = "",
                PrinterName = null
            ...
            {
                Name = "EMS打印",
                Url = "/Print/html/emsprinter.html",
                Summary = "只适合EMS打印功能",
                PrinterName = null
            });
            this.Save(data);
        ...
        public const string EMS打印 = nameof(EMS打印);
        public const string 跨越速运打印 = nameof(跨越速运打印);
        public const string 顺丰打印 = nameof(顺丰打印);

        public const string 快递鸟跨越速递 = nameof(快递鸟跨越速递);
        public const string 快递鸟顺丰 = nameof(快递鸟顺丰);
        public const string 出库通知打印 = nameof(出库通知打印);
        public const string 送货单打印 = nameof(送货单打印);
        public const string 入库单打印 = nameof(入库单打印);
        public const string 国际快递针式 = nameof(国际快递针式);
