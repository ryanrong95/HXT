...
namespace Yahv.CrmPlus.Service.Views.Origins
{
    ...
    public class MyDraftClientsOrigin : Yahv.Linq.UniqueView<Models.Origins.Client, PvdCrmReponsitory>
    {

        internal MyDraftClientsOrigin()
        {
        ...
        internal MyDraftClientsOrigin(PvdCrmReponsitory reponsitory) : base(reponsitory)
        {
        }
