<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Srm.Suppliers.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        ...
        function detail(id, enterpriseid) {
            $.myWindow({
                title: '供应商管理',
                url: '../SupplierDetails/List.aspx?id=' + id + '&enterpriseid=' + enterpriseid,
                width: '80%',
                height: '80%',
                onClose: function () {
        ...
        <table id="dg" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th data-options="field:'SettlementDesc',width:'10%'">结算类型</th>
                    <th data-options="field:'District',width:'10%'">国别地区</th>
                    <th data-options="field:'IsAccount',width:'10%',formatter:acountformatter">是否有账期</th>
                    <th data-options="field:'IsSpecial',width:'10%',formatter:specialformatter">是否特色</th>
                    <th data-options="field:'IsClient',width:'10%',formatter:clientformatter">是否同为客户</th>
