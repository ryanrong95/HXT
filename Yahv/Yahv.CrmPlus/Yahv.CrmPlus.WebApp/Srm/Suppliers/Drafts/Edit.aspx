<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Srm.Suppliers.Drafts.Edit" %>
    ...
    <script>
        $(function () {
            ...
            $("#SupplierName").textbox('textbox').bind('blur', function (e) {
                var newname = $("#SupplierName").textbox('getValue');
                if (newname != model.Entity.Name && newname.length) {
                    $.post("?action=Exist", { Name: newname }, function (result) {
                        if (result.Exist) {
                            $("#SupplierName").textbox('setValue', model.Entity.Name);
