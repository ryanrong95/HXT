<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Srm.SupplierDetails.Contacts.List" %>
    ...
    <script>
        $(function () {
            ...
            $("#btnCreator").click(function () {
                $.myDialog({
                    title: "新增",
                    url: 'Add.aspx?&enterpriseid=' + model.ID, onClose: function () {
        ...
        function btnformatter(value, rowData) {
            ...
            if (rowData.Status == '<%=(int)DataStatus.Normal%>') {
                arry.push('<a id="btnUnable" href="#" particle="Name:\'停用联系人\',jField:\'btnUnable\'" class="easyui-linkbutton" data-options="iconCls:\'icon-yg-disabled\'" onclick="Closed(\'' + rowData.ID + '\')">停用</a> ');
            } else if (rowData.Status == '<%=(int)DataStatus.Closed%>') {
                arry.push('<a id="btnEnable" href="#" particle="Name:\'启用联系人\',jField:\'btnEnable\'" class="easyui-linkbutton" data-options="iconCls:\'icon-yg-enabled\'" onclick="Enable(\'' + rowData.ID + '\')">启用</a> ');
            }
        ...
        function Details(id) {
            $.myWindow({
                title: "详情",
                url: 'Detail.aspx?enterpriseid=' + model.ID + '&subid=' + id, onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "800px",
                height: "450px",
    ...
    <div id="tb">
        <div>
            <table class="liebiao-compact">
                <tr>
                    <td colspan="8"><a id="btnCreator" particle="Name:'新增联系人',jField:'btnCreator'" class="easyui-linkbutton" data-options="iconCls:'icon-yg-add'">添加</a></td>
                    ...
                    <td >手机号/电话</td>
                    <td>
                        <input id="txtmobile" data-options="prompt:'手机号/电话',validType:'length[1,75]',isKeydown:true" class="easyui-textbox" /></td>
