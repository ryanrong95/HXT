<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Srm.SupplierDetails.Settlements.Add" %>
    ...
    <div class="easyui-panel" id="tt" data-options="fit:true">
        <table class="liebiao">
            <tr>
                <td>我方公司:</td>
                <td>
                    <input id="cbbCompany" name="TakerID" style="width: 350px" />

                    <%--<input id="cbbCompany" name="TakerID" class="easyui-combobox" style="width: 350px;" />--%>
                </td>
            </tr>
            <tr>
                <td style="width: 120px;">结算方式：</td>
                <td>
                    <input id="cbbClearType" name="ClearType" style="width: 350px;" />
                </td>
            </tr>
