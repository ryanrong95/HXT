<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Srm.SupplierDetails.Settlements.Edit" %>
    ...
    <script>
        $(function () {
            ...
            if (!jQuery.isEmptyObject(model.Entity)) {
                document.getElementById("companyName").innerHTML = model.Entity.Taker.Name;
                $('#form1').form('load', {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    <div class="easyui-panel" id="tt" data-options="fit:true" style="padding: 0px;">
        <table class="liebiao">
            <tr>
                <td>我方公司:</td>
                <td>
