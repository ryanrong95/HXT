<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Specials.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Srm.ApprovalRecords.Specials" %>
        ...
        $(function () {
            var getQuery = function () {
                var params = {
                    ...
                    BrandName: $.trim($("#txtbrand").textbox('getValue')),
                };
                return params;
            };
            //设置表格
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
            ...
            <table class="liebiao-compact">
                <tr>
                    <td>
                     ...
                     <td>
                        <input id="txtbrand" class="easyui-textbox" data-options="prompt:'品牌'"/></td>
                    <td>申请时间</td>
                    <td>
    ...
    <table id="dg" style="width: 100%">
        <thead>
            <tr>
                <th data-options="field:'EnterpriseName',width:280,sortable:true">供应商名称</th>
                <th data-options="field:'Brand',width:150,sortable:true">品牌</th>
                <th data-options="field:'PartNumber',width:150,sortable:true">型号</th>
                <th data-options="field:'Type',width:80,sortable:true">特色类型</th>
