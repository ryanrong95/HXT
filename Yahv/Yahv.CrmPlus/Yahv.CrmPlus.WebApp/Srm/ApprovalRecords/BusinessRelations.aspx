<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="BusinessRelations.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Srm.ApprovalRecords.BusinessRelations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    <div id="tb">
        <div>
            <table class="liebiao-compact">
                <tr>
                    <td>
                        <input id="txtname" class="easyui-textbox" data-options="prompt:'供应商名称/关联公司'" /></td>
                    <td>申请时间</td>
                    <td>
    ...
    <table id="dg" style="width: 100%">
        <thead>
            <tr>
                <th data-options="field:'MainEnterpriseName',width:260,sortable:true">供应商名称</th>
                <th data-options="field:'SubEnterpriseName',width:260,sortable:true">关联公司</th>
                <th data-options="field:'RelationType',width:100,sortable:true">关联类型</th>
                <th data-options="field:'Applyer',width:100,sortable:true">申请人</th>
                ...
                <th data-options="field:'Status',width:80">审批结果</th>
            </tr>
        </thead>
    </table>
</asp:Content>
