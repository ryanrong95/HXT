<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="SupplierRegistes.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Srm.ApprovalRecords.SupplierRegistes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        ...
        function nameformatter(value, rowData) {
            var result = "";
            result += '<a href="#" onclick=detail(\'' + rowData.SupplierID + '\')>' + rowData.SupplierName + '</a>';
            return result;
        }
        function detail(id) {
            $.myWindow({
                title: '供应商注册信息',
                url: '../Suppliers/Drafts/Details.aspx?id=' + id,
                width: '1100px',
                height: '600px',
                onClose: function () {
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
        ...
        <div>
            <table class="liebiao-compact">
                <tr>
                    ...
                    <td> <input id="txtApplyAdmin" class="easyui-textbox" data-options="prompt:'注册人'"/></td>
                    <td>
    ...
    <table id="dg" style="width: 100%">
        <thead>
            <tr>
                <th data-options="field:'SupplierName',formatter:nameformatter,width:300,sortable:true">供应商名称</th>
                <th data-options="field:'Applyer',width:120,sortable:true">注册人</th>
                <th data-options="field:'ApplyDate',width:150,sortable:true">注册时间</th>
                <th data-options="field:'Approver',width:100,sortable:true,sortable:true">审批人</th>
                <th data-options="field:'ApproveDate',width:150,sortable:true">审批时间</th>
                <th data-options="field:'Status',width:100">审批结果</th>
            </tr>
        </thead>
    </table>
</asp:Content>
