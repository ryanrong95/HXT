<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="MyProtecteds.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Srm.ApprovalRecords.MyProtecteds" %>
        ...
        <thead>
            <tr>
              <%--  <th data-options="field:'EnterpriseName',width:280,sortable:true">供应商名称</th>--%>
                <th data-options="field:'ApplyDate',width:'25%',sortable:true">申请时间</th>
                <th data-options="field:'Approver',width:'25%',sortable:true,sortable:true">审批人</th>
                <th data-options="field:'ApproveDate',width:'25%',sortable:true">审批时间</th>
                <th data-options="field:'Status',width:'25%'">审批结果</th>
            </tr>
        </thead>
    </table>
</asp:Content>
