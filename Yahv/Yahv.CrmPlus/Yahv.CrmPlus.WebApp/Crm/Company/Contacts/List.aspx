<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Crm.Company.Contacts.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script>
        $(function () {
            ...
            //    $.myDialog({
            //        title: '添加',
            //        url: 'Edit.aspx?&companyid=' +  model.ID,
            //        width: "80%",
            //        height: "60%",
            //        isHaveOk: true,
            //        onClose: function () {
        ...
        function Closed(id) {
            $.messager.confirm('确认', '您确认想要停用该联系人信息吗？', function (r) {
                if (r) {
        ...
        function Enable(id) {
            $.messager.confirm('确认', '您确认启用该联系人信息吗？', function (r) {
                if (r) {
    ...
    <table id="dg" style="width: 100%">
        <thead>
            <tr>
                ...
                <th data-options="field:'Department',width:220">部门</th>
                ...
                <th data-options="field:'Gender',width:200">性别</th>
                 ...
                 <th data-options="field:'Wx',width:200">微信</th>
