...
namespace Yahv.CrmPlus.WebApp.Crm.Company.Contacts
{
    public partial class List : ErpParticlePage
    {
        ...
        protected object data()
        {
            ...
            var query = Erp.Current.CrmPlus.Companies[id].Contacts.Where(Predicate());
        ...
        protected void Closed()
        {
            ...
            try
            {
                ...
                var entity = Erp.Current.CrmPlus.Companies[companyID].Contacts[id];
                entity.Closed();
                LogsOperating.LogOperating(Erp.Current, entity.Enterprise.ID, $"停用联系人:{ entity.ID}");

            }
            catch (Exception ex)
            {

                LogsOperating.LogOperating(Erp.Current, companyID, $"停用联系人 操作失败" + ex);
            }
        }
        ...
        protected void Enable()
        {
            ...
            try
            {
                ...
                var entity = Erp.Current.CrmPlus.Companies[companyID].Contacts[id];
                entity.Enable();
                LogsOperating.LogOperating(Erp.Current, entity.Enterprise.ID, $"启用联系人:{ entity.ID}");

            }
            catch (Exception ex)
            {

                LogsOperating.LogOperating(Erp.Current, companyID, $"启用联系人 操作失败" + ex);
            }
        }
