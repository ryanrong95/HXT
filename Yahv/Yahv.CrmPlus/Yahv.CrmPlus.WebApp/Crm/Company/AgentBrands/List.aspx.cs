...
namespace Yahv.CrmPlus.WebApp.Crm.Company.AgentBrands
{
    public partial class List : ErpParticlePage
    {
        ...
        protected void abandon()
        {
            ...
            try
            {
                ...
                entity.Abandon();
                LogsOperating.LogOperating(Erp.Current, entity.EnterpriseID, $"废弃代理品牌:代理公司'{entity.EnterpriseName}',品牌'{entity.BrandName}'");
