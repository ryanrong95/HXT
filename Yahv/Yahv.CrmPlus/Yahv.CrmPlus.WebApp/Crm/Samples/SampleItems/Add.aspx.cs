...
namespace Yahv.CrmPlus.WebApp.Crm.Samples.SampleItems
{
    public partial class Add : ErpParticlePage
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            var product = new SampleItemRoll()[id]?? new SampleItem();
        ...
        private void Entity_EnterSuccess(object sender, Usually.SuccessEventArgs e)
        {
            ...
            Service.LogsOperating.LogOperating(Erp.Current, entity.ID, $"新增样品明细ID:{entity.ID}");
