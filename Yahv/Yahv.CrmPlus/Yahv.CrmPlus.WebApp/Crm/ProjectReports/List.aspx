<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Crm.ProjectReports.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script>
        $(function () {
            ...
            var getQuery = function () {
                var params = {
                    ...
                    ProjectName: $.trim($('#ProjectName').textbox("getText")),
                    StandardPartNumber: $.trim($('#StandardPartNumber').textbox("getText")),
        ...
        function addPrice(id) {
            $.myWindow({
                title: "价格维护",
                url: 'AddPrice.aspx?ID=' + id, onClose: function () {
        ...
        function showDetailPage(id, pm) {
            $.myWindow({
                title: "详情",
                url: 'Detail.aspx?ID=' + id + "&Pm=" + pm, onClose: function () {
                    window.grid.myDatagrid('flush');
                },
                width: "50%",
                height: "70%",
        ...
        <div>
            <table class="liebiao-compact">
                ...
                <tr>
                    ...
                    <td>
                        <input id="Status" name="Status" style="width: 200px" /></td>
                    <td colspan="6">
    ...
    <table id="dg" style="width: 100%" data-option="true">
        <thead>
            <tr>
                ...
                <th data-options="field:'PM',width:150">PM</th>
                <th data-options="field:'FAE',width:150">FAE</th>
