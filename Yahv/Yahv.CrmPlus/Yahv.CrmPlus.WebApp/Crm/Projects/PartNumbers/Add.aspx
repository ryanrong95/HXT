<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Crm.Projects.PartNumbers.Add" %>
        ...
        $(function () {
            ...
            $("#ProjectStatus").combobox({
                ...
                onChange: function (newValue, oldValue) {
                    if (model.Entity ?.ProjectStatus != null) {
            ...
            // 参考单价输入框
            $('#ExpectUnitPrice').numberbox({
                onChange: function (newValue, oldValue) {
                    var num = $("#ExpectQuantity").numberbox("getValue");
                    $("#ExpectTotal").numberbox("setValue", newValue* num);
                }
            });
            // 预计成交量输入框
            $('#ExpectQuantity').numberbox({
                onChange: function (newValue, oldValue) {
                    var price = $("#ExpectUnitPrice").numberbox("getValue");
                    $("#ExpectTotal").numberbox("setValue", newValue * price);
                }
            });
