<%@ Page Language="C#"  MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Crm.Client.BusinessRelations.Add" %>
    ...
    <script>
        $(function () {
            ...
            $('#RelationFile').fileUploader({
                required: true,
                type: 'RelationFiles',
                accept: 'text/csv,image/gif,image/jpeg,image/bmp,application/pdf,image/png,application/pdf'.split(','),
