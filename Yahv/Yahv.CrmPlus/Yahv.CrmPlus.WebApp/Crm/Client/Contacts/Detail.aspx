<%@ Page Title="" Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="Yahv.CrmPlus.WebApp.Crm.Contacts.Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    <%
        ...
        Yahv.CrmPlus.Service.Models.Origins.FilesDescription card = this.Model.Card as Yahv.CrmPlus.Service.Models.Origins.FilesDescription;
    %>
