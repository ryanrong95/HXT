...
namespace Yahv.Services.Models
{
    ...
    /// 运单
    /// </summary>
    [ViewFactory(typeof(Views.WaybillsTopView<>))]
    public class Waybill : IUnique
    {
        ...
        public string CarrierName
        {
            get
            {
                ...
                {
                    using (var view = new Services.Views.CarriersTopView<PvWsOrderReponsitory>())
                    {
                        return view[this.CarrierID]?.Name;
                    }
                }
        ...
        public Waybill()
        {
            this.Condition = new WayCondition().Json();
