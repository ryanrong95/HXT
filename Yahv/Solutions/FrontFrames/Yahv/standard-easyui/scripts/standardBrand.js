...
(function ($) {
        ...
        brand: {
            validator: function (value, param) {
                ...
                var og = $.grep(data, function (item, index) {
                    return $.trim(item.ShortName) == $.trim(value);
                });

                return og.length > 0;
            },
            message: '必须选择下拉列表中的品牌!'
        }
    ...
    $.fn.standardBrand = function (opt, param) {
        ...
        return this.each(function () {
            ...
            }, $.fn.standardBrand.defaults, options);
            ...
            sender.combobox({
                ...
                loader: function (param, success, error) {
                    ...
                    setTimeoutAjax = setTimeout(function () {
                        $.ajax({
                            ...
                            error: function (err) {
                                alert('standardBrand.error:' + JSON.stringify(err));
                            }
                        });
                    }, 100);
                },
                ...
                formatter: function (row) {
                    ...
                    var html = row.ShortName  + '<span style="float:right">' + arry.join('') + '</span>';
                ...
                validType: options.isValid ? 'brand["' + sender_id + '"]' : 'isNull',
                data: [],
                icons: []
            });
        });
