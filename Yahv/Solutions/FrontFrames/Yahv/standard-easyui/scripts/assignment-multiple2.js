...
(function ($) {
    ...
    $.fn.assignment = function (opt, param) {
        ...
        //为页面添加dom元素---开始
        var contains_id = randomID("contains");
        var contains_west_id = randomID("contains_west");
        var contains_center_id = randomID("contains_center");
        var $contains = $("<div class='easyui-layout' style='width:100%;height:100%;' id='cc'></div>");
        var $contains_west = $("<div data-options='region:\"west\",collapsible:false' title='待选择列表' style='width:50%;'>x</div>");
        var $contains_center = $("<div data-options='region:\"center\"' title='已选择列表' style='width:50%;'>xx</div>");
        $contains.append($contains_west);
        $contains.append($contains_center);
        ...
        $contains_center.append($selected);
        $contains_west.append($pending);
        $contains_center.append($selectedtoolbar);
        $contains_west.append($pendtoolbar);
        //为页面添加dom元素---结束
