...
(function ($) {
    ...
    //接口地址
    var ajaxUrl = {
        getSuppliers: '/crmplusapi/RFQV3/Suppliers',
        getNewRegistered: '/crmplusapi/RFQV3/SupplierNewRegistered',
        syncSuppliers: '/crmplusapi/RFQV3/SyncSuppliers',
    }
    ...
    innerMethods.prototype = {
        ...
        //为兼容之前的插件逻辑，添加隐藏输入框，用于保存供应商信息
        addSupplierInput: function (sender, formName) {
    ...
    $.fn.supplier = function (opt, param) {
        ...
        return this.each(function () {
            ...
            //为兼容之前的插件逻辑，添加隐藏输入框，用于保存供应商信息
            myMethods.addSupplierInput(sender, formName);
            ...
            sender.combobox({
                ...
                loader: function (param, success, error) {
                    ...
                    setTimeoutAjax = setTimeout(function () {
                        myMethods.getSuppliers(sender, q, success);
                    }, 500);
                },
                mode: 'remote',
                valueField: 'id',
                ...
                onSelect: function (record) {
                    ...
                    var oldValue = inputs.inputSupplierName.val();
                    inputs.inputSupplierName.val($.trim(record.name));
                    inputs.inputSupplierID.val($.trim(record.id));
