...
(function ($) {
    //接口地址
    var ajaxUrl = {
        getSupplierPayees: '/crmplusapi/RFQV3/SupplierPayees',
    }
    ...
    $.fn.supplierPayee = function (opt, param) {
        //如果options为string，则是方法调用
        if (typeof opt == 'string') {
            var method = $.fn.supplierPayee.methods[opt];
            if (method) {
        ...
        var options = opt || {};
        options = $.extend(true, {}, $.fn.supplierPayee.defaults, options);
    ...
    $.parser.plugins.push('supplierPayee');
})(jQuery)