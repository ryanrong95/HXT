...
(function ($) {
    ...
    //接口地址
    var ajaxUrl = {
        getSuppliers: '/crmplus2api/Enterprises/Suppliers',
        getNewRegistered: '/crmplus2api/Suppliers/NewRegistered'
    }

    //供应商快速注册页面地址
    var pageUrl = {
        supplierQuickRegister: '/crmplus2/Srm/Drafts/QuickRegister.aspx'
    }
