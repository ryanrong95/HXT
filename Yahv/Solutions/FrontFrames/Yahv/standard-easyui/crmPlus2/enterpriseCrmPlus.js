...
(function ($) {
    ...
    //接口地址
    var AjaxUrl = {
        getCompanys: '/crmplus2api/Enterprises/Normals'
    }

    //编写enterpriseCrmPlus插件
    $.fn.enterpriseCrmPlus = function (opt, param) {
        //如果options为string，则是方法调用
        if (typeof opt == 'string') {
            var method = $.fn.enterpriseCrmPlus.methods[opt];
            if (method) {
        ...
        var options = opt || {};
        options = $.extend(true, {}, $.fn.enterpriseCrmPlus.defaults, options);
        ...
        return this.each(function () {
            ...
            sender.combobox({
                loader: function (param, success, error) {
                    ...
                    setTimeoutAjax = setTimeout(function () {
                        $.ajax({
                            ...
                            error: function (err) {
                                disLoad();
                                alert('enterpriseCrmPlus.error:' + JSON.stringify(err));
                ...
                validType: 'enterpriseCrmPlus["' + sender_id + '"]',
            });
    ...
    $.parser.plugins.push('enterpriseCrmPlus');
})(jQuery)