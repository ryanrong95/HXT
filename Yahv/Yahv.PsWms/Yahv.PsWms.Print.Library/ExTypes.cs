...
namespace Yahv.PsWms.Print.Library
{
    ...
    public class SfExpType : CodeType
    {
        ...
        public const int 国际小包平邮 = 9;
        public const int 国际小包挂号 = 10;
        public const int 国际特惠 = 23;
        public const int 国际特惠_商家代理 = 27;
        public const int 国际电商专递_标准 = 29;
        public const int 便利箱产品 = 31;
        public const int 顺丰干配 = 111;
        public const int 顺丰空配 = 112;
        public const int 整车直达 = 153;
        public const int 标准零担 = 155;
        public const int 极速包裹 = 199;
        public const int 冷运特惠 = 201;
        public const int 顺丰微小件 = 202;
        public const int 医药快运 = 203;
        public const int 特惠专配 = 208;
        public const int 高铁专送 = 209;
        public const int 大票直送 = 215;
        public const int 精温专递 = 229;
        public const int 陆运包裹 = 231;
        public const int 丰网速运 = 242;
        public const int 电商标快 = 247;
    ...
    public class KysyExpType : CodeType
    {
        ...
        public const int 当天达 = 10;
        public const int 次日达 = 20;
        public const int 隔日达 = 30;
        public const int 陆运件 = 40;
        public const int 同城次日 = 50;
        public const int 次晨达 = 60;
        public const int 同城即日 = 70;
        public const int 航空件 = 80;
        public const int 省内次日 = 160;
        public const int 省内即日 = 170;
        public const int 空运 = 210;
        public const int 专运 = 220;
