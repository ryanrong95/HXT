...
namespace Yahv.PsWms.SzMvc.Services.Views
{
    ...
    /// 开票申请视图
    /// </summary>
    public class Invoices_Show_View : QueryView<InvoiceShow, PsOrderRepository>
    {
        ...
        protected Invoices_Show_View(PsOrderRepository reponsitory, IQueryable<InvoiceShow> iQueryable) : base(reponsitory, iQueryable)
        {
        }

        protected override IQueryable<InvoiceShow> GetIQueryable()
        {
            var invoices =this.Reponsitory.ReadTable<Layers.Data.Sqls.PsOrder.SzInvoiceNoticesTopView>();
            var admins = this.Reponsitory.ReadTable<Layers.Data.Sqls.PsOrder.AdminsTopView>();
            var clients = this.Reponsitory.ReadTable<Layers.Data.Sqls.PsOrder.Clients>();          
            var iQuery = from entity in invoices
                         ...
                         select new InvoiceShow
                         {
                             ID = entity.ID,
                             Title = entity.Title,
                             InvoiceType = (Underly.InvoiceType)entity.Type,
                             InvoiceDeliveryType =(Underly.InvoiceDeliveryType) entity.DeliveryType,
                             InvoiceNoticeStatus = (Enums.InvoiceEnum)entity.Status,
        ...
        public Tuple<IEnumerable<InvoiceShow>, int> ToMyPage(int pageIndex = 1, int pageSize = 20)
        {
            ...
            var invoiceItems = this.Reponsitory.ReadTable<Layers.Data.Sqls.PsOrder.SzInvoiceNoticeItemsTopView>(); ;
        ...
        /// <returns></returns>
        public Invoices_Show_View SearchByStatus(Enums.InvoiceEnum status)
        {
        ...
        /// <returns></returns>
        public Invoices_Show_View SearchByInvoiceType(Underly.InvoiceType invoiceType)
        {
            var linq = from query in this.IQueryable
        ...
        /// <param name="invoiceType"></param>
        /// <returns></returns>
        public Invoices_Show_View SearchByInvoiceDeliveryType(Underly.InvoiceDeliveryType deliveryType)
        {
            var linq = from query in this.IQueryable
    ...
    public class InvoiceShow
    {
        ...
        /// 开票类型
        /// </summary>
        public Underly.InvoiceType InvoiceType { get; set; }

        /// <summary>
        /// 交付方式
        /// </summary>
        public Underly.InvoiceDeliveryType InvoiceDeliveryType { get; set; }

        /// <summary>
        /// 开票状态
        /// </summary>
        public Enums.InvoiceEnum InvoiceNoticeStatus { get; set; }
