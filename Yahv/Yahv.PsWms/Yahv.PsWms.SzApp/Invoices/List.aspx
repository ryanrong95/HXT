<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.PsWms.SzApp.Invoices.List" %>
        ...
        <table class="liebiao">
            ...
            <tr>
                <td colspan="8">
                    ...
                    <a id="btnAdd" class="easyui-linkbutton" iconcls="icon-yg-add">新增申请</a>
                </td>
            </tr>
        </table>
    </div>
