<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.PsWms.SzApp.Orders.OutBound.List" %>
    ...
    <table id="tab1" title="出库订单">
        <thead>
            <tr>
                ...
                <th data-options="field:'TransportModeDec',align:'center'" style="width: 100px">收货方式</th>
