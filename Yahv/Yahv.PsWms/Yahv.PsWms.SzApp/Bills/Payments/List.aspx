<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Yahv.PsWms.SzApp.Bills.Payments.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    <div id="topper">
        ...
        <table class="liebiao">
            <tr>
                ...
                <td>
                    <input id="dateIndex" data-options="prompt:'',validType:'length[6,6]'" class="easyui-numberbox" style="width: 150px" />
                </td>
            </tr>
            <tr>
                <td colspan="8">
    ...
    <table id="tab1" title="应付账单列表">
        <thead>
            <tr>
                <th data-options="field:'Payer',align:'left'" style="width: 200px;">付款人</th>
