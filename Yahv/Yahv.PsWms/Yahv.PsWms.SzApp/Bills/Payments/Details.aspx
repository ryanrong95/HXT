<%@ Page Language="C#" MasterPageFile="~/Uc/Works.Master" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Yahv.PsWms.SzApp.Bills.Payments.Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphForm" runat="server">
    <table class="liebiao">
        <tr>
            <td colspan="2">
                <div style="padding: 5px; float: left;">
                    <label id="dateIndex" style="font-size: 20px; font-weight: 700"></label><br />
        ...
        <tr>
            <td class="title" colspan="2">付款账户</td>
        </tr>
        <tr>
