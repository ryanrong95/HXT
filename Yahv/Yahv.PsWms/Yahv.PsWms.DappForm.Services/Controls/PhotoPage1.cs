...
{
    public partial class PhotoPage1 : Form
    {
        /*
         业务逻辑：
        ...
        private void PhotoPage1_Load(object sender, EventArgs e)
        {
        ...
        static PhotoPage1 current;
        static public PhotoPage1 Current
        {
            get
            {
                if (current == null)
                {
                    current = new PhotoPage1();
                }
        ...
        private void PhotoPage1_FormClosed(object sender, FormClosedEventArgs e)
        {
            current = null;
        }

        private void PhotoPage1_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            //if (this.vspMain.GetCurrentVideoFrame() != null)
            //{
            //    var bmp = this.vspMain.GetCurrentVideoFrame();
            //    this.scale = bmp.Height / bmp.Width;
            //}
        ...
        private string GetFileName()
        {
            ...
            {
                //this.scale = (double)bmp.Height / bmp.Width;
        ...
        private void PhotoPage1_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {

        }

        private void PhotoPage1_Resize(object sender, EventArgs e)
        {
