<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductView.aspx.cs" Inherits="WebApp.Crm.MyApprove.ProductView" %>
...
<body class="easyui-layout">
    ...
    <div title="审批记录列表" data-options="region:'center',border:false" style="height: 30%">
        <table id="datagrid" class="mygrid" data-options="fit:true,scrollbarSize:0">
            <thead>
                <tr>
                    <th field="AdminName" data-options="align:'center'" style="width: 100px;">审批人</th>
                    <th field="StatusName" data-options="align:'center'" style="width: 100px;">审批状态</th>
                    <th field="AprDate" data-options="align:'center'" style="width: 100px;">审批时间</th>
                    <th field="Comment" data-options="align:'center'" style="width: 200px;">审批意见</th>
                </tr>
            </thead>
        </table>
    </div>
