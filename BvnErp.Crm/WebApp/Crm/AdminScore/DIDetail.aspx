<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIDetail.aspx.cs" Inherits="WebApp.Crm.AdminScore.DIDetail" %>
        ...
        <table id="datagrid" title="产品列表" data-options="fit:true,scrollbarSize:0" class="mygrid">
            <thead>
                <tr>
                    ...
                    <th field="StandProductName" data-options="align:'center'" style="width: 100px">产品型号</th>
