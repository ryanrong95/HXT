<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebApp.Crm.Beneficiaries.List" %>
...
<body class="easyui-layout">
    <div title="收益人" data-options="region:'north',border:false" style="height: 60px">
    ...
    <div data-options="region:'center',border:false">
        <table id="datagrid" title="收益人列表" data-options="fitColumns:true,border:false,fit:true,scrollbarSize:0" class="mygrid">
            <thead>
                <tr>
                    <th field="Btn" data-options="align:'center',formatter:Operation" style="width: 100px">操作</th>
                    <th field="Bank" data-options="align:'center'" style="width: 100px">银行</th>
                    <th field="BankCode" data-options="align:'center'" style="width: 50px">账户</th>
                    <th field="Address" data-options="align:'center'" style="width: 100px;">地址</th>
                    <th field="CompanyName" data-options="align:'center'" style="width: 100px;">公司</th>
                </tr>
            </thead>
        </table>
    </div>
