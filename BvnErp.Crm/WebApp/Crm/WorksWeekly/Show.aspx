<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="WebApp.Crm.WorksWeekly.Show" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //打开点评页面
        function Add() {
            var url = location.pathname.replace(/Show.aspx/ig, 'WeeklyComment.aspx') + "?ID=" + getQueryString("ID") + "&Type=40";
            top.$.myWindow({
                iconCls: "",
                noheader: false,
                title: '我的点评',
...
<body>    
    <form id="form1" runat="server" method="post">
        <table id="table1" style="margin: 0 auto; width: 100%; height: 100%">
            <tr>
                <td class="lbl"><strong>当前周</strong></td>
                <td>第<asp:Label ID="WeekOfYear" runat="server" Text=""></asp:Label>周
                </td>
                <td class="lbl"><strong>撰写人</strong></td>
                <td>
                    <asp:Label ID="AdminName" runat="server" Text=""></asp:Label>
                </td>
                <td class="lbl"><strong>撰写时间</strong></td>
                <td>
            ...
            <tr style="padding-top: 30px">
                <td class="lbl" style="width: 80px"><strong>周报内容</strong></td>
                <td colspan="5">
    ...
    <div id="DivComment" style="width: 100%">
    ...
    <div id="divComment" style="text-align: center; margin-top: 30px">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if (AllData != null) {
                ...
                $("#WeekOfYear").val(AllData["WeekOfYear"]);
                $("#DivComment").hide();
