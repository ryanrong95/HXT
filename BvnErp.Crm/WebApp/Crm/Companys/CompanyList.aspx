<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyList.aspx.cs" Inherits="WebApp.Crm.Companys.CompanyList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //新增
        function Add() {
            var url = location.pathname.replace(/CompanyList.aspx/ig, 'Edit.aspx') + "?Type=C";
            if (true) {
                top.$.myWindow({
                    url: url,
                    iconCls: "",
        ...
        function Edit(Index) {
            ...
            if (rowdata) {
                var url = location.pathname.replace(/CompanyList.aspx/ig, 'Edit.aspx') + "?ID=" + rowdata.ID + "&Type=C";
                top.$.myWindow({
                    iconCls: "",
                    noheader: false,
                    title: '公司编辑',
...
<body class="easyui-layout">
    <div title="公司列表" data-options="region:'north',border:false" style="height: 80px">
        ...
        <table id="datagrid" data-options="fit:true,scrollbarSize:0" class="mygrid">
            <thead>
                <tr>
                    ...
                    <th field="Name" data-options="align:'center',formatter:formatCellTooltip" style="width: 100px">公司名称</th>
                    <th field="Code" data-options="align:'center'" style="width: 100px">公司编码</th>
                    <th field="Summary" data-options="align:'center'" style="width: 200px">公司描述</th>
                </tr>
            </thead>
        </table>
    </div>
