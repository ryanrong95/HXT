...
{
    public partial class TopObject : Needs.Web.Forms.ClientPage
    {
        ...
        protected void getConfig()
        {
            ...
            {
                using (var view = new Needs.Interpreter.Views.TopObjectsView())
                {
        ...
        public Newtonsoft.Json.Linq.JArray TopobjectTree()
        {
            ...
            int cnt = 1;
            var view = new Needs.Interpreter.Views.TopObjectsView();
