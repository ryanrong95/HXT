<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="En_TopObjectEdit.aspx.cs" Inherits="WebApp.Erp.Translate.En_TopObjectEdit" %>
...
<body class="easyui-layout">
    <div data-options="region:'north',collapsible:false" title="国际化语言翻译" style="height: 55px">
        ...
        <a href="#" class="easyui-linkbutton" onclick="top.$.myWindow({            
                    url: location.href.replace(/En_TopObjectEdit/i, 'En_importlangConfigs')
                }).open();">批量处理</a>
    </div>
