<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="En_importlangConfigs.aspx.cs" Inherits="WebApp.Erp.Translate.En_importlangConfigs" %>
    ...
    <script>
        ...
        function intiData() {
            worker.createScript({ src: '/files/langfile.js' }, function () {
                $.post('En_TopobjectConfig.ashx?action=upload', { data: JSON.stringify(lang || {}) }, function (text) {
                    $.get('?', {
                        action: 'delete',
                        file: 'langfile.js'
                    });
