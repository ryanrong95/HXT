...
{
    public partial class importlangConfigs : Needs.Web.Forms.BasePage
    {
        /// <summary>
        /// 上传文件
        /// </summary>
        ...
        protected void import()
        {
            ...
            //导入之前先备份
            var old = Needs.Interpreter.Models.TopObject.Outputs().Json();
            //backups
            ...
            Needs.Interpreter.Models.TopObject.Import(langType, data.JsonToTopObject());
